...
- **Stage 4 On-Device AI (1,500만 / 4주)**: Hailo-8 또는 Jetson Orin 또는 ESP32-S3 + 모델 fine-tuning + C++ 추론 엔진 + Stage 0 인프라 통합
- 추가 워크플로우 1건당 100만 (Stage 0 종료 후 별도 견적)
- 풀 패키지 도입 시: Stage 0 + 1 + 2 + 3 + 4 = **7,300만** (단계별 진행, 단계별 결정 가능)
