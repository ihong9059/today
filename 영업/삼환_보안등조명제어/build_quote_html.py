# -*- coding: utf-8 -*-
"""견적서 HTML 생성 (xlsx와 동일 데이터·금액 자동계산)"""
...
html = f"""<!DOCTYPE html>
<html lang="ko"><head><meta charset="UTF-8"><title>광안 보안등 유선 0-10V 디밍 조명제어 견적서 — UTTEC</title>
<style>
...
<div class="head">
  ...
  <h1>견 적 서</h1>
  <div class="sub">Quotation<br>2026. 07. 24.<br>v1.0 (E13 상세도 반영)</div>
</div>
<table class="info">
...
6. 유효기간: 견적일로부터 <b>30일</b>. 하자보증 1년(협의 연장). ※ 사업자등록번호 등은 계약 시 제공.
</div>
<div class="stamp">
...
out = "삼환_광안보안등_유선디밍제어_견적서_UTTEC_v1_20260724.html"
