...
type: entity
created: 2026-05-07
updated: 2026-05-29 R41 Path A 본격 진입 cascade (vanilla Zephyr STM32H7 DMIC 정식 지원 0 → 본 vault custom Zephyr patch chain 11.5/12 단계 PASS + SAI4 register 결정타 ACR1.DMAEN bit17=0 + PC1+PE2 2핀 Ethernet 충돌 확정 + 시나리오 E E1/E2/E3 분리 박제 + STM-17~21 신규 함정 5건 + Stage 4 시나리오 E1 영업 자산 회복)
