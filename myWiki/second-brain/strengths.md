...
### 7. 통신 프로토콜 다양성 (7종 직접 경험)
양산 5종 + 직접 구현 1종 + 분석 완료 1종 = 통신 프로토콜 7종 보유.
- **양산 (실제 판매)**: RS-485 Modbus RTU, BLE Mesh, LoRa/MQTT, EtherCAT, CAN
- **직접 구현 (검증 완료)**: OOK Sub-GHz RF (CC1101 447.925MHz Replay, REVITA 2026-05)
- **분석 완료**: AISG 3.0 (HDLC + RS-485/OOK PHY, 위시캣 #155057, 2026-05) — [[aisg]]
