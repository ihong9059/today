...
- **`weldrobot-claude` — `C:/todo/weldRobot/` (Windows, 본 PC, 2026-06-06 합류) — UTTEC 용접 로봇 신사업 vault (Tier 3, Path 4 Vision seam tracking + AI 비드 검사 add-on box 우선 진입 + Path 3 AI 자율 path planning 장기 carry)** ⭐ **14th NEW** (carrier 패턴 2번째 적용 사례 정착 검증, mywiki strengths §13)
