...
- **`ponet-claude` — `C:/todo/ponet/` (Windows, 본 PC, 2026-06-06 합류) — Ponet 광주 협력 회사 vault (Tier 3, 조대홍 사장, 자체 SSH fact-finding 신설 패턴 첫 사례, PCB 설계 풀세트 + 더존 ERP + 자체 호스팅)** ⭐ **15th NEW** (carrier 패턴 3번째 적용 사례 정착 확정, mywiki strengths §13)
