...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '바닥마감재의 종류와 특징을 설명하시오.',
        answer: '타일, 목재, 비닐, 카펫, 석재',
        prompt: `실내건축기사 실내건축재료 문제입니다.\n\n문제: 바닥마감재의 종류와 특징을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },      {
        id: 2,
        question: '친환경 인증제도를 설명하시오.',
        answer: 'HB마크, 환경마크, GR마크',
        prompt: `실내건축기사 실내건축재료 문제입니다.\n\n문제: 친환경 인증제도를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-purple-600 font-medium">실내건축재료</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">실내건축재료 학습</h1>
