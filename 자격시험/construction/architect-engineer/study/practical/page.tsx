...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '건축공사 적산의 일반적인 순서를 설명하시오.',
        answer: '도면분석→물량산출→단가적용→공사비산출→내역서작성',
        prompt: `건축기사 실기 문제입니다.

문제: 건축공사 적산의 일반적인 순서를 설명하시오.
...
비슷한 유형의 연습문제 3개도 만들어주세요.`
      ...
      {
        id: 2,
        question: '철근 수량 산출 시 할증률 적용 기준을 설명하시오.',
        answer: 'D10~D13: 3%, D16~D25: 5%, D29 이상: 8%',
        prompt: `건축기사 실기 문제입니다.

문제: 철근 수량 산출 시 할증률 적용 기준을 설명하시오.
...
비슷한 유형의 연습문제 3개도 만들어주세요.`
  ...
  },
  {
    ...
    questions: [
      {
        id: 1,
        question: '건축도면의 종류와 내용을 설명하시오.',
        answer: '배치도, 평면도, 입면도, 단면도, 상세도, 구조도',
        prompt: `건축기사 실기 문제입니다.

문제: 건축도면의 종류와 내용을 설명하시오.
...
비슷한 유형의 연습문제 3개도 만들어주세요.`
  ...
  },
  {
    ...
    questions: [
      {
        id: 1,
        question: '철근콘크리트 보의 휨설계 순서를 설명하시오.',
        answer: '설계하중→설계모멘트→유효깊이→필요철근량→배근상세',
        prompt: `건축기사 실기 문제입니다.

문제: 철근콘크리트 보의 휨설계 순서를 설명하시오.
...
export default function PracticalStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('architect-practical-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('architect-practical-progress', JSON.stringify(newCompleted));
  };
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-purple-100">건축기사 실기시험</p>
              </div>
            </div>
