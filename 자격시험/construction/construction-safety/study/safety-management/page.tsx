...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '하인리히의 재해발생 이론을 설명하시오.',
        answer: '1:29:300 법칙, 도미노 이론',
        prompt: `건설안전기사 안전관리론 문제입니다.\n\n문제: 하인리히의 재해발생 이론을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },      {
        id: 2,
        question: '안전관리 조직의 형태를 설명하시오.',
        answer: '직계식, 참모식, 직계참모식',
        prompt: `건설안전기사 안전관리론 문제입니다.\n\n문제: 안전관리 조직의 형태를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
];
...
export default function SafetymanagementStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('safety-management-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('safety-management-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-yellow-600 font-medium">안전관리론</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">안전관리론 학습</h1>
