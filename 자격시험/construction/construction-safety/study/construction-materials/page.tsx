...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '콘크리트의 압축강도 시험 방법을 설명하시오.',
        answer: '공시체 제작, 28일 양생, 압축시험',
        prompt: `건설안전기사 건설재료학 문제입니다.\n\n문제: 콘크리트의 압축강도 시험 방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
];
...
export default function ConstructionmaterialsStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('construction-materials-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('construction-materials-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-yellow-600 font-medium">건설재료학</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">건설재료학 학습</h1>
