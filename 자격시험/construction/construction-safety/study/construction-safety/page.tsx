...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '건설현장 추락재해 방지대책을 설명하시오.',
        answer: '안전난간, 안전망, 안전대, 개구부 덮개',
        prompt: `건설안전기사 건설안전기술 문제입니다.\n\n문제: 건설현장 추락재해 방지대책을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },      {
        id: 2,
        question: '굴착공사 시 안전대책을 설명하시오.',
        answer: '흙막이, 토사붕괴방지, 지하매설물 확인',
        prompt: `건설안전기사 건설안전기술 문제입니다.\n\n문제: 굴착공사 시 안전대책을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
];
...
export default function ConstructionsafetyStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('construction-safety-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('construction-safety-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-yellow-600 font-medium">건설안전기술</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">건설안전기술 학습</h1>
                <p className="text-yellow-100">건설안전기사</p>
              </div>
            </div>
