...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '벡터 데이터와 래스터 데이터의 차이를 설명하시오.',
        answer: '벡터: 점,선,면 / 래스터: 격자셀',
        prompt: `측량및지형공간정보기사 GIS 문제입니다.\n\n문제: 벡터 데이터와 래스터 데이터의 차이를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },      {
        id: 2,
        question: '공간분석의 종류를 설명하시오.',
        answer: '버퍼분석, 중첩분석, 네트워크분석',
        prompt: `측량및지형공간정보기사 GIS 문제입니다.\n\n문제: 공간분석의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
...
export default function GisStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('gis-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('gis-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-teal-600 font-medium">GIS</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">GIS 학습</h1>
