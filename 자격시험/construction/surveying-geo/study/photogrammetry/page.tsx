...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '항공사진의 내부표정 요소를 설명하시오.',
        answer: '초점거리, 주점위치, 렌즈왜곡',
        prompt: `측량및지형공간정보기사 사진측량 문제입니다.\n\n문제: 항공사진의 내부표정 요소를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },      {
        id: 2,
        question: '수치표고모델(DEM)의 제작 방법을 설명하시오.',
        answer: '스테레오 영상 매칭, 보간법',
        prompt: `측량및지형공간정보기사 사진측량 문제입니다.\n\n문제: 수치표고모델(DEM)의 제작 방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
];
...
export default function PhotogrammetryStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('photogrammetry-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('photogrammetry-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-teal-600 font-medium">사진측량</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">사진측량 학습</h1>
                <p className="text-teal-100">측량및지형공간정보기사</p>
              </div>
            </div>
