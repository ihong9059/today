...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '지오이드와 타원체의 차이를 설명하시오.',
        answer: '지오이드: 평균해수면, 타원체: 수학적 모델',
        prompt: `측량및지형공간정보기사 측지학 문제입니다.\n\n문제: 지오이드와 타원체의 차이를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },      {
        id: 2,
        question: 'GNSS 측량의 원리를 설명하시오.',
        answer: '위성신호 수신, 삼변측량 원리',
        prompt: `측량및지형공간정보기사 측지학 문제입니다.\n\n문제: GNSS 측량의 원리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
];
...
export default function GeodesyStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('geodesy-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('geodesy-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-teal-600 font-medium">측지학</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">측지학 학습</h1>
