...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '베르누이 방정식을 설명하고 적용 예를 드시오.',
        answer: '에너지 보존: P/γ + V²/2g + Z = 일정',
        prompt: `토목기사 수리학 문제입니다.\n\n문제: 베르누이 방정식을 설명하고 적용 예를 드시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },      {
        id: 2,
        question: '관수로와 개수로의 차이점을 설명하시오.',
        answer: '관수로: 압력, 개수로: 자유수면',
        prompt: `토목기사 수리학 문제입니다.\n\n문제: 관수로와 개수로의 차이점을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
];
...
export default function HydraulicsStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('hydraulics-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('hydraulics-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-amber-600 font-medium">수리학</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">수리학 학습</h1>
