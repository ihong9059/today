...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '단순보의 반력과 전단력, 휨모멘트를 구하시오.',
        answer: 'V=wL/2, Mmax=wL²/8',
        prompt: `토목기사 응용역학 문제입니다.\n\n문제: 단순보의 반력과 전단력, 휨모멘트를 구하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },      {
        id: 2,
        question: '트러스 구조의 부재력 계산 방법을 설명하시오.',
        answer: '절점법, 단면법 적용',
        prompt: `토목기사 응용역학 문제입니다.\n\n문제: 트러스 구조의 부재력 계산 방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  },  {
    ...
    questions: [
      {
        id: 1,
        question: '부정정 구조물의 해석 방법을 설명하시오.',
        answer: '처짐각법, 모멘트분배법, 매트릭스법',
        prompt: `토목기사 응용역학 문제입니다.\n\n문제: 부정정 구조물의 해석 방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
];
...
export default function AppliedmechanicsStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('applied-mechanics-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('applied-mechanics-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-amber-600 font-medium">응용역학</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">응용역학 학습</h1>
