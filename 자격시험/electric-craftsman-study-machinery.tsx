...
export default function ElectricCraftsmanMachineryStudyPage() {
  ...
  const markComplete = () => {
    ...
    localStorage.setItem('electric-craftsman-machinery-completed', JSON.stringify([...newCompleted]));
  };
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="mb-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-2xl font-bold text-gray-800">전기기기 학습하기</h1>
          </div>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 mb-4">
              ...
              <div className="border-t pt-4">
                {!showAnswer ? (
                  <button onClick={() => setShowAnswer(true)} className="w-full py-3 bg-orange-500 text-white rounded-lg font-medium hover:bg-orange-600 transition-colors">정답 보기</button>
                ) : (
