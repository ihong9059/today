...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: 'SCM의 목적을 설명하시오.',
        answer: '총비용 최소화, 고객서비스 극대화',
        prompt: `유통관리사 1급 물류관리 문제입니다.\n\n문제: SCM의 목적을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '채찍효과를 설명하시오.',
        answer: '수요정보 왜곡, 상류로 갈수록 변동 확대',
        prompt: `유통관리사 1급 물류관리 문제입니다.\n\n문제: 채찍효과를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'VMI를 설명하시오.',
        answer: '공급자 재고관리, 자동발주',
        prompt: `유통관리사 1급 물류관리 문제입니다.\n\n문제: VMI를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: 'CPFR을 설명하시오.',
        answer: '협력적 계획/예측/보충',
        prompt: `유통관리사 1급 물류관리 문제입니다.\n\n문제: CPFR을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '3PL과 4PL을 설명하시오.',
        answer: '3PL: 물류아웃소싱, 4PL: 공급사슬통합',
        prompt: `유통관리사 1급 물류관리 문제입니다.\n\n문제: 3PL과 4PL을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function LogisticsmanagementStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('logistics-management-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('logistics-management-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-teal-600 font-medium">물류관리</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">물류관리 학습</h1>
