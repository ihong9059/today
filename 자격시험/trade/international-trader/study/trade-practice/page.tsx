...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '무역계약의 성립요건을 설명하시오.',
        answer: '청약과 승낙, 당사자능력, 목적물 특정',
        prompt: `국제무역사 무역실무 문제입니다.\n\n문제: 무역계약의 성립요건을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '품질조건의 종류를 설명하시오.',
        answer: '견본매매, 표준품매매, 상표매매, 명세서매매',
        prompt: `국제무역사 무역실무 문제입니다.\n\n문제: 품질조건의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '수량조건 결정방법을 설명하시오.',
        answer: '개수, 중량, 용적, 포장단위',
        prompt: `국제무역사 무역실무 문제입니다.\n\n문제: 수량조건 결정방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '가격조건의 구성을 설명하시오.',
        answer: '통화+금액+단위+인코텀즈',
        prompt: `국제무역사 무역실무 문제입니다.\n\n문제: 가격조건의 구성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '선적조건의 내용을 설명하시오.',
        answer: '선적시기, 분할선적, 환적 허용여부',
        prompt: `국제무역사 무역실무 문제입니다.\n\n문제: 선적조건의 내용을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '신용장의 당사자를 설명하시오.',
        answer: '개설의뢰인, 수익자, 개설은행, 통지은행',
        prompt: `국제무역사 무역실무 문제입니다.\n\n문제: 신용장의 당사자를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '신용장 통일규칙(UCP 600)을 설명하시오.',
        answer: 'ICC 제정, 신용장 국제표준규칙',
        prompt: `국제무역사 무역실무 문제입니다.\n\n문제: 신용장 통일규칙(UCP 600)을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'Discrepancy의 종류를 설명하시오.',
        answer: '서류불일치, L/C 조건 불합치',
        prompt: `국제무역사 무역실무 문제입니다.\n\n문제: Discrepancy의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '무역금융의 종류를 설명하시오.',
        answer: '수출성장자금, 수입자금, 포페이팅',
        prompt: `국제무역사 무역실무 문제입니다.\n\n문제: 무역금융의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '환위험 관리를 설명하시오.',
        answer: '선물환, 통화옵션, 환변동보험',
        prompt: `국제무역사 무역실무 문제입니다.\n\n문제: 환위험 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function TradepracticeStudyPage() {
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('trade-practice-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/trade/international-trader" className="text-gray-600 hover:text-teal-600">국제무역사</Link>
            <span className="text-gray-300">›</span>
            <span className="text-teal-600 font-medium">무역실무</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">무역실무 학습</h1>
                <p className="text-teal-100">국제무역사</p>
              </div>
            </div>
