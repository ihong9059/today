...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '해상운송의 종류를 설명하시오.',
        answer: '정기선, 부정기선, 전용선',
        prompt: `국제무역사 물류와 보험 문제입니다.\n\n문제: 해상운송의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '항공운송의 특징을 설명하시오.',
        answer: '신속, 고가품, 소량화물 적합',
        prompt: `국제무역사 물류와 보험 문제입니다.\n\n문제: 항공운송의 특징을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '복합운송의 개념을 설명하시오.',
        answer: '2가지 이상 운송수단, 단일계약',
        prompt: `국제무역사 물류와 보험 문제입니다.\n\n문제: 복합운송의 개념을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '컨테이너 운송을 설명하시오.',
        answer: 'FCL/LCL, CY/CFS',
        prompt: `국제무역사 물류와 보험 문제입니다.\n\n문제: 컨테이너 운송을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '운임의 구성을 설명하시오.',
        answer: '기본운임, 할증료, 부대비용',
        prompt: `국제무역사 물류와 보험 문제입니다.\n\n문제: 운임의 구성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '적하보험의 담보위험을 설명하시오.',
        answer: 'ICC(A), ICC(B), ICC(C) 조건',
        prompt: `국제무역사 물류와 보험 문제입니다.\n\n문제: 적하보험의 담보위험을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '보험금액 산정을 설명하시오.',
        answer: 'CIF가격 × 110%',
        prompt: `국제무역사 물류와 보험 문제입니다.\n\n문제: 보험금액 산정을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '구상권의 개념을 설명하시오.',
        answer: '보험자가 제3자에 손해배상 청구',
        prompt: `국제무역사 물류와 보험 문제입니다.\n\n문제: 구상권의 개념을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '공동해손을 설명하시오.',
        answer: '공동위험 회피위한 희생/비용 분담',
        prompt: `국제무역사 물류와 보험 문제입니다.\n\n문제: 공동해손을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '면책사항을 설명하시오.',
        answer: '고의, 자연소모, 포장불량, 지연손해',
        prompt: `국제무역사 물류와 보험 문제입니다.\n\n문제: 면책사항을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function TradelogisticsStudyPage() {
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('trade-logistics-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-teal-600 font-medium">물류와 보험</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">물류와 보험 학습</h1>
