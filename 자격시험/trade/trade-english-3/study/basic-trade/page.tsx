...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '무역의 정의를 설명하시오.',
        answer: '국가간 상품/서비스 교환, 수출/수입',
        prompt: `무역영어 3급 무역기초 문제입니다.\n\n문제: 무역의 정의를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '무역의 이점을 설명하시오.',
        answer: '비교우위, 규모의 경제, 시장확대',
        prompt: `무역영어 3급 무역기초 문제입니다.\n\n문제: 무역의 이점을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '수출입 절차를 설명하시오.',
        answer: '계약→신용장→생산→선적→통관→대금결제',
        prompt: `무역영어 3급 무역기초 문제입니다.\n\n문제: 수출입 절차를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '무역업 등록요건을 설명하시오.',
        answer: '사업자등록, 무역업고유번호 신청',
        prompt: `무역영어 3급 무역기초 문제입니다.\n\n문제: 무역업 등록요건을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '무역관련 기관을 설명하시오.',
        answer: 'KOTRA, 무역협회, 관세청, 무역보험공사',
        prompt: `무역영어 3급 무역기초 문제입니다.\n\n문제: 무역관련 기관을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '수출입신고서를 설명하시오.',
        answer: '관세청 제출, 품목/가격/수량 신고',
        prompt: `무역영어 3급 무역기초 문제입니다.\n\n문제: 수출입신고서를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'Offer Sheet의 구성을 설명하시오.',
        answer: '품명, 규격, 수량, 가격, 유효기간',
        prompt: `무역영어 3급 무역기초 문제입니다.\n\n문제: Offer Sheet의 구성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'Purchase Order의 내용을 설명하시오.',
        answer: '구매발주서, 주문내역 확정',
        prompt: `무역영어 3급 무역기초 문제입니다.\n\n문제: Purchase Order의 내용을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: 'Quotation의 목적을 설명하시오.',
        answer: '견적서, 가격/조건 제시',
        prompt: `무역영어 3급 무역기초 문제입니다.\n\n문제: Quotation의 목적을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: 'Invoice와 Receipt의 차이를 설명하시오.',
        answer: 'Invoice: 청구서, Receipt: 영수증',
        prompt: `무역영어 3급 무역기초 문제입니다.\n\n문제: Invoice와 Receipt의 차이를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
];

export default function BasictradeStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('basic-trade-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('basic-trade-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-teal-600 font-medium">무역기초</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">무역기초 학습</h1>
                <p className="text-teal-100">무역영어 3급</p>
              </div>
            </div>
