...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: 'Please quote your best price의 의미를 설명하시오.',
        answer: '최저가격을 제시해 주세요',
        prompt: `무역영어 3급 기초영어 문제입니다.\n\n문제: Please quote your best price의 의미를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'We are pleased to inform의 용법을 설명하시오.',
        answer: '기쁜 마음으로 알려드립니다 (긍정적 통보)',
        prompt: `무역영어 3급 기초영어 문제입니다.\n\n문제: We are pleased to inform의 용법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'at your earliest convenience의 의미를 설명하시오.',
        answer: '가능한 빠른 시일 내에',
        prompt: `무역영어 3급 기초영어 문제입니다.\n\n문제: at your earliest convenience의 의미를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: 'subject to의 의미를 설명하시오.',
        answer: '~을 조건으로, ~에 따라',
        prompt: `무역영어 3급 기초영어 문제입니다.\n\n문제: subject to의 의미를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: 'in compliance with의 의미를 설명하시오.',
        answer: '~에 따라, ~을 준수하여',
        prompt: `무역영어 3급 기초영어 문제입니다.\n\n문제: in compliance with의 의미를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
];

export default function BasicenglishStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('basic-english-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('basic-english-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-teal-600 font-medium">기초영어</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">기초영어 학습</h1>
