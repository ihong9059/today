...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '생크림 보관법을 설명하시오.',
        answer: '냉장보관(4°C), 밀폐, 빠른 사용',
        prompt: `제과기능사 식품위생 문제입니다.\n\n문제: 생크림 보관법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '완제품 보관을 설명하시오.',
        answer: '종류별 적정온도, 습도관리, 유통기한',
        prompt: `제과기능사 식품위생 문제입니다.\n\n문제: 완제품 보관을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '작업장 위생을 설명하시오.',
        answer: '청결, 환기, 해충방지, 정리정돈',
        prompt: `제과기능사 식품위생 문제입니다.\n\n문제: 작업장 위생을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '개인위생 관리를 설명하시오.',
        answer: '손씻기, 위생복, 위생모, 건강관리',
        prompt: `제과기능사 식품위생 문제입니다.\n\n문제: 개인위생 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '알레르기 표시를 설명하시오.',
        answer: '계란, 우유, 밀, 땅콩 등 표시 의무',
        prompt: `제과기능사 식품위생 문제입니다.\n\n문제: 알레르기 표시를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function PastryhygieneStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('pastry-hygiene-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('pastry-hygiene-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/service/pastry" className="text-gray-600 hover:text-rose-600">제과기능사</Link>
            <span className="text-gray-300">›</span>
            <span className="text-rose-600 font-medium">식품위생</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">식품위생 학습</h1>
                <p className="text-rose-100">제과기능사</p>
              </div>
            </div>
