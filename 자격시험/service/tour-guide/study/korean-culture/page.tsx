...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '유네스코 세계유산을 설명하시오.',
        answer: '경복궁, 창덕궁, 불국사, 석굴암 등',
        prompt: `관광통역안내사 한국문화 문제입니다.\n\n문제: 유네스코 세계유산을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '한국의 전통음식을 설명하시오.',
        answer: '김치, 불고기, 비빔밥, 한정식',
        prompt: `관광통역안내사 한국문화 문제입니다.\n\n문제: 한국의 전통음식을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '전통예술을 설명하시오.',
        answer: '판소리, 탈춤, 사물놀이, 한복',
        prompt: `관광통역안내사 한국문화 문제입니다.\n\n문제: 전통예술을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '한국의 명절을 설명하시오.',
        answer: '설날, 추석, 정월대보름, 단오',
        prompt: `관광통역안내사 한국문화 문제입니다.\n\n문제: 한국의 명절을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '현대 한류를 설명하시오.',
        answer: 'K-POP, 드라마, 영화, 음식한류',
        prompt: `관광통역안내사 한국문화 문제입니다.\n\n문제: 현대 한류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function KoreancultureStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('korean-culture-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('korean-culture-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-rose-600 font-medium">한국문화</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">한국문화 학습</h1>
