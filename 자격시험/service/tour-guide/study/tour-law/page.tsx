...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '관광기본법의 목적을 설명하시오.',
        answer: '관광진흥, 국민경제발전, 국민복지향상',
        prompt: `관광통역안내사 관광법규 문제입니다.\n\n문제: 관광기본법의 목적을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '관광사업의 종류를 설명하시오.',
        answer: '여행업, 관광숙박업, 관광객이용시설업',
        prompt: `관광통역안내사 관광법규 문제입니다.\n\n문제: 관광사업의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '관광통역안내사 업무를 설명하시오.',
        answer: '외국인 대상 관광안내, 통역',
        prompt: `관광통역안내사 관광법규 문제입니다.\n\n문제: 관광통역안내사 업무를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '자격 취소사유를 설명하시오.',
        answer: '부정행위, 자격증 대여, 법령위반',
        prompt: `관광통역안내사 관광법규 문제입니다.\n\n문제: 자격 취소사유를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '관광진흥개발기금을 설명하시오.',
        answer: '관광시설 지원, 홍보, 인력양성',
        prompt: `관광통역안내사 관광법규 문제입니다.\n\n문제: 관광진흥개발기금을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '안내사의 자세를 설명하시오.',
        answer: '친절, 정확, 안전, 문화존중',
        prompt: `관광통역안내사 관광법규 문제입니다.\n\n문제: 안내사의 자세를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '고객응대 요령을 설명하시오.',
        answer: '경청, 명확한 설명, 불만처리',
        prompt: `관광통역안내사 관광법규 문제입니다.\n\n문제: 고객응대 요령을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '안전관리를 설명하시오.',
        answer: '인원파악, 응급상황대비, 보험',
        prompt: `관광통역안내사 관광법규 문제입니다.\n\n문제: 안전관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '문화차이 대응을 설명하시오.',
        answer: '문화존중, 편견없는 태도, 배려',
        prompt: `관광통역안내사 관광법규 문제입니다.\n\n문제: 문화차이 대응을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '비밀유지의무를 설명하시오.',
        answer: '개인정보보호, 업무상비밀',
        prompt: `관광통역안내사 관광법규 문제입니다.\n\n문제: 비밀유지의무를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
...
export default function TourlawStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('tour-law-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('tour-law-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/service/tour-guide" className="text-gray-600 hover:text-rose-600">관광통역안내사</Link>
            <span className="text-gray-300">›</span>
            <span className="text-rose-600 font-medium">관광법규</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">관광법규 학습</h1>
                <p className="text-rose-100">관광통역안내사</p>
              </div>
            </div>
