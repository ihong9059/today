...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '레스토랑 유형을 설명하시오.',
        answer: '파인다이닝, 캐주얼, 뷔페, 커피숍',
        prompt: `호텔관리사 식음료관리 문제입니다.\n\n문제: 레스토랑 유형을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '메뉴 계획을 설명하시오.',
        answer: '원가분석, 인기도, 계절메뉴',
        prompt: `호텔관리사 식음료관리 문제입니다.\n\n문제: 메뉴 계획을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '주장관리를 설명하시오.',
        answer: '와인리스트, 재고, 온도관리',
        prompt: `호텔관리사 식음료관리 문제입니다.\n\n문제: 주장관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '위생관리를 설명하시오.',
        answer: 'HACCP, 식재료관리, 조리위생',
        prompt: `호텔관리사 식음료관리 문제입니다.\n\n문제: 위생관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '원가관리를 설명하시오.',
        answer: '식자재비율, 손익분기, 가격결정',
        prompt: `호텔관리사 식음료관리 문제입니다.\n\n문제: 원가관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function HotelfbStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('hotel-fb-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('hotel-fb-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/service/hotel-service" className="text-gray-600 hover:text-rose-600">호텔관리사</Link>
            <span className="text-gray-300">›</span>
            <span className="text-rose-600 font-medium">식음료관리</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">식음료관리 학습</h1>
                <p className="text-rose-100">호텔관리사</p>
              </div>
            </div>
