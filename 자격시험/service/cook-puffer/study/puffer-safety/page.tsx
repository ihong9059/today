...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '중독 증상을 설명하시오.',
        answer: '입술 마비→사지 마비→호흡곤란',
        prompt: `복어조리기능사 안전관리 문제입니다.\n\n문제: 중독 증상을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '응급처치를 설명하시오.',
        answer: '즉시 119, 인공호흡, 병원 이송',
        prompt: `복어조리기능사 안전관리 문제입니다.\n\n문제: 응급처치를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '독성부위 처리를 설명하시오.',
        answer: '별도 용기, 밀봉, 소각 또는 매립',
        prompt: `복어조리기능사 안전관리 문제입니다.\n\n문제: 독성부위 처리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '작업장 관리를 설명하시오.',
        answer: '전용 도마/칼, 세척 철저, 기록유지',
        prompt: `복어조리기능사 안전관리 문제입니다.\n\n문제: 작업장 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '구입시 확인사항을 설명하시오.',
        answer: '허가업소, 종류 확인, 신선도 체크',
        prompt: `복어조리기능사 안전관리 문제입니다.\n\n문제: 구입시 확인사항을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function PuffersafetyStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('puffer-safety-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('puffer-safety-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-rose-600 font-medium">안전관리</span>
          </nav>
        </div>
      </header>
