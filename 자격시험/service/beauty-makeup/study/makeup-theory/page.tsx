...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '메이크업 도구를 설명하시오.',
        answer: '브러시, 스펀지, 퍼프, 아이래시컬러',
        prompt: `미용사(메이크업) 메이크업 이론 문제입니다.\n\n문제: 메이크업 도구를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '피부톤 분석을 설명하시오.',
        answer: '웜톤, 쿨톤, 뉴트럴',
        prompt: `미용사(메이크업) 메이크업 이론 문제입니다.\n\n문제: 피부톤 분석을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '얼굴형 분석을 설명하시오.',
        answer: '타원형, 둥근형, 각진형, 긴형',
        prompt: `미용사(메이크업) 메이크업 이론 문제입니다.\n\n문제: 얼굴형 분석을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '베이스 메이크업을 설명하시오.',
        answer: '프라이머→파운데이션→컨실러→파우더',
        prompt: `미용사(메이크업) 메이크업 이론 문제입니다.\n\n문제: 베이스 메이크업을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '색조 화장품을 설명하시오.',
        answer: '아이섀도, 블러셔, 립스틱, 마스카라',
        prompt: `미용사(메이크업) 메이크업 이론 문제입니다.\n\n문제: 색조 화장품을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '컨투어링을 설명하시오.',
        answer: '명암으로 얼굴형 보정, 쉐딩+하이라이트',
        prompt: `미용사(메이크업) 메이크업 이론 문제입니다.\n\n문제: 컨투어링을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '아이 메이크업을 설명하시오.',
        answer: '섀도→라이너→마스카라→눈썹',
        prompt: `미용사(메이크업) 메이크업 이론 문제입니다.\n\n문제: 아이 메이크업을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '립 메이크업을 설명하시오.',
        answer: '립라이너→립스틱→글로스',
        prompt: `미용사(메이크업) 메이크업 이론 문제입니다.\n\n문제: 립 메이크업을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '웨딩 메이크업을 설명하시오.',
        answer: '화사함, 지속력, 사진발 고려',
        prompt: `미용사(메이크업) 메이크업 이론 문제입니다.\n\n문제: 웨딩 메이크업을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '무대 메이크업을 설명하시오.',
        answer: '강조, 진한 색상, 조명 고려',
        prompt: `미용사(메이크업) 메이크업 이론 문제입니다.\n\n문제: 무대 메이크업을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function MakeuptheoryStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('makeup-theory-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('makeup-theory-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/service/beauty-makeup" className="text-gray-600 hover:text-rose-600">미용사(메이크업)</Link>
            <span className="text-gray-300">›</span>
            <span className="text-rose-600 font-medium">메이크업 이론</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">메이크업 이론 학습</h1>
                <p className="text-rose-100">미용사(메이크업)</p>
              </div>
            </div>
