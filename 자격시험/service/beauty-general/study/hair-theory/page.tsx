...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '모발의 구조를 설명하시오.',
        answer: '모표피, 모피질, 모수질의 3층 구조',
        prompt: `미용사(일반) 헤어 이론 문제입니다.\n\n문제: 모발의 구조를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '모발의 생장주기를 설명하시오.',
        answer: '성장기(2-6년), 퇴행기(2주), 휴지기(3개월)',
        prompt: `미용사(일반) 헤어 이론 문제입니다.\n\n문제: 모발의 생장주기를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '두피의 유형을 설명하시오.',
        answer: '건성, 지성, 민감성, 비듬성',
        prompt: `미용사(일반) 헤어 이론 문제입니다.\n\n문제: 두피의 유형을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '샴푸의 원리를 설명하시오.',
        answer: '계면활성제가 오염물 유화/제거',
        prompt: `미용사(일반) 헤어 이론 문제입니다.\n\n문제: 샴푸의 원리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '모발손상 원인을 설명하시오.',
        answer: '화학처리, 열, 자외선, 물리적 손상',
        prompt: `미용사(일반) 헤어 이론 문제입니다.\n\n문제: 모발손상 원인을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '기본 커트 도구를 설명하시오.',
        answer: '커트가위, 틴닝가위, 레이저, 빗',
        prompt: `미용사(일반) 헤어 이론 문제입니다.\n\n문제: 기본 커트 도구를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '그라데이션 커트를 설명하시오.',
        answer: '위로 갈수록 길게, 무게감 있는 스타일',
        prompt: `미용사(일반) 헤어 이론 문제입니다.\n\n문제: 그라데이션 커트를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '레이어 커트를 설명하시오.',
        answer: '위로 갈수록 짧게, 움직임 있는 스타일',
        prompt: `미용사(일반) 헤어 이론 문제입니다.\n\n문제: 레이어 커트를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '원랭스 커트를 설명하시오.',
        answer: '일직선, 같은 길이, 무게선 강조',
        prompt: `미용사(일반) 헤어 이론 문제입니다.\n\n문제: 원랭스 커트를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '스퀘어 커트를 설명하시오.',
        answer: '각진 형태, 라인 강조',
        prompt: `미용사(일반) 헤어 이론 문제입니다.\n\n문제: 스퀘어 커트를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
...
export default function HairtheoryStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('hair-theory-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('hair-theory-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/service/beauty-general" className="text-gray-600 hover:text-rose-600">미용사(일반)</Link>
            <span className="text-gray-300">›</span>
            <span className="text-rose-600 font-medium">헤어 이론</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">헤어 이론 학습</h1>
                <p className="text-rose-100">미용사(일반)</p>
              </div>
            </div>
