...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '펌의 원리를 설명하시오.',
        answer: '환원→모발연화→산화→형태고정',
        prompt: `미용사(일반) 펌/염색 문제입니다.\n\n문제: 펌의 원리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '콜드펌과 열펌을 설명하시오.',
        answer: '콜드(상온), 열펌(열로 강한 컬)',
        prompt: `미용사(일반) 펌/염색 문제입니다.\n\n문제: 콜드펌과 열펌을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '염색의 원리를 설명하시오.',
        answer: '산화제→모표피 열림→색소 침투',
        prompt: `미용사(일반) 펌/염색 문제입니다.\n\n문제: 염색의 원리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '탈색과 염색 차이를 설명하시오.',
        answer: '탈색(멜라닌 분해), 염색(색소 첨가)',
        prompt: `미용사(일반) 펌/염색 문제입니다.\n\n문제: 탈색과 염색 차이를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '패치테스트를 설명하시오.',
        answer: '알레르기 확인, 48시간 전 피부테스트',
        prompt: `미용사(일반) 펌/염색 문제입니다.\n\n문제: 패치테스트를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function HairpermStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('hair-perm-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('hair-perm-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-rose-600 font-medium">펌/염색</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">펌/염색 학습</h1>
