...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '호텔 마케팅믹스를 설명하시오.',
        answer: '상품, 가격, 유통, 촉진(4P)',
        prompt: `호텔경영사 호텔마케팅 문제입니다.\n\n문제: 호텔 마케팅믹스를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '온라인 마케팅을 설명하시오.',
        answer: 'OTA, 자사홈페이지, SNS마케팅',
        prompt: `호텔경영사 호텔마케팅 문제입니다.\n\n문제: 온라인 마케팅을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '고객관계관리를 설명하시오.',
        answer: 'CRM, 멤버십, 고객데이터 활용',
        prompt: `호텔경영사 호텔마케팅 문제입니다.\n\n문제: 고객관계관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '브랜드 관리를 설명하시오.',
        answer: '브랜드 이미지, 포지셔닝, 차별화',
        prompt: `호텔경영사 호텔마케팅 문제입니다.\n\n문제: 브랜드 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '경쟁분석을 설명하시오.',
        answer: 'SWOT, 벤치마킹, 시장조사',
        prompt: `호텔경영사 호텔마케팅 문제입니다.\n\n문제: 경쟁분석을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function HotelmarketingStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('hotel-marketing-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('hotel-marketing-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-rose-600 font-medium">호텔마케팅</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">호텔마케팅 학습</h1>
