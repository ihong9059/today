...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '면도 준비를 설명하시오.',
        answer: '스팀타월, 쉐이빙폼, 피부연화',
        prompt: `이용사 면도 문제입니다.\n\n문제: 면도 준비를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '면도 방향을 설명하시오.',
        answer: '결 방향으로, 피부 당기며',
        prompt: `이용사 면도 문제입니다.\n\n문제: 면도 방향을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '면도기 관리를 설명하시오.',
        answer: '날 교체, 소독, 건조보관',
        prompt: `이용사 면도 문제입니다.\n\n문제: 면도기 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '면도 후 관리를 설명하시오.',
        answer: '애프터쉐이브, 보습, 진정',
        prompt: `이용사 면도 문제입니다.\n\n문제: 면도 후 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '면도 트러블 대처를 설명하시오.',
        answer: '상처시 지혈, 염증예방',
        prompt: `이용사 면도 문제입니다.\n\n문제: 면도 트러블 대처를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
...
export default function BarbershaveStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('barber-shave-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('barber-shave-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-rose-600 font-medium">면도</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">면도 학습</h1>
