...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '이용업의 정의를 설명하시오.',
        answer: '손님의 두발, 수염을 깎거나 다듬는 영업',
        prompt: `이용사 이용 이론 문제입니다.\n\n문제: 이용업의 정의를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '기본 도구를 설명하시오.',
        answer: '가위, 빗, 클리퍼, 면도기',
        prompt: `이용사 이용 이론 문제입니다.\n\n문제: 기본 도구를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '두부의 구분을 설명하시오.',
        answer: '전두부, 두정부, 측두부, 후두부',
        prompt: `이용사 이용 이론 문제입니다.\n\n문제: 두부의 구분을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '모발의 특성을 설명하시오.',
        answer: '굵기, 밀도, 형태(직모/곱슬)',
        prompt: `이용사 이용 이론 문제입니다.\n\n문제: 모발의 특성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '고객상담을 설명하시오.',
        answer: '스타일 확인, 두상/모질 파악',
        prompt: `이용사 이용 이론 문제입니다.\n\n문제: 고객상담을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '클리퍼 사용법을 설명하시오.',
        answer: '가드 선택, 아래→위로, 균일하게',
        prompt: `이용사 이용 이론 문제입니다.\n\n문제: 클리퍼 사용법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '가위 커트법을 설명하시오.',
        answer: '빗으로 들어 자르기, 각도 조절',
        prompt: `이용사 이용 이론 문제입니다.\n\n문제: 가위 커트법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '그라데이션을 설명하시오.',
        answer: '아래는 짧게, 위로 갈수록 길게',
        prompt: `이용사 이용 이론 문제입니다.\n\n문제: 그라데이션을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '레이저 커트를 설명하시오.',
        answer: '가위 대신 레이저, 질감 표현',
        prompt: `이용사 이용 이론 문제입니다.\n\n문제: 레이저 커트를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '마무리 정리를 설명하시오.',
        answer: '라인정리, 잔머리제거, 스타일링',
        prompt: `이용사 이용 이론 문제입니다.\n\n문제: 마무리 정리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function BarbertheoryStudyPage() {
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('barber-theory-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/service/barber" className="text-gray-600 hover:text-rose-600">이용사</Link>
            <span className="text-gray-300">›</span>
            <span className="text-rose-600 font-medium">이용 이론</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">이용 이론 학습</h1>
                <p className="text-rose-100">이용사</p>
              </div>
            </div>
