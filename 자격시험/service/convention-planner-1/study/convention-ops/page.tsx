...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '등록 시스템을 설명하시오.',
        answer: '온라인등록, 현장등록, 네임택',
        prompt: `컨벤션기획사1급 컨벤션 운영 문제입니다.\n\n문제: 등록 시스템을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '세션 운영을 설명하시오.',
        answer: '타임키핑, 동시통역, 장비관리',
        prompt: `컨벤션기획사1급 컨벤션 운영 문제입니다.\n\n문제: 세션 운영을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '의전을 설명하시오.',
        answer: 'VIP관리, 서열, 의전차량, 수행',
        prompt: `컨벤션기획사1급 컨벤션 운영 문제입니다.\n\n문제: 의전을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '전시 운영을 설명하시오.',
        answer: '부스배치, 참가업체관리, 철수',
        prompt: `컨벤션기획사1급 컨벤션 운영 문제입니다.\n\n문제: 전시 운영을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '평가와 보고를 설명하시오.',
        answer: '만족도조사, 성과분석, 최종보고',
        prompt: `컨벤션기획사1급 컨벤션 운영 문제입니다.\n\n문제: 평가와 보고를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function ConventionopsStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('convention-ops-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('convention-ops-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-rose-600 font-medium">컨벤션 운영</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">컨벤션 운영 학습</h1>
