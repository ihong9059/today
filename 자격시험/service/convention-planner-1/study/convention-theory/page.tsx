...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '컨벤션의 정의를 설명하시오.',
        answer: '회의, 전시, 이벤트, 인센티브의 복합 산업',
        prompt: `컨벤션기획사1급 컨벤션 이론 문제입니다.\n\n문제: 컨벤션의 정의를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'MICE 산업을 설명하시오.',
        answer: 'Meeting, Incentive, Convention, Exhibition',
        prompt: `컨벤션기획사1급 컨벤션 이론 문제입니다.\n\n문제: MICE 산업을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '컨벤션 시설을 설명하시오.',
        answer: '컨벤션센터, 호텔, 전시장, 유니크베뉴',
        prompt: `컨벤션기획사1급 컨벤션 이론 문제입니다.\n\n문제: 컨벤션 시설을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: 'PCO의 역할을 설명하시오.',
        answer: 'Professional Congress Organizer, 전문기획',
        prompt: `컨벤션기획사1급 컨벤션 이론 문제입니다.\n\n문제: PCO의 역할을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '국제기구 회의를 설명하시오.',
        answer: 'UN, APEC, G20 등 정부간 회의',
        prompt: `컨벤션기획사1급 컨벤션 이론 문제입니다.\n\n문제: 국제기구 회의를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    id: 'convention-planning',
    name: '컨벤션 기획',
    color: 'from-rose-500 to-pink-500',
    questions: [
      {
        id: 1,
        question: '기획 프로세스를 설명하시오.',
        answer: '유치→기획→운영→평가',
        prompt: `컨벤션기획사1급 컨벤션 이론 문제입니다.\n\n문제: 기획 프로세스를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '예산 수립을 설명하시오.',
        answer: '수입(등록비,후원)→지출(장소,인력)',
        prompt: `컨벤션기획사1급 컨벤션 이론 문제입니다.\n\n문제: 예산 수립을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '프로그램 구성을 설명하시오.',
        answer: '기조연설, 세션, 네트워킹, 관광',
        prompt: `컨벤션기획사1급 컨벤션 이론 문제입니다.\n\n문제: 프로그램 구성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '연사 관리를 설명하시오.',
        answer: '섭외, 계약, 발표자료, 의전',
        prompt: `컨벤션기획사1급 컨벤션 이론 문제입니다.\n\n문제: 연사 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '후원 유치를 설명하시오.',
        answer: '스폰서십 제안, 등급별 혜택',
        prompt: `컨벤션기획사1급 컨벤션 이론 문제입니다.\n\n문제: 후원 유치를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function ConventiontheoryStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('convention-theory-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('convention-theory-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/service/convention-planner-1" className="text-gray-600 hover:text-rose-600">컨벤션기획사1급</Link>
            <span className="text-gray-300">›</span>
            <span className="text-rose-600 font-medium">컨벤션 이론</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">컨벤션 이론 학습</h1>
                <p className="text-rose-100">컨벤션기획사1급</p>
              </div>
            </div>
