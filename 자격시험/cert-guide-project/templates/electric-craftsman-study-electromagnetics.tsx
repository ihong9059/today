...
export default function ElectricCraftsmanElectromagneticsStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('electric-craftsman-electromagnetics-completed');
    if (saved) {
  ...
  const markComplete = () => {
    ...
    localStorage.setItem('electric-craftsman-electromagnetics-completed', JSON.stringify([...newCompleted]));
  };
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-2xl font-bold text-gray-800">전기자기학 학습하기</h1>
          </div>
