      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <a href="/category/mechanical/electric-engineer" className="text-gray-600 hover:text-yellow-600">전기기사</a>
            <span className="text-gray-300">›</span>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-yellow-100">Engineer Electricity - 시험 과목 및 출제 경향</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        ...
        <div className="grid md:grid-cols-4 gap-4">
          <div className="text-center p-4 bg-gray-50 rounded-lg">
            <p className="text-3xl font-bold text-yellow-600">5과목</p>
            <p className="text-sm text-gray-500">시험 과목</p>
          </div>
          <div className="text-center p-4 bg-gray-50 rounded-lg">
            <p className="text-3xl font-bold text-yellow-600">100문항</p>
            <p className="text-sm text-gray-500">총 문제 수</p>
          </div>
          <div className="text-center p-4 bg-gray-50 rounded-lg">
            <p className="text-3xl font-bold text-yellow-600">2시간 30분</p>
            <p className="text-sm text-gray-500">시험 시간</p>
          </div>
          <div className="text-center p-4 bg-gray-50 rounded-lg">
            <p className="text-3xl font-bold text-yellow-600">객관식</p>
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        ...
        <div className="grid md:grid-cols-4 gap-4">
          ...
          <div className="text-center p-4 bg-gray-50 rounded-lg">
            <p className="text-3xl font-bold text-yellow-600">100점</p>
            <p className="text-sm text-gray-500">만점</p>
          </div>
          <div className="text-center p-4 bg-gray-50 rounded-lg">
            <p className="text-3xl font-bold text-yellow-600">60점</p>
      ...
      <div className="space-y-6">
        ...
        {sections.map((section, index) => (
          <div key={index} className="bg-white rounded-xl shadow-md overflow-hidden">
            <div className={`p-4 bg-gradient-to-r ${
              section.color === 'yellow' ? 'from-yellow-500 to-amber-500' :
              section.color === 'orange' ? 'from-orange-500 to-red-500' :
              section.color === 'red' ? 'from-red-500 to-rose-500' :
                ...
                <div>
                  ...
                  {section.studyLink && (
                    <a
                      ...
                      className={`inline-flex items-center gap-2 mt-4 px-4 py-2 ${
                        section.color === 'yellow' ? 'bg-yellow-500 hover:bg-yellow-600' :
                        section.color === 'orange' ? 'bg-orange-500 hover:bg-orange-600' :
                        section.color === 'red' ? 'bg-red-500 hover:bg-red-600' :
                        'bg-teal-500 hover:bg-teal-600'
                      } text-white rounded-lg transition text-sm font-medium`}
                    >
                      📚 {section.name} 학습하기 →
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-200">
            <h3 className="font-bold text-yellow-700 mb-2">1단계: 계산 연습</h3>
            <p className="text-sm text-gray-600">단락전류, 전압강하, 역률 계산 반복. 공식 암기 필수</p>
          </div>
          <div className="p-4 bg-orange-50 rounded-lg border border-orange-200">
            <h3 className="font-bold text-orange-700 mb-2">2단계: 설비 이해</h3>
            <p className="text-sm text-gray-600">수변전설비, 배전반 구성 등 설비 구조 학습</p>
          </div>
          <div className="p-4 bg-red-50 rounded-lg border border-red-200">
            <h3 className="font-bold text-red-700 mb-2">3단계: 기출 분석</h3>
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        ...
        <div className="space-y-3">
          {[
            { name: '전기설비 설계 문제', time: '45분', color: 'bg-yellow-500' },
            { name: '전력계통 계산 문제', time: '40분', color: 'bg-orange-500' },
            { name: '전기기기 응용 문제', time: '35분', color: 'bg-red-500' },
            { name: '전기법규/시설 문제', time: '20분', color: 'bg-teal-500' },
