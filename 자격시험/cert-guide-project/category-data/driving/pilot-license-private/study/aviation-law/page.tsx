...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '항공안전법의 목적을 설명하시오.',
        answer: '항공기 안전운항, 사고예방, 국제기준 준수',
        prompt: `자가용조종사 항공법규 문제입니다.\n\n문제: 항공안전법의 목적을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '비행공역의 종류를 설명하시오.',
        answer: 'A/B/C/D/E/G 공역, 관제/비관제 구분',
        prompt: `자가용조종사 항공법규 문제입니다.\n\n문제: 비행공역의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'VFR 기상최저치를 설명하시오.',
        answer: '시정 5km 이상, 구름과 거리(수직/수평)',
        prompt: `자가용조종사 항공법규 문제입니다.\n\n문제: VFR 기상최저치를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '비행계획서 제출을 설명하시오.',
        answer: '비행목적, 경로, 고도, 예정시간, 비상대책',
        prompt: `자가용조종사 항공법규 문제입니다.\n\n문제: 비행계획서 제출을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '조종사 면허의 종류를 설명하시오.',
        answer: '자가용/사업용/운송용, 한정사항(기종/등급)',
        prompt: `자가용조종사 항공법규 문제입니다.\n\n문제: 조종사 면허의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    id: 'air-traffic',
    ...
    questions: [
      {
        id: 1,
        question: 'ATC 교신절차를 설명하시오.',
        answer: '호출부호, 위치보고, 허가요청, 확인응답',
        prompt: `자가용조종사 항공법규 문제입니다.\n\n문제: ATC 교신절차를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '비행우선순위를 설명하시오.',
        answer: '조난항공기>긴급항공기>군용기>민간기',
        prompt: `자가용조종사 항공법규 문제입니다.\n\n문제: 비행우선순위를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '활주로 식별표지를 설명하시오.',
        answer: '번호(방위), 중심선, 착륙대표지',
        prompt: `자가용조종사 항공법규 문제입니다.\n\n문제: 활주로 식별표지를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '경항공기 운항규칙을 설명하시오.',
        answer: '고도제한, 공역제한, 야간비행제한',
        prompt: `자가용조종사 항공법규 문제입니다.\n\n문제: 경항공기 운항규칙을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '항공기 충돌방지를 설명하시오.',
        answer: '우측통과, 추월시 우측, 정면대향시 우회전',
        prompt: `자가용조종사 항공법규 문제입니다.\n\n문제: 항공기 충돌방지를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function AviationlawStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('aviation-law-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('aviation-law-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-gray-600 font-medium">항공법규</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">항공법규 학습</h1>
