...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '양력 발생원리를 설명하시오.',
        answer: '베르누이 원리, 받음각, 익형의 곡률',
        prompt: `자가용조종사 비행이론 문제입니다.\n\n문제: 양력 발생원리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '4가지 비행력을 설명하시오.',
        answer: '양력(상향), 중력(하향), 추력(전방), 항력(후방)',
        prompt: `자가용조종사 비행이론 문제입니다.\n\n문제: 4가지 비행력을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '실속(Stall)을 설명하시오.',
        answer: '임계받음각 초과, 양력급감, 회복조작',
        prompt: `자가용조종사 비행이론 문제입니다.\n\n문제: 실속(Stall)을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '안정성과 조종성을 설명하시오.',
        answer: '세로/가로/방향안정성, 상반되는 관계',
        prompt: `자가용조종사 비행이론 문제입니다.\n\n문제: 안정성과 조종성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '조종면의 종류를 설명하시오.',
        answer: '에일러론(롤), 엘리베이터(피치), 러더(요)',
        prompt: `자가용조종사 비행이론 문제입니다.\n\n문제: 조종면의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '이륙성능에 영향을 주는 요소를 설명하시오.',
        answer: '중량, 온도, 고도, 바람, 활주로상태',
        prompt: `자가용조종사 비행이론 문제입니다.\n\n문제: 이륙성능에 영향을 주는 요소를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '선회비행을 설명하시오.',
        answer: '뱅크각, 로드팩터, 실속속도증가',
        prompt: `자가용조종사 비행이론 문제입니다.\n\n문제: 선회비행을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '비상착륙 절차를 설명하시오.',
        answer: '착륙지 선정, 체크리스트, 조난신호',
        prompt: `자가용조종사 비행이론 문제입니다.\n\n문제: 비상착륙 절차를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '연료관리를 설명하시오.',
        answer: '연료계산, 예비연료, 소모량 점검',
        prompt: `자가용조종사 비행이론 문제입니다.\n\n문제: 연료관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '중량균형을 설명하시오.',
        answer: '무게중심(CG), 하중배분, 비행한계',
        prompt: `자가용조종사 비행이론 문제입니다.\n\n문제: 중량균형을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function AviationtheoryStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('aviation-theory-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('aviation-theory-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/driving/pilot-license-private" className="text-gray-600 hover:text-gray-600">자가용조종사</Link>
            <span className="text-gray-300">›</span>
            <span className="text-gray-600 font-medium">비행이론</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">비행이론 학습</h1>
                <p className="text-gray-100">자가용조종사</p>
              </div>
            </div>
