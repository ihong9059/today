...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '낙수자 구조방법을 설명하시오.',
        answer: '낙수자 주시, 구명부환 투척, 접근법',
        prompt: `요트조종면허 안전운항 문제입니다.\n\n문제: 낙수자 구조방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '전복시 대처를 설명하시오.',
        answer: '선체부착, 구명동의 착용, 구조신호',
        prompt: `요트조종면허 안전운항 문제입니다.\n\n문제: 전복시 대처를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '좌초시 대처를 설명하시오.',
        answer: '역추진, 중량이동, 만조대기, 구조요청',
        prompt: `요트조종면허 안전운항 문제입니다.\n\n문제: 좌초시 대처를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '폭풍우 대비를 설명하시오.',
        answer: '귀항, 세일축소, 해치폐쇄, 구명동의착용',
        prompt: `요트조종면허 안전운항 문제입니다.\n\n문제: 폭풍우 대비를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '충돌예방을 설명하시오.',
        answer: '경계강화, 조기피항, 우현우선, 동력선회피',
        prompt: `요트조종면허 안전운항 문제입니다.\n\n문제: 충돌예방을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function YachtsafetyStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('yacht-safety-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('yacht-safety-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-gray-600 font-medium">안전운항</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">안전운항 학습</h1>
