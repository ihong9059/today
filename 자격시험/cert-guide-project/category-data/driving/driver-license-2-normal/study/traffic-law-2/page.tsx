...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '도로교통법의 목적을 설명하시오.',
        answer: '교통안전과 원활한 소통, 사고예방, 피해경감',
        prompt: `2종 보통면허 도로교통법규 문제입니다.\n\n문제: 도로교통법의 목적을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '운전면허 종류를 설명하시오.',
        answer: '1종(대형/보통/소형/특수), 2종(보통/소형/원동기)',
        prompt: `2종 보통면허 도로교통법규 문제입니다.\n\n문제: 운전면허 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '면허취소 사유를 설명하시오.',
        answer: '음주운전, 뺑소니, 무면허운전 방조, 벌점초과',
        prompt: `2종 보통면허 도로교통법규 문제입니다.\n\n문제: 면허취소 사유를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '어린이보호구역 규정을 설명하시오.',
        answer: '30km/h 이하, 주정차금지, 사고시 가중처벌',
        prompt: `2종 보통면허 도로교통법규 문제입니다.\n\n문제: 어린이보호구역 규정을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '보행자 보호의무를 설명하시오.',
        answer: '횡단보도 앞 일시정지, 보행자 우선, 안전거리 확보',
        prompt: `2종 보통면허 도로교통법규 문제입니다.\n\n문제: 보행자 보호의무를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function Trafficlaw2StudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('traffic-law-2-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('traffic-law-2-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/driving/driver-license-2-normal" className="text-gray-600 hover:text-gray-600">2종 보통면허</Link>
            <span className="text-gray-300">›</span>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-100">2종 보통면허</p>
              </div>
            </div>
