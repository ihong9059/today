...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '이동식 크레인의 종류를 설명하시오.',
        answer: '트럭크레인, 크롤러크레인, 휠크레인, 타워크레인',
        prompt: `기중기운전기능사 기중기 이론 문제입니다.\n\n문제: 이동식 크레인의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '양중능력을 결정하는 요소를 설명하시오.',
        answer: '붐길이, 작업반경, 권상하중, 선회각도',
        prompt: `기중기운전기능사 기중기 이론 문제입니다.\n\n문제: 양중능력을 결정하는 요소를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '와이어로프 구조를 설명하시오.',
        answer: '심강, 스트랜드, 소선, 꼬임방향(S/Z)',
        prompt: `기중기운전기능사 기중기 이론 문제입니다.\n\n문제: 와이어로프 구조를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '훅의 안전장치를 설명하시오.',
        answer: '래치, 과부하방지장치, 권과방지장치, 풍속계',
        prompt: `기중기운전기능사 기중기 이론 문제입니다.\n\n문제: 훅의 안전장치를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '아웃트리거의 역할을 설명하시오.',
        answer: '지지면적 확대, 전도방지, 수평유지',
        prompt: `기중기운전기능사 기중기 이론 문제입니다.\n\n문제: 아웃트리거의 역할을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '레버 조작방법을 설명하시오.',
        answer: '권상/권하, 붐기복, 선회, 주행 레버',
        prompt: `기중기운전기능사 기중기 이론 문제입니다.\n\n문제: 레버 조작방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '양중작업 순서를 설명하시오.',
        answer: '아웃트리거설치-훅이동-슬링걸이-인양-이동-하역',
        prompt: `기중기운전기능사 기중기 이론 문제입니다.\n\n문제: 양중작업 순서를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '정격하중을 결정하는 방법을 설명하시오.',
        answer: '작업반경×정격총하중표, 붐길이 고려',
        prompt: `기중기운전기능사 기중기 이론 문제입니다.\n\n문제: 정격하중을 결정하는 방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '신호수 수신호를 설명하시오.',
        answer: '권상(주먹), 권하(손바닥), 정지(팔 수평)',
        prompt: `기중기운전기능사 기중기 이론 문제입니다.\n\n문제: 신호수 수신호를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '2인1조 작업원칙을 설명하시오.',
        answer: '운전자-신호수 호흡, 신호확인 후 작동',
        prompt: `기중기운전기능사 기중기 이론 문제입니다.\n\n문제: 2인1조 작업원칙을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function CranetheoryStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('crane-theory-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('crane-theory-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/driving/crane-license" className="text-gray-600 hover:text-gray-600">기중기운전기능사</Link>
            <span className="text-gray-300">›</span>
            <span className="text-gray-600 font-medium">기중기 이론</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">기중기 이론 학습</h1>
                <p className="text-gray-100">기중기운전기능사</p>
              </div>
            </div>
