...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '방어운전의 개념을 설명하시오.',
        answer: '상대방 과실 예측, 사고 미연 방지, 양보운전',
        prompt: `1종 보통면허 안전운전 문제입니다.\n\n문제: 방어운전의 개념을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '야간운전 주의사항을 설명하시오.',
        answer: '전조등 사용, 속도감소, 시야제한 인지, 피로운전 금지',
        prompt: `1종 보통면허 안전운전 문제입니다.\n\n문제: 야간운전 주의사항을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '악천후 운전요령을 설명하시오.',
        answer: '감속운전, 안전거리 확보, 급브레이크 금지, 시야확보',
        prompt: `1종 보통면허 안전운전 문제입니다.\n\n문제: 악천후 운전요령을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '고속도로 안전운전을 설명하시오.',
        answer: '차로준수, 졸음쉼터 활용, 고장시 갓길정차/삼각대설치',
        prompt: `1종 보통면허 안전운전 문제입니다.\n\n문제: 고속도로 안전운전을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '교차로 통행방법을 설명하시오.',
        answer: '서행진입, 신호준수, 보행자 우선, 우회전시 일시정지',
        prompt: `1종 보통면허 안전운전 문제입니다.\n\n문제: 교차로 통행방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '브레이크 고장시 대처방법을 설명하시오.',
        answer: '엔진브레이크, 핸드브레이크, 기어다운, 가드레일 이용',
        prompt: `1종 보통면허 안전운전 문제입니다.\n\n문제: 브레이크 고장시 대처방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '타이어 펑크시 대처를 설명하시오.',
        answer: '핸들 고정, 서서히 감속, 갓길 정차, 비상등 점등',
        prompt: `1종 보통면허 안전운전 문제입니다.\n\n문제: 타이어 펑크시 대처를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '교통사고 발생시 조치를 설명하시오.',
        answer: '부상자 구호, 경찰신고(112), 현장보존, 보험사 연락',
        prompt: `1종 보통면허 안전운전 문제입니다.\n\n문제: 교통사고 발생시 조치를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '화재발생시 대처를 설명하시오.',
        answer: '정차, 탑승자 대피, 소화기 사용, 119 신고',
        prompt: `1종 보통면허 안전운전 문제입니다.\n\n문제: 화재발생시 대처를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '침수도로 통행요령을 설명하시오.',
        answer: '수심확인, 저단기어 사용, 정차금지, 통행금지시 우회',
        prompt: `1종 보통면허 안전운전 문제입니다.\n\n문제: 침수도로 통행요령을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function SafedrivingStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('safe-driving-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('safe-driving-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-gray-600 font-medium">안전운전</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">안전운전 학습</h1>
