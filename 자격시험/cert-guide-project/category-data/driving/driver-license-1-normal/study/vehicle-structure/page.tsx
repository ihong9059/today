...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '4행정 사이클을 설명하시오.',
        answer: '흡입-압축-폭발-배기, 크랭크축 2회전에 1회 폭발',
        prompt: `1종 보통면허 자동차 구조 문제입니다.\n\n문제: 4행정 사이클을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '냉각장치의 구성을 설명하시오.',
        answer: '라디에이터, 냉각수, 워터펌프, 서모스탯, 냉각팬',
        prompt: `1종 보통면허 자동차 구조 문제입니다.\n\n문제: 냉각장치의 구성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '윤활장치의 역할을 설명하시오.',
        answer: '마찰감소, 냉각, 밀봉, 청정, 방청작용',
        prompt: `1종 보통면허 자동차 구조 문제입니다.\n\n문제: 윤활장치의 역할을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '변속기의 종류를 설명하시오.',
        answer: '수동(MT), 자동(AT), 무단(CVT), 듀얼클러치(DCT)',
        prompt: `1종 보통면허 자동차 구조 문제입니다.\n\n문제: 변속기의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '배기장치의 구성을 설명하시오.',
        answer: '배기다기관, 촉매변환기, 소음기, 배기관',
        prompt: `1종 보통면허 자동차 구조 문제입니다.\n\n문제: 배기장치의 구성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '유압브레이크 원리를 설명하시오.',
        answer: '파스칼 원리, 마스터실린더-휠실린더 연결, 배력장치',
        prompt: `1종 보통면허 자동차 구조 문제입니다.\n\n문제: 유압브레이크 원리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'ABS의 기능을 설명하시오.',
        answer: '급제동시 바퀴잠김 방지, 조향력 유지, ECU 제어',
        prompt: `1종 보통면허 자동차 구조 문제입니다.\n\n문제: ABS의 기능을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '조향장치의 구성을 설명하시오.',
        answer: '핸들, 조향축, 기어박스, 타이로드, 너클',
        prompt: `1종 보통면허 자동차 구조 문제입니다.\n\n문제: 조향장치의 구성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '타이어 공기압 관리를 설명하시오.',
        answer: '적정압력 유지, 월1회 점검, 편마모 방지, 연비향상',
        prompt: `1종 보통면허 자동차 구조 문제입니다.\n\n문제: 타이어 공기압 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '현가장치의 역할을 설명하시오.',
        answer: '충격흡수, 승차감 향상, 타이어 접지력 유지',
        prompt: `1종 보통면허 자동차 구조 문제입니다.\n\n문제: 현가장치의 역할을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function VehiclestructureStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('vehicle-structure-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('vehicle-structure-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-gray-600 font-medium">자동차 구조</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">자동차 구조 학습</h1>
