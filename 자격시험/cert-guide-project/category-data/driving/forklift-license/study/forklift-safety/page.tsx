    ...
    questions: [
      {
        ...
        answer: '과적재, 급회전, 경사지, 편하중, 과속',
        prompt: `지게차운전기능사 안전관리 문제입니다.\n\n문제: 전도사고 원인을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '충돌사고 예방을 설명하시오.',
        answer: '시야확보, 경적사용, 지정통로, 속도제한',
        prompt: `지게차운전기능사 안전관리 문제입니다.\n\n문제: 충돌사고 예방을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '협착재해 예방을 설명하시오.',
        answer: '마스트/차체 사이 금지, 포크 위 탑승금지',
        prompt: `지게차운전기능사 안전관리 문제입니다.\n\n문제: 협착재해 예방을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '화물낙하 방지를 설명하시오.',
        answer: '적재기준 준수, 포크 수평, 결속상태 확인',
        prompt: `지게차운전기능사 안전관리 문제입니다.\n\n문제: 화물낙하 방지를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '정기검사 항목을 설명하시오.',
        answer: '제동장치, 조향장치, 유압장치, 안전장치, 마스트',
        prompt: `지게차운전기능사 안전관리 문제입니다.\n\n문제: 정기검사 항목을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function ForkliftsafetyStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('forklift-safety-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('forklift-safety-progress', JSON.stringify(newCompleted));
  };
