...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '대형차 사각지대를 설명하시오.',
        answer: '전방/후방/측면 사각지대, 우회전시 내륜차 주의',
        prompt: `1종 대형면허 대형차 운전 문제입니다.\n\n문제: 대형차 사각지대를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '내륜차와 외륜차를 설명하시오.',
        answer: '회전시 안쪽바퀴가 안쪽으로, 바깥바퀴가 바깥으로',
        prompt: `1종 대형면허 대형차 운전 문제입니다.\n\n문제: 내륜차와 외륜차를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '대형차 제동거리 특성을 설명하시오.',
        answer: '공차/적재시 차이, 에어브레이크 특성, 페이드 현상',
        prompt: `1종 대형면허 대형차 운전 문제입니다.\n\n문제: 대형차 제동거리 특성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '언덕길 운전요령을 설명하시오.',
        answer: '저단기어, 배기브레이크 활용, 반클러치 금지',
        prompt: `1종 대형면허 대형차 운전 문제입니다.\n\n문제: 언덕길 운전요령을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '대형차 후진 요령을 설명하시오.',
        answer: '유도자 활용, 사이드미러 확인, 서행, 경음기 사용',
        prompt: `1종 대형면허 대형차 운전 문제입니다.\n\n문제: 대형차 후진 요령을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function LargedrivingStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('large-driving-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('large-driving-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/driving/driver-license-1-large" className="text-gray-600 hover:text-gray-600">1종 대형면허</Link>
            <span className="text-gray-300">›</span>
            <span className="text-gray-600 font-medium">대형차 운전</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">대형차 운전 학습</h1>
                <p className="text-gray-100">1종 대형면허</p>
              </div>
            </div>
