...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: 'C언어 포인터 개념을 설명하시오.',
        answer: '메모리 주소를 저장하는 변수',
        prompt: `정보처리기사 실기 문제입니다.\n\n문제: C언어 포인터 개념을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'Java 예외처리 방법을 설명하시오.',
        answer: 'try-catch-finally, throws',
        prompt: `정보처리기사 실기 문제입니다.\n\n문제: Java 예외처리 방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'Python 리스트 컴프리헨션을 설명하시오.',
        answer: '[표현식 for 항목 in 반복가능객체 if 조건]',
        prompt: `정보처리기사 실기 문제입니다.\n\n문제: Python 리스트 컴프리헨션을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 4,
        question: '재귀함수의 종료조건을 설명하시오.',
        answer: '기저조건(Base Case) 설정 필수',
        prompt: `정보처리기사 실기 문제입니다.\n\n문제: 재귀함수의 종료조건을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 5,
        question: '배열과 연결리스트를 비교하시오.',
        answer: '배열: 인덱스접근O(1), 연결리스트: 삽입삭제O(1)',
        prompt: `정보처리기사 실기 문제입니다.\n\n문제: 배열과 연결리스트를 비교하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
