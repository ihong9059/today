...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '프로세스 스케줄링 알고리즘을 설명하시오.',
        answer: 'FCFS, SJF, RR, 우선순위',
        prompt: `전자계산기조직응용기사 운영체제 문제입니다.\n\n문제: 프로세스 스케줄링 알고리즘을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 2,
        question: '교착상태 조건을 설명하시오.',
        answer: '상호배제, 점유대기, 비선점, 순환대기',
        prompt: `전자계산기조직응용기사 운영체제 문제입니다.\n\n문제: 교착상태 조건을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 3,
        question: '프로세스와 스레드를 비교하시오.',
        answer: '프로세스: 독립메모리, 스레드: 공유메모리',
        prompt: `전자계산기조직응용기사 운영체제 문제입니다.\n\n문제: 프로세스와 스레드를 비교하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 4,
        question: '문맥교환(Context Switch)을 설명하시오.',
        answer: 'CPU가 다른 프로세스로 전환시 상태 저장/복원',
        prompt: `전자계산기조직응용기사 운영체제 문제입니다.\n\n문제: 문맥교환(Context Switch)을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 5,
        question: '세마포어와 뮤텍스를 비교하시오.',
        answer: '세마포어: 카운팅, 뮤텍스: 이진(0/1)',
        prompt: `전자계산기조직응용기사 운영체제 문제입니다.\n\n문제: 세마포어와 뮤텍스를 비교하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
...
export default function OperatingsystemStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('operating-system-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('operating-system-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-blue-600 font-medium">운영체제</span>
          </nav>
        </div>
      </header>
