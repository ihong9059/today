...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '정보전략계획(ISP)을 설명하시오.',
        answer: '현행분석→목표설계→실행계획',
        prompt: `정보관리기술사 정보전략계획 문제입니다.\n\n문제: 정보전략계획(ISP)을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'EA 프레임워크를 설명하시오.',
        answer: 'Zachman, TOGAF, FEAF',
        prompt: `정보관리기술사 정보전략계획 문제입니다.\n\n문제: EA 프레임워크를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'BPR과 PI를 비교하시오.',
        answer: 'BPR: 급진적 혁신, PI: 점진적 개선',
        prompt: `정보관리기술사 정보전략계획 문제입니다.\n\n문제: BPR과 PI를 비교하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 4,
        question: 'IT 투자 평가 방법을 설명하시오.',
        answer: 'ROI, NPV, IRR, TCO',
        prompt: `정보관리기술사 정보전략계획 문제입니다.\n\n문제: IT 투자 평가 방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 5,
        question: '정보화 성숙도 모델을 설명하시오.',
        answer: 'CMMI, SPICE, ITIL',
        prompt: `정보관리기술사 정보전략계획 문제입니다.\n\n문제: 정보화 성숙도 모델을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
];

export default function InformationstrategyStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('information-strategy-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('information-strategy-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-blue-600 font-medium">정보전략계획</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">정보전략계획 학습</h1>
