...
const subjects = [
    { id: 'network-theory', name: '네트워크 이론', emoji: '📖', desc: '네트워크 이론 학습' },
    { id: 'network-equipment', name: '네트워크 장비', emoji: '📖', desc: '네트워크 장비 학습' },
    { id: 'protocol', name: '프로토콜', emoji: '📖', desc: '프로토콜 학습' },
    { id: 'practical', name: '실기', emoji: '📖', desc: '실기 학습' }
];

export default function NetworkadminMainPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white py-16">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl font-bold mb-4">네트워크관리사</h1>
          <p className="text-xl text-blue-100">네트워크 구축 및 관리</p>
        </div>
      </section>

      <main className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <Link href="/category/it/network-admin/exam" className="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {subjects.map((subject) => (
            <Link
              key={subject.id}
              href={`/category/it/network-admin/study/${subject.id}`}
