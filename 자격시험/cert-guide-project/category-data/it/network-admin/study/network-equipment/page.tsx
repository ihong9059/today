...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '라우터와 스위치의 차이를 설명하시오.',
        answer: '라우터: L3 IP기반, 스위치: L2 MAC기반',
        prompt: `네트워크관리사 네트워크 장비 문제입니다.\n\n문제: 라우터와 스위치의 차이를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'VLAN의 개념을 설명하시오.',
        answer: '논리적 네트워크 분할, 브로드캐스트 도메인 분리',
        prompt: `네트워크관리사 네트워크 장비 문제입니다.\n\n문제: VLAN의 개념을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 3,
        question: '허브와 스위치를 비교하시오.',
        answer: '허브: 플러딩, 스위치: MAC학습/포워딩',
        prompt: `네트워크관리사 네트워크 장비 문제입니다.\n\n문제: 허브와 스위치를 비교하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 4,
        question: 'L3 스위치의 특징을 설명하시오.',
        answer: '라우팅+스위칭, 하드웨어 기반 빠른 처리',
        prompt: `네트워크관리사 네트워크 장비 문제입니다.\n\n문제: L3 스위치의 특징을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 5,
        question: '로드밸런서의 역할을 설명하시오.',
        answer: '트래픽 분산, 고가용성, 헬스체크',
        prompt: `네트워크관리사 네트워크 장비 문제입니다.\n\n문제: 로드밸런서의 역할을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
...
export default function NetworkequipmentStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('network-equipment-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('network-equipment-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-blue-600 font-medium">네트워크 장비</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">네트워크 장비 학습</h1>
                <p className="text-blue-100">네트워크관리사</p>
              </div>
            </div>
