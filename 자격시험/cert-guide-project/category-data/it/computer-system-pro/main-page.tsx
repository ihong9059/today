...
const subjects = [
    { id: 'system-design', name: '시스템 설계', emoji: '📖', desc: '시스템 설계 학습' },
    { id: 'emerging-tech', name: '신기술', emoji: '📖', desc: '신기술 학습' },
    { id: 'practical', name: '면접', emoji: '📖', desc: '면접 학습' }
];

export default function ComputersystemproMainPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-blue-600 font-medium">컴퓨터시스템응용기술사</span>
          </nav>
        </div>
      </header>
      ...
      <section className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white py-16">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl font-bold mb-4">컴퓨터시스템응용기술사</h1>
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <Link href="/category/it/computer-system-pro/exam" className="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {subjects.map((subject) => (
            <Link
              key={subject.id}
              href={`/category/it/computer-system-pro/study/${subject.id}`}
