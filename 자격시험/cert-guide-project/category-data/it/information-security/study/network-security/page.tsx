...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: 'DDoS 공격 유형을 설명하시오.',
        answer: 'SYN Flood, UDP Flood, HTTP Flood',
        prompt: `정보보안기사 네트워크 보안 문제입니다.\n\n문제: DDoS 공격 유형을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 2,
        question: '방화벽의 종류를 설명하시오.',
        answer: '패킷필터링, 상태검사, 애플리케이션',
        prompt: `정보보안기사 네트워크 보안 문제입니다.\n\n문제: 방화벽의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'IDS와 IPS의 차이를 설명하시오.',
        answer: 'IDS: 탐지/알림, IPS: 탐지/차단',
        prompt: `정보보안기사 네트워크 보안 문제입니다.\n\n문제: IDS와 IPS의 차이를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 4,
        question: 'VPN의 프로토콜을 설명하시오.',
        answer: 'IPSec, SSL/TLS, PPTP, L2TP',
        prompt: `정보보안기사 네트워크 보안 문제입니다.\n\n문제: VPN의 프로토콜을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 5,
        question: '스니핑과 스푸핑을 설명하시오.',
        answer: '스니핑: 도청, 스푸핑: 위장',
        prompt: `정보보안기사 네트워크 보안 문제입니다.\n\n문제: 스니핑과 스푸핑을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
...
export default function NetworksecurityStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('network-security-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('network-security-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-blue-600 font-medium">네트워크 보안</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">네트워크 보안 학습</h1>
