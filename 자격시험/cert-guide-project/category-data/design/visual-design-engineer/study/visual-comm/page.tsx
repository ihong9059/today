...
export default function StudyPage() {
  ...
  const questions = [
      {
        id: 1,
        question: '시각커뮤니케이션 기본 요소는?',
        answer: '발신자, 메시지, 채널, 수신자, 피드백. 효과적 정보 전달',
        prompt: '시각디자인기사 시험 관련 질문입니다: 시각커뮤니케이션 기본 요소는? 자세히 설명해주세요.'
      },
      {
        id: 2,
        question: '기호학이란?',
        answer: '기호와 의미의 관계 연구. 디자인에서 의미 전달 원리',
        prompt: '시각디자인기사 시험 관련 질문입니다: 기호학이란? 자세히 설명해주세요.'
      },
      {
        id: 3,
        question: '아이콘, 인덱스, 심볼 차이는?',
        answer: '아이콘(유사성), 인덱스(인과성), 심볼(약속). 퍼스의 기호 분류',
        prompt: '시각디자인기사 시험 관련 질문입니다: 아이콘, 인덱스, 심볼 차이는? 자세히 설명해주세요.'
      },
      {
        id: 4,
        question: '시각적 계층구조란?',
        answer: '정보 중요도에 따라 시각적 강약 조절. 크기, 색상, 위치 활용',
        prompt: '시각디자인기사 시험 관련 질문입니다: 시각적 계층구조란? 자세히 설명해주세요.'
      },
      {
        id: 5,
        question: '그리드 시스템이란?',
        answer: '일관된 레이아웃을 위한 격자 구조. 12컬럼 그리드 등',
        prompt: '시각디자인기사 시험 관련 질문입니다: 그리드 시스템이란? 자세히 설명해주세요.'
      },
  ];

  useEffect(() => {
    const saved = localStorage.getItem('visual-design-engineer-visual-comm-progress');
    if (saved) {
  ...
  const toggleComplete = (id: number) => {
    ...
    localStorage.setItem('visual-design-engineer-visual-comm-progress', JSON.stringify(updated));
  };
