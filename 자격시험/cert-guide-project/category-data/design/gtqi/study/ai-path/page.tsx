...
export default function StudyPage() {
  ...
  const questions = [
      {
        id: 1,
        question: '패스파인더 기능은?',
        answer: '합치기, 빼기, 교차, 분할 등. 복잡한 형태 제작',
        prompt: 'GTQi(일러스트) 시험 관련 질문입니다: 패스파인더 기능은? 자세히 설명해주세요.'
      },
      {
        id: 2,
        question: '오프셋 패스란?',
        answer: '패스를 일정 거리만큼 안/바깥으로 복제. 테두리 효과',
        prompt: 'GTQi(일러스트) 시험 관련 질문입니다: 오프셋 패스란? 자세히 설명해주세요.'
      },
      {
        id: 3,
        question: '블렌드(Blend)란?',
        answer: '두 오브젝트 사이 중간 단계 자동 생성. 그라데이션 효과',
        prompt: 'GTQi(일러스트) 시험 관련 질문입니다: 블렌드(Blend)란? 자세히 설명해주세요.'
      },
      {
        id: 4,
        question: '효과 vs 변형 차이는?',
        answer: '효과(비파괴, Appearance), 변형(원본 수정). 확장으로 변환',
        prompt: 'GTQi(일러스트) 시험 관련 질문입니다: 효과 vs 변형 차이는? 자세히 설명해주세요.'
      },
      {
        id: 5,
        question: '클리핑 마스크 단축키는?',
        answer: 'Ctrl+7 (Cmd+7). 상위 오브젝트로 하위 자르기',
        prompt: 'GTQi(일러스트) 시험 관련 질문입니다: 클리핑 마스크 단축키는? 자세히 설명해주세요.'
      },
  ];
  ...
  const toggleComplete = (id: number) => {
    ...
    localStorage.setItem('gtqi-ai-path-progress', JSON.stringify(updated));
  };
