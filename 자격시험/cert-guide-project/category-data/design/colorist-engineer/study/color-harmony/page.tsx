...
export default function StudyPage() {
  ...
  const questions = [
      {
        id: 1,
        question: '보색 배색이란?',
        answer: '색상환 반대편 색 조합. 강렬한 대비, 주의 집중',
        prompt: '컬러리스트기사 시험 관련 질문입니다: 보색 배색이란? 자세히 설명해주세요.'
      },
      {
        id: 2,
        question: '유사색 배색이란?',
        answer: '색상환 인접 색 조합. 조화롭고 부드러운 느낌',
        prompt: '컬러리스트기사 시험 관련 질문입니다: 유사색 배색이란? 자세히 설명해주세요.'
      },
      {
        id: 3,
        question: '톤온톤이란?',
        answer: '같은 색상에서 톤 차이로 배색. 부드러운 변화, 통일감',
        prompt: '컬러리스트기사 시험 관련 질문입니다: 톤온톤이란? 자세히 설명해주세요.'
      },
      {
        id: 4,
        question: '액센트 컬러란?',
        answer: '전체 배색에서 강조점 색상. 5~10% 비율, 시선 유도',
        prompt: '컬러리스트기사 시험 관련 질문입니다: 액센트 컬러란? 자세히 설명해주세요.'
      },
      {
        id: 5,
        question: '색채 조화론 종류는?',
        answer: '오스트발트, 먼셀, 저드, 문-스펜서. 각 이론별 조화 원리',
        prompt: '컬러리스트기사 시험 관련 질문입니다: 색채 조화론 종류는? 자세히 설명해주세요.'
      },
  ];
  ...
  const toggleComplete = (id: number) => {
    ...
    localStorage.setItem('colorist-engineer-color-harmony-progress', JSON.stringify(updated));
  };
