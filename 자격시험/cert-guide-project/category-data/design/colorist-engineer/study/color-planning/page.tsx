...
export default function StudyPage() {
  ...
  const questions = [
      {
        id: 1,
        question: '색채 마케팅이란?',
        answer: '색채로 소비자 행동에 영향. 브랜드 인지, 구매 유도',
        prompt: '컬러리스트기사 시험 관련 질문입니다: 색채 마케팅이란? 자세히 설명해주세요.'
      },
      {
        id: 2,
        question: '환경색채란?',
        answer: '건축, 도시 환경의 색채 계획. 지역 특성, 조화 고려',
        prompt: '컬러리스트기사 시험 관련 질문입니다: 환경색채란? 자세히 설명해주세요.'
      },
      {
        id: 3,
        question: '색채 트렌드 분석법은?',
        answer: '사회문화 분석, 패션쇼, 전시회, 색채 기관 예측(PANTONE 등)',
        prompt: '컬러리스트기사 시험 관련 질문입니다: 색채 트렌드 분석법은? 자세히 설명해주세요.'
      },
      {
        id: 4,
        question: '산업별 색채 특성은?',
        answer: '패션(계절), 인테리어(공간), 제품(브랜드), 식품(식욕)',
        prompt: '컬러리스트기사 시험 관련 질문입니다: 산업별 색채 특성은? 자세히 설명해주세요.'
      },
      {
        id: 5,
        question: '문화별 색채 차이는?',
        answer: '같은 색도 문화권마다 의미 다름. 글로벌 디자인 시 주의',
        prompt: '컬러리스트기사 시험 관련 질문입니다: 문화별 색채 차이는? 자세히 설명해주세요.'
      },
  ];
  ...
  const toggleComplete = (id: number) => {
    ...
    localStorage.setItem('colorist-engineer-color-planning-progress', JSON.stringify(updated));
  };
