      ...
      topics: [
            {
              id: 'design-basics',
              name: '디자인 기초',
              href: '/category/design/computer-graphics/study/design-basics'
            },
            {
              id: 'color-theory',
              name: '색채학',
              href: '/category/design/computer-graphics/study/color-theory'
            },
            {
              id: 'typography',
              name: '타이포그래피',
              href: '/category/design/computer-graphics/study/typography'
            },
      ]
    },
    {
      ...
      topics: [
            {
              id: 'photoshop',
              name: '포토샵',
              href: '/category/design/computer-graphics/study/photoshop'
            },
            {
              id: 'illustrator',
              name: '일러스트레이터',
              href: '/category/design/computer-graphics/study/illustrator'
            },
            {
              id: 'file-formats',
              name: '파일 형식',
              href: '/category/design/computer-graphics/study/file-formats'
            },
      ]
    },
  ];
