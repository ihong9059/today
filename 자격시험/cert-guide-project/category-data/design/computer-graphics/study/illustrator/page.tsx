...
export default function StudyPage() {
  ...
  const questions = [
      {
        id: 1,
        question: '벡터 그래픽 장점은?',
        answer: '확대해도 화질 저하 없음, 파일 크기 작음, 편집 용이, 인쇄에 적합',
        prompt: '컴퓨터그래픽스운용기능사 시험 관련 질문입니다: 벡터 그래픽 장점은? 자세히 설명해주세요.'
      },
      {
        id: 2,
        question: '베지어 곡선이란?',
        answer: '앵커 포인트와 핸들로 곡선 제어. 펜 도구의 핵심 원리',
        prompt: '컴퓨터그래픽스운용기능사 시험 관련 질문입니다: 베지어 곡선이란? 자세히 설명해주세요.'
      },
      {
        id: 3,
        question: '패스파인더 기능은?',
        answer: '오브젝트 합치기(Unite), 빼기(Minus Front), 교차(Intersect), 나누기',
        prompt: '컴퓨터그래픽스운용기능사 시험 관련 질문입니다: 패스파인더 기능은? 자세히 설명해주세요.'
      },
      {
        id: 4,
        question: '클리핑 마스크란?',
        answer: '상위 오브젝트 모양으로 하위 오브젝트를 자르기. Ctrl+7로 생성',
        prompt: '컴퓨터그래픽스운용기능사 시험 관련 질문입니다: 클리핑 마스크란? 자세히 설명해주세요.'
      },
      {
        id: 5,
        question: '심볼(Symbol) 활용은?',
        answer: '반복 사용 요소 저장. 일괄 수정 가능, 파일 크기 감소, 작업 효율화',
        prompt: '컴퓨터그래픽스운용기능사 시험 관련 질문입니다: 심볼(Symbol) 활용은? 자세히 설명해주세요.'
      },
  ];

  useEffect(() => {
    const saved = localStorage.getItem('computer-graphics-illustrator-progress');
    if (saved) {
  ...
  const toggleComplete = (id: number) => {
    ...
    localStorage.setItem('computer-graphics-illustrator-progress', JSON.stringify(updated));
  };
