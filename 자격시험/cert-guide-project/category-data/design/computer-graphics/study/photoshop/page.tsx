...
export default function StudyPage() {
  ...
  const questions = [
      {
        id: 1,
        question: '레이어 마스크의 역할은?',
        answer: '이미지 일부를 비파괴적으로 숨기거나 표시. 흰색=보임, 검정=숨김',
        prompt: '컴퓨터그래픽스운용기능사 시험 관련 질문입니다: 레이어 마스크의 역할은? 자세히 설명해주세요.'
      },
      {
        id: 2,
        question: '블렌딩 모드 Multiply 효과는?',
        answer: '어두운 색이 더 어두워지는 곱하기 효과. 그림자, 질감 표현에 활용',
        prompt: '컴퓨터그래픽스운용기능사 시험 관련 질문입니다: 블렌딩 모드 Multiply 효과는? 자세히 설명해주세요.'
      },
      {
        id: 3,
        question: '스마트 오브젝트 장점은?',
        answer: '비파괴 편집, 원본 유지, 필터 재편집 가능, 확대해도 품질 유지',
        prompt: '컴퓨터그래픽스운용기능사 시험 관련 질문입니다: 스마트 오브젝트 장점은? 자세히 설명해주세요.'
      },
      {
        id: 4,
        question: '해상도(Resolution)란?',
        answer: '이미지 세밀도. 웹용 72dpi, 인쇄용 300dpi 이상 권장',
        prompt: '컴퓨터그래픽스운용기능사 시험 관련 질문입니다: 해상도(Resolution)란? 자세히 설명해주세요.'
      },
      {
        id: 5,
        question: '조정 레이어(Adjustment Layer) 장점은?',
        answer: '비파괴 색상 보정, 언제든 수정 가능, 여러 레이어에 동시 적용',
        prompt: '컴퓨터그래픽스운용기능사 시험 관련 질문입니다: 조정 레이어(Adjustment Layer) 장점은? 자세히 설명해주세요.'
      },
  ];

  useEffect(() => {
    const saved = localStorage.getItem('computer-graphics-photoshop-progress');
    if (saved) {
  ...
  const toggleComplete = (id: number) => {
    ...
    localStorage.setItem('computer-graphics-photoshop-progress', JSON.stringify(updated));
  };
