...
export default function StudyPage() {
  ...
  const questions = [
      {
        id: 1,
        question: '플라스틱 종류는?',
        answer: '열가소성(PP, PE, ABS), 열경화성(에폭시). 가공성과 내열성 차이',
        prompt: '제품디자인기사 시험 관련 질문입니다: 플라스틱 종류는? 자세히 설명해주세요.'
      },
      {
        id: 2,
        question: '사출성형이란?',
        answer: '녹인 플라스틱을 금형에 주입하여 제품 제작. 대량생산에 적합',
        prompt: '제품디자인기사 시험 관련 질문입니다: 사출성형이란? 자세히 설명해주세요.'
      },
      {
        id: 3,
        question: 'CMF란?',
        answer: 'Color(색상), Material(재료), Finishing(마감). 제품 감성품질 결정',
        prompt: '제품디자인기사 시험 관련 질문입니다: CMF란? 자세히 설명해주세요.'
      },
      {
        id: 4,
        question: '알루미늄 특징은?',
        answer: '가볍고 내식성 우수, 열전도성 좋음. 아노다이징 표면처리 가능',
        prompt: '제품디자인기사 시험 관련 질문입니다: 알루미늄 특징은? 자세히 설명해주세요.'
      },
      {
        id: 5,
        question: '친환경 소재 종류는?',
        answer: '생분해성 플라스틱, 재활용 소재, 바이오 소재. 지속가능 디자인',
        prompt: '제품디자인기사 시험 관련 질문입니다: 친환경 소재 종류는? 자세히 설명해주세요.'
      },
  ];

  useEffect(() => {
    const saved = localStorage.getItem('product-design-engineer-materials-progress');
    if (saved) {
  ...
  const toggleComplete = (id: number) => {
    ...
    localStorage.setItem('product-design-engineer-materials-progress', JSON.stringify(updated));
  };
