...
export default function StudyPage() {
  ...
  const questions = [
      {
        id: 1,
        question: '인간공학이란?',
        answer: '인간 특성에 맞게 제품 설계. 사용성, 안전성, 편의성 향상',
        prompt: '제품디자인기사 시험 관련 질문입니다: 인간공학이란? 자세히 설명해주세요.'
      },
      {
        id: 2,
        question: '인체측정학이란?',
        answer: '인체 치수 측정/분석. 제품 크기 결정의 기초 데이터',
        prompt: '제품디자인기사 시험 관련 질문입니다: 인체측정학이란? 자세히 설명해주세요.'
      },
      {
        id: 3,
        question: '5%, 50%, 95% 백분위 의미는?',
        answer: '인구의 5%, 50%, 95%가 해당 치수 이하. 설계 범위 결정',
        prompt: '제품디자인기사 시험 관련 질문입니다: 5%, 50%, 95% 백분위 의미는? 자세히 설명해주세요.'
      },
      {
        id: 4,
        question: '유니버설 디자인이란?',
        answer: '모든 사람이 사용 가능한 디자인. 7가지 원칙, 장애 유무 불문',
        prompt: '제품디자인기사 시험 관련 질문입니다: 유니버설 디자인이란? 자세히 설명해주세요.'
      },
      {
        id: 5,
        question: '어포던스란?',
        answer: '사물이 행동을 유도하는 특성. 문 손잡이=당기기, 버튼=누르기',
        prompt: '제품디자인기사 시험 관련 질문입니다: 어포던스란? 자세히 설명해주세요.'
      },
  ];

  useEffect(() => {
    const saved = localStorage.getItem('product-design-engineer-ergonomics-progress');
    if (saved) {
  ...
  const toggleComplete = (id: number) => {
    ...
    localStorage.setItem('product-design-engineer-ergonomics-progress', JSON.stringify(updated));
  };
