...
const subjects = [
      { id: 'labor-law', name: '노동법' }
];

export default function LaborattorneyMainPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-violet-50">
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">공인노무사</span>
          </nav>
        </div>
      </header>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-800">공인노무사</h1>
          <p className="text-gray-600">노동 관련 법률 전문가</p>
        </div>

        <div className="grid gap-4 mb-8">
          <Link href="/category/legal/labor-attorney/exam">
        ...
        <div className="grid gap-3">
          {subjects.map((subject) => (
            <Link key={subject.id} href={`/category/legal/labor-attorney/study/${subject.id}`}>
