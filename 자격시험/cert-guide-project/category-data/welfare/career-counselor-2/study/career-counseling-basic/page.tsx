...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '직업상담의 목표를 설명하시오.',
        answer: '자기이해, 직업정보 탐색, 의사결정, 취업준비',
        prompt: `직업상담사 2급 직업상담 기초 문제입니다.\n\n문제: 직업상담의 목표를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '상담관계 형성기법을 설명하시오.',
        answer: '경청, 공감, 수용, 질문, 반영',
        prompt: `직업상담사 2급 직업상담 기초 문제입니다.\n\n문제: 상담관계 형성기법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '진로상담 과정을 설명하시오.',
        answer: '관계형성-자기이해-직업탐색-의사결정-실행',
        prompt: `직업상담사 2급 직업상담 기초 문제입니다.\n\n문제: 진로상담 과정을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '집단직업상담의 특성을 설명하시오.',
        answer: '효율성, 상호작용, 피드백, 사회기술 학습',
        prompt: `직업상담사 2급 직업상담 기초 문제입니다.\n\n문제: 집단직업상담의 특성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '취업지원 프로그램의 종류를 설명하시오.',
        answer: '취업성공패키지, 청년내일채움공제, 국민취업지원제도',
        prompt: `직업상담사 2급 직업상담 기초 문제입니다.\n\n문제: 취업지원 프로그램의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
];

export default function CareercounselingbasicStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('career-counseling-basic-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('career-counseling-basic-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/welfare/career-counselor-2" className="text-gray-600 hover:text-violet-600">직업상담사 2급</Link>
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">직업상담 기초</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">직업상담 기초 학습</h1>
                <p className="text-violet-100">직업상담사 2급</p>
              </div>
            </div>
