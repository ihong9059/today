...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '동기이론(매슬로우)을 설명하시오.',
        answer: '생리-안전-소속-존경-자아실현 욕구',
        prompt: `직업상담사 2급 직업심리학 문제입니다.\n\n문제: 동기이론(매슬로우)을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '직무만족의 영향요인을 설명하시오.',
        answer: '직무특성, 보상, 대인관계, 성장기회',
        prompt: `직업상담사 2급 직업심리학 문제입니다.\n\n문제: 직무만족의 영향요인을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '조직몰입의 유형을 설명하시오.',
        answer: '정서적, 규범적, 지속적 몰입',
        prompt: `직업상담사 2급 직업심리학 문제입니다.\n\n문제: 조직몰입의 유형을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '직무스트레스 관리방안을 설명하시오.',
        answer: '스트레스원 파악, 대처기술, 사회적지지, EAP',
        prompt: `직업상담사 2급 직업심리학 문제입니다.\n\n문제: 직무스트레스 관리방안을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '경력개발의 단계를 설명하시오.',
        answer: '탐색-확립-유지-전환 또는 쇠퇴 단계',
        prompt: `직업상담사 2급 직업심리학 문제입니다.\n\n문제: 경력개발의 단계를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
...
export default function VocationalpsychologyStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('vocational-psychology-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('vocational-psychology-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">직업심리학</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">직업심리학 학습</h1>
