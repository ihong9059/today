...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '한국표준직업분류를 설명하시오.',
        answer: '대분류 10개, 중/소/세분류, 직무 및 기능 기준',
        prompt: `직업상담사 2급 고용정보론 문제입니다.\n\n문제: 한국표준직업분류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '워크넷의 기능을 설명하시오.',
        answer: '채용정보, 구직등록, 직업심리검사, 진로상담',
        prompt: `직업상담사 2급 고용정보론 문제입니다.\n\n문제: 워크넷의 기능을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '직업정보의 수집방법을 설명하시오.',
        answer: '문헌조사, 인터뷰, 직업체험, 온라인 검색',
        prompt: `직업상담사 2급 고용정보론 문제입니다.\n\n문제: 직업정보의 수집방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '취업알선 과정을 설명하시오.',
        answer: '구직등록-적합매칭-알선-사후관리',
        prompt: `직업상담사 2급 고용정보론 문제입니다.\n\n문제: 취업알선 과정을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '고용서비스의 종류를 설명하시오.',
        answer: '고용센터, 민간취업알선, 대학일자리센터',
        prompt: `직업상담사 2급 고용정보론 문제입니다.\n\n문제: 고용서비스의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
...
export default function EmploymentinfoStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('employment-info-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('employment-info-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">고용정보론</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">고용정보론 학습</h1>
