...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '놀이의 특성을 설명하시오.',
        answer: '자발성, 내적동기, 즐거움, 과정중시, 자유선택',
        prompt: `보육교사 2급 놀이지도 문제입니다.\n\n문제: 놀이의 특성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '놀이 발달단계를 설명하시오.',
        answer: '기능놀이-구성놀이-상징놀이-규칙있는놀이',
        prompt: `보육교사 2급 놀이지도 문제입니다.\n\n문제: 놀이 발달단계를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '사회적 놀이 발달(파튼)을 설명하시오.',
        answer: '방관-혼자-병행-연합-협동놀이',
        prompt: `보육교사 2급 놀이지도 문제입니다.\n\n문제: 사회적 놀이 발달(파튼)을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '놀이환경 구성 원리를 설명하시오.',
        answer: '안전성, 다양성, 접근성, 융통성, 개방성',
        prompt: `보육교사 2급 놀이지도 문제입니다.\n\n문제: 놀이환경 구성 원리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '교사의 놀이개입 전략을 설명하시오.',
        answer: '관찰자, 무대관리자, 공동놀이자, 놀이지도자',
        prompt: `보육교사 2급 놀이지도 문제입니다.\n\n문제: 교사의 놀이개입 전략을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
];

export default function PlayguidanceStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('play-guidance-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('play-guidance-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">놀이지도</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">놀이지도 학습</h1>
