...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '어린이집 설치기준을 설명하시오.',
        answer: '시설규모, 설비기준, 교사대아동비율, 안전기준',
        prompt: `보육교사 1급 보육시설 운영관리 문제입니다.\n\n문제: 어린이집 설치기준을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '보육교직원의 자격기준을 설명하시오.',
        answer: '원장/교사 자격, 학력/경력 요건, 승급교육',
        prompt: `보육교사 1급 보육시설 운영관리 문제입니다.\n\n문제: 보육교직원의 자격기준을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '어린이집 운영위원회의 역할을 설명하시오.',
        answer: '운영전반 자문, 보육프로그램, 예산결산, 급식',
        prompt: `보육교사 1급 보육시설 운영관리 문제입니다.\n\n문제: 어린이집 운영위원회의 역할을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '보육료 지원체계를 설명하시오.',
        answer: '보육료, 양육수당, 아이돌봄서비스, 아이행복카드',
        prompt: `보육교사 1급 보육시설 운영관리 문제입니다.\n\n문제: 보육료 지원체계를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '어린이집 평가인증제를 설명하시오.',
        answer: '의무평가, 4영역 평가지표, 등급 부여',
        prompt: `보육교사 1급 보육시설 운영관리 문제입니다.\n\n문제: 어린이집 평가인증제를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
];

export default function ChildcareadminStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('childcare-admin-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('childcare-admin-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">보육시설 운영관리</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">보육시설 운영관리 학습</h1>
