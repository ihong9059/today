...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '이상행동의 정의기준을 설명하시오.',
        answer: '통계적, 주관적, 사회문화적, 기능적 기준',
        prompt: `임상심리사 2급 이상심리학 문제입니다.\n\n문제: 이상행동의 정의기준을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '불안장애의 원인을 설명하시오.',
        answer: '생물학적, 심리적(학습,인지), 사회적 요인',
        prompt: `임상심리사 2급 이상심리학 문제입니다.\n\n문제: 불안장애의 원인을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '기분장애의 유형을 설명하시오.',
        answer: '주요우울장애, 지속성우울장애, 양극성장애',
        prompt: `임상심리사 2급 이상심리학 문제입니다.\n\n문제: 기분장애의 유형을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '강박관련장애를 설명하시오.',
        answer: '강박장애, 신체변형장애, 저장장애, 발모광',
        prompt: `임상심리사 2급 이상심리학 문제입니다.\n\n문제: 강박관련장애를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '해리장애를 설명하시오.',
        answer: '해리성정체감장애, 해리성기억상실, 이인증',
        prompt: `임상심리사 2급 이상심리학 문제입니다.\n\n문제: 해리장애를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
...
export default function AbnormalpsychologyStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('abnormal-psychology-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('abnormal-psychology-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">이상심리학</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">이상심리학 학습</h1>
