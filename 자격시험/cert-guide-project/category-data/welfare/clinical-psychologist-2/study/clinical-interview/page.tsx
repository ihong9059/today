...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '초기면접의 목적을 설명하시오.',
        answer: '정보수집, 관계형성, 문제파악, 치료계획',
        prompt: `임상심리사 2급 임상면접 문제입니다.\n\n문제: 초기면접의 목적을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '정신상태검사(MSE)의 영역을 설명하시오.',
        answer: '외모,행동,기분,사고,지각,인지,병식',
        prompt: `임상심리사 2급 임상면접 문제입니다.\n\n문제: 정신상태검사(MSE)의 영역을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '자살위험 평가면접을 설명하시오.',
        answer: '자살사고,계획,의도,수단,보호요인 평가',
        prompt: `임상심리사 2급 임상면접 문제입니다.\n\n문제: 자살위험 평가면접을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '사례개념화를 설명하시오.',
        answer: '문제목록, 가설, 발달력, 강점, 치료계획',
        prompt: `임상심리사 2급 임상면접 문제입니다.\n\n문제: 사례개념화를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '치료적 관계의 특성을 설명하시오.',
        answer: '전문성, 비밀보장, 경계, 신뢰, 협력',
        prompt: `임상심리사 2급 임상면접 문제입니다.\n\n문제: 치료적 관계의 특성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
];

export default function ClinicalinterviewStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('clinical-interview-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('clinical-interview-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/welfare/clinical-psychologist-2" className="text-gray-600 hover:text-violet-600">임상심리사 2급</Link>
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">임상면접</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">임상면접 학습</h1>
                <p className="text-violet-100">임상심리사 2급</p>
              </div>
            </div>
