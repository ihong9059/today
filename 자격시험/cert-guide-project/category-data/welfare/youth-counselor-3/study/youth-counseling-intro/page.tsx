...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '청소년상담의 목표를 설명하시오.',
        answer: '자기이해, 문제해결, 적응능력 향상, 성장촉진',
        prompt: `청소년상담사 3급 청소년상담 입문 문제입니다.\n\n문제: 청소년상담의 목표를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '상담관계의 특성을 설명하시오.',
        answer: '전문적 관계, 비밀보장, 목적지향, 시간제한',
        prompt: `청소년상담사 3급 청소년상담 입문 문제입니다.\n\n문제: 상담관계의 특성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '상담면접의 기본기술을 설명하시오.',
        answer: '경청, 반영, 명료화, 질문, 요약',
        prompt: `청소년상담사 3급 청소년상담 입문 문제입니다.\n\n문제: 상담면접의 기본기술을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '청소년 내담자의 특성을 설명하시오.',
        answer: '비자발성, 양가감정, 의존과독립, 현재중심',
        prompt: `청소년상담사 3급 청소년상담 입문 문제입니다.\n\n문제: 청소년 내담자의 특성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '부모상담의 원칙을 설명하시오.',
        answer: '협력관계, 정보공유, 비밀보장 한계, 변화촉진',
        prompt: `청소년상담사 3급 청소년상담 입문 문제입니다.\n\n문제: 부모상담의 원칙을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
...
export default function YouthcounselingintroStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('youth-counseling-intro-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('youth-counseling-intro-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/welfare/youth-counselor-3" className="text-gray-600 hover:text-violet-600">청소년상담사 3급</Link>
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">청소년상담 입문</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">청소년상담 입문 학습</h1>
                <p className="text-violet-100">청소년상담사 3급</p>
              </div>
            </div>
