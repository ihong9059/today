...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '집단상담의 치료적 요인을 설명하시오.',
        answer: '보편성, 희망고취, 이타심, 카타르시스, 응집력',
        prompt: `청소년상담사 2급 집단상담 문제입니다.\n\n문제: 집단상담의 치료적 요인을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '집단상담 발달단계를 설명하시오.',
        answer: '시작-과도기-작업-종결 단계',
        prompt: `청소년상담사 2급 집단상담 문제입니다.\n\n문제: 집단상담 발달단계를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '집단상담 리더의 역할을 설명하시오.',
        answer: '촉진자, 모델, 보호자, 과정관찰자',
        prompt: `청소년상담사 2급 집단상담 문제입니다.\n\n문제: 집단상담 리더의 역할을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '집단역동의 개념을 설명하시오.',
        answer: '상호작용, 영향력, 의사소통 패턴, 하위집단',
        prompt: `청소년상담사 2급 집단상담 문제입니다.\n\n문제: 집단역동의 개념을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '문제집단원 유형과 대처를 설명하시오.',
        answer: '독점자, 침묵자, 공격자, 의존자 대처전략',
        prompt: `청소년상담사 2급 집단상담 문제입니다.\n\n문제: 문제집단원 유형과 대처를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
];
...
export default function GroupcounselingStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('group-counseling-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('group-counseling-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">집단상담</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">집단상담 학습</h1>
