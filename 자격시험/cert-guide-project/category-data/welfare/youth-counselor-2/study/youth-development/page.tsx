...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '청소년기 신체발달 특성을 설명하시오.',
        answer: '급성장, 2차 성징, 호르몬 변화, 신체상 변화',
        prompt: `청소년상담사 2급 청소년발달 문제입니다.\n\n문제: 청소년기 신체발달 특성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '청소년기 인지발달(형식적 조작기)을 설명하시오.',
        answer: '추상적 사고, 가설연역적 사고, 이상주의',
        prompt: `청소년상담사 2급 청소년발달 문제입니다.\n\n문제: 청소년기 인지발달(형식적 조작기)을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '청소년기 정체감 발달(마르시아)을 설명하시오.',
        answer: '정체감 성취/유예/유실/혼미 4유형',
        prompt: `청소년상담사 2급 청소년발달 문제입니다.\n\n문제: 청소년기 정체감 발달(마르시아)을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '또래관계의 중요성을 설명하시오.',
        answer: '사회화, 정서적지지, 자아정체감, 친밀감',
        prompt: `청소년상담사 2급 청소년발달 문제입니다.\n\n문제: 또래관계의 중요성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '청소년기 도덕성 발달을 설명하시오.',
        answer: '인습수준에서 후인습수준으로의 발달',
        prompt: `청소년상담사 2급 청소년발달 문제입니다.\n\n문제: 청소년기 도덕성 발달을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
];

export default function YouthdevelopmentStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('youth-development-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('youth-development-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">청소년발달</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">청소년발달 학습</h1>
                <p className="text-violet-100">청소년상담사 2급</p>
              </div>
            </div>
