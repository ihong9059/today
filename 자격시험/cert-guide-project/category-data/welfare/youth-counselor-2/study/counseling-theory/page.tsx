...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '정신분석상담의 기법을 설명하시오.',
        answer: '자유연상, 꿈분석, 전이분석, 저항분석',
        prompt: `청소년상담사 2급 상담이론 문제입니다.\n\n문제: 정신분석상담의 기법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '인간중심상담의 핵심조건을 설명하시오.',
        answer: '무조건적 긍정적 존중, 공감적 이해, 일치성',
        prompt: `청소년상담사 2급 상담이론 문제입니다.\n\n문제: 인간중심상담의 핵심조건을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '인지행동상담의 기법을 설명하시오.',
        answer: '인지재구조화, 행동실험, 노출치료, 이완훈련',
        prompt: `청소년상담사 2급 상담이론 문제입니다.\n\n문제: 인지행동상담의 기법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '게슈탈트상담의 기법을 설명하시오.',
        answer: '빈의자 기법, 알아차림, 현재에 머물기, 실험',
        prompt: `청소년상담사 2급 상담이론 문제입니다.\n\n문제: 게슈탈트상담의 기법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '해결중심 단기상담의 질문을 설명하시오.',
        answer: '기적질문, 예외질문, 척도질문, 대처질문',
        prompt: `청소년상담사 2급 상담이론 문제입니다.\n\n문제: 해결중심 단기상담의 질문을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
];
...
export default function CounselingtheoryStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('counseling-theory-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('counseling-theory-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">상담이론</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">상담이론 학습</h1>
