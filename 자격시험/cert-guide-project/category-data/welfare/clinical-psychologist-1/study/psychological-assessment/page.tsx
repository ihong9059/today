...
const topics = [
  {
    id: 'assessment-advanced',
    name: '심리검사 심화',
    color: 'from-violet-500 to-purple-600',
    questions: [
      {
        id: 1,
        question: '웩슬러 지능검사(K-WAIS)를 설명하시오.',
        answer: '언어이해, 지각추론, 작업기억, 처리속도 4요인',
        prompt: `임상심리사 1급 심리평가 문제입니다.\n\n문제: 웩슬러 지능검사(K-WAIS)를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'MMPI-2 임상척도를 설명하시오.',
        answer: '10개 임상척도, 타당도척도, 프로파일 해석',
        prompt: `임상심리사 1급 심리평가 문제입니다.\n\n문제: MMPI-2 임상척도를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '로샤검사의 시행과 해석을 설명하시오.',
        answer: '10개 잉크반점, 반응단계, 종합체계 해석',
        prompt: `임상심리사 1급 심리평가 문제입니다.\n\n문제: 로샤검사의 시행과 해석을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '주제통각검사(TAT)를 설명하시오.',
        answer: '그림자극, 투사적 검사, 욕구-압력 분석',
        prompt: `임상심리사 1급 심리평가 문제입니다.\n\n문제: 주제통각검사(TAT)를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '신경심리검사의 종류를 설명하시오.',
        answer: 'K-WAIS, BGT, 레이복잡도형검사, 선로잇기검사',
        prompt: `임상심리사 1급 심리평가 문제입니다.\n\n문제: 신경심리검사의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
];
...
export default function PsychologicalassessmentStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('psychological-assessment-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('psychological-assessment-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/welfare/clinical-psychologist-1" className="text-gray-600 hover:text-violet-600">임상심리사 1급</Link>
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">심리평가</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">심리평가 학습</h1>
                <p className="text-violet-100">임상심리사 1급</p>
              </div>
            </div>
