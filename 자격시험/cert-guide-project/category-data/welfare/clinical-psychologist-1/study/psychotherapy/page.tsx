...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '인지치료(벡)의 기법을 설명하시오.',
        answer: '자동적사고 확인, 인지왜곡 수정, 행동실험',
        prompt: `임상심리사 1급 심리치료 문제입니다.\n\n문제: 인지치료(벡)의 기법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '변증법적행동치료(DBT)를 설명하시오.',
        answer: '마음챙김, 대인관계효율성, 정서조절, 고통감내',
        prompt: `임상심리사 1급 심리치료 문제입니다.\n\n문제: 변증법적행동치료(DBT)를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'EMDR의 치료과정을 설명하시오.',
        answer: '외상기억 처리, 안구운동, 재처리, 설치',
        prompt: `임상심리사 1급 심리치료 문제입니다.\n\n문제: EMDR의 치료과정을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '정신역동적 심리치료를 설명하시오.',
        answer: '무의식, 방어기제, 전이분석, 통찰',
        prompt: `임상심리사 1급 심리치료 문제입니다.\n\n문제: 정신역동적 심리치료를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '가족치료의 접근을 설명하시오.',
        answer: '구조적, 전략적, 경험적, 해결중심 가족치료',
        prompt: `임상심리사 1급 심리치료 문제입니다.\n\n문제: 가족치료의 접근을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
...
export default function PsychotherapyStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('psychotherapy-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('psychotherapy-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">심리치료</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">심리치료 학습</h1>
