...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '사회복지사업법의 주요 내용을 설명하시오.',
        answer: '사회복지사 자격, 시설 설치운영, 사회복지법인',
        prompt: `사회복지사 1급 사회복지법제론 문제입니다.\n\n문제: 사회복지사업법의 주요 내용을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '국민기초생활보장법의 급여 종류를 설명하시오.',
        answer: '생계급여, 의료급여, 주거급여, 교육급여, 자활급여',
        prompt: `사회복지사 1급 사회복지법제론 문제입니다.\n\n문제: 국민기초생활보장법의 급여 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '아동복지법의 보호조치를 설명하시오.',
        answer: '보호대상아동 발견, 상담조사, 보호조치(가정위탁/시설보호)',
        prompt: `사회복지사 1급 사회복지법제론 문제입니다.\n\n문제: 아동복지법의 보호조치를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '노인복지법의 주요 서비스를 설명하시오.',
        answer: '노인주거복지시설, 노인의료복지시설, 재가노인복지시설',
        prompt: `사회복지사 1급 사회복지법제론 문제입니다.\n\n문제: 노인복지법의 주요 서비스를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '장애인복지법의 장애유형과 서비스를 설명하시오.',
        answer: '장애유형 15종, 활동지원서비스, 재활지원',
        prompt: `사회복지사 1급 사회복지법제론 문제입니다.\n\n문제: 장애인복지법의 장애유형과 서비스를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
];
...
export default function SocialwelfarelawStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('social-welfare-law-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('social-welfare-law-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">사회복지법제론</span>
          </nav>
        </div>
      </header>
