  ...
  questions: [
      {
        id: 1,
        question: '엔진 점검 항목은?',
        answer: `오일량/상태, 냉각수, 에어필터, 연료필터, 팬벨트, 배터리`,
        prompt: `농업기계기사 농기계 정비 관련 질문입니다: 엔진 점검 항목은? 이에 대해 자세히 설명해주세요.`
      },
      {
        id: 2,
        question: '유압장치 고장 원인은?',
        answer: `오일부족, 에어혼입, 필터막힘, 호스누유, 펌프마모, 밸브고착`,
        prompt: `농업기계기사 농기계 정비 관련 질문입니다: 유압장치 고장 원인은? 이에 대해 자세히 설명해주세요.`
      },
      {
        id: 3,
        question: '동절기 농기계 관리법은?',
        answer: `연료첨가제, 부동액, 배터리충전, 냉각수배수, 그리스주입, 격납보관`,
        prompt: `농업기계기사 농기계 정비 관련 질문입니다: 동절기 농기계 관리법은? 이에 대해 자세히 설명해주세요.`
      },
      {
        id: 4,
        question: '안전사고 예방법은?',
        answer: `작동전 점검, 경사지작업주의, 로토베이터주의, 전도방지, 안전프레임`,
        prompt: `농업기계기사 농기계 정비 관련 질문입니다: 안전사고 예방법은? 이에 대해 자세히 설명해주세요.`
      },
      {
        id: 5,
        question: '농기계 수명연장 방법은?',
        answer: `정기점검, 청소, 부품교환, 적정부하작업, 규격연료/오일 사용`,
        prompt: `농업기계기사 농기계 정비 관련 질문입니다: 농기계 수명연장 방법은? 이에 대해 자세히 설명해주세요.`
      },
  ]
};
...
export default function StudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('agri-machine-engineer-machine-maintenance-progress');
  ...
  const toggleComplete = (qId: number) => {
    ...
    localStorage.setItem('agri-machine-engineer-machine-maintenance-progress', JSON.stringify(newCompleted));
  };
