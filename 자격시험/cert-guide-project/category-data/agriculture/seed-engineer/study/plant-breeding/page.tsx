  ...
  questions: [
      {
        id: 1,
        question: '육종의 목표는?',
        answer: `수량증대, 품질향상, 내병성, 내재해성, 기계화적응, 소비자기호`,
        prompt: `종자기사 작물육종학 관련 질문입니다: 육종의 목표는? 이에 대해 자세히 설명해주세요.`
      },
      {
        id: 2,
        question: '교배육종법 과정은?',
        answer: `모본선정→교배→F1→세대진전→선발→계통육성→생산력검정→등록`,
        prompt: `종자기사 작물육종학 관련 질문입니다: 교배육종법 과정은? 이에 대해 자세히 설명해주세요.`
      },
      {
        id: 3,
        question: '돌연변이 육종이란?',
        answer: `방사선/화학물질로 변이유발. 단기간 신형질 획득. 키작은 벼/무종피 종자`,
        prompt: `종자기사 작물육종학 관련 질문입니다: 돌연변이 육종이란? 이에 대해 자세히 설명해주세요.`
      },
      {
        id: 4,
        question: '분자표지 활용법은?',
        answer: `DNA마커 이용 선발, 조기선발, 양적형질 분석(QTL), 분자육종`,
        prompt: `종자기사 작물육종학 관련 질문입니다: 분자표지 활용법은? 이에 대해 자세히 설명해주세요.`
      },
      {
        id: 5,
        question: 'F1종자(일대잡종)란?',
        answer: `잡종강세 이용. 균일성/수량↑. 채종복잡/종자비↑. 채소류 주류`,
        prompt: `종자기사 작물육종학 관련 질문입니다: F1종자(일대잡종)란? 이에 대해 자세히 설명해주세요.`
      },
  ]
};
...
export default function StudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('seed-engineer-plant-breeding-progress');
  ...
  const toggleComplete = (qId: number) => {
    ...
    localStorage.setItem('seed-engineer-plant-breeding-progress', JSON.stringify(newCompleted));
  };
