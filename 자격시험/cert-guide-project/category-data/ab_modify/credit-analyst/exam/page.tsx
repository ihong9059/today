...
export default function CreditAnalystExamPage() {
  ...
  const subjects = [
    { name: '회계원리', questions: 20, time: 25, topics: '회계의 기초, 재무제표, 회계순환과정, 자산·부채·자본회계' },
    { name: '재무회계', questions: 20, time: 25, topics: '재무보고 개념체계, 유동자산, 비유동자산, 부채, 자본' },
    { name: '신용분석', questions: 20, time: 25, topics: '신용분석 기초, 재무비율분석, 현금흐름분석, 신용등급' },
    { name: '기업분석', questions: 20, time: 25, topics: '기업분석 개요, 산업분석, 경영분석, 가치평가' },
  ];

  const registrationSteps = [
    { step: 1, title: '회원가입', description: '한국금융연수원 홈페이지에서 회원가입' },
    { step: 2, title: '시험접수', description: '자격시험 > 시험접수 메뉴에서 신용분석사 선택' },
  ...
  const examRules = [
    ...
    { icon: '✏️', title: '필기구 지참', description: '컴퓨터용 사인펜 지참 권장' },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-violet-50">
      ...
      <header className="bg-white/80 backdrop-blur-sm border-b border-blue-100 sticky top-0 z-40">
        <div className="max-w-6xl mx-auto px-4 py-4">
          ...
          <h1 className="text-2xl font-bold text-gray-800">신용분석사 시험 정보</h1>
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <section className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-white rounded-2xl p-5 shadow-lg border border-blue-100 text-center">
                ...
                {subjects.map((subject, index) => (
                  <div key={index} className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-sm text-blue-600 font-medium">{subject.questions}문항</span>
                    </div>
            ...
            <section className="bg-white rounded-2xl shadow-lg p-6 border border-blue-100">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {registrationSteps.map((step) => (
                  <div key={step.step} className="flex gap-4 p-4 bg-blue-50 rounded-xl">
              ...
              <div className="mt-6 p-4 bg-gradient-to-r from-blue-100 to-indigo-100 rounded-xl">
            ...
            <section className="bg-white rounded-2xl shadow-lg p-6 border border-blue-100">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-4 bg-blue-50 rounded-xl">
                  ...
                  <p className="text-2xl font-bold text-blue-600">50,000원</p>
                </div>
        ...
        {activeSection === 'info' && (
          <div className="space-y-6">
            ...
            <section className="bg-white rounded-2xl shadow-lg p-6 border border-blue-100">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-blue-50 rounded-xl">
                  <h3 className="font-bold text-gray-800 mb-2">금융기관 취업</h3>
                  <p className="text-sm text-gray-600">
                    은행, 저축은행, 캐피탈사 등 여신업무 담당자로 취업 시 우대
                  </p>
                </div>
                <div className="p-4 bg-indigo-50 rounded-xl">
                  <h3 className="font-bold text-gray-800 mb-2">신용평가회사</h3>
                  <p className="text-sm text-gray-600">
                    한국신용평가, NICE신용평가, 한국기업평가 등 입사 시 필수 또는 우대
                  </p>
                </div>
            ...
            <section className="bg-white rounded-2xl shadow-lg p-6 border border-blue-100">
              <h2 className="text-xl font-bold text-gray-800 mb-6">시험장 안내</h2>
              <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl">
                <p className="text-gray-700">
                  시험장은 접수 후 수험표에서 확인할 수 있습니다.
                  주로 서울, 부산, 대구, 대전, 광주 등 주요 도시에서 진행됩니다.
                </p>
              </div>
            </section>
          </div>
        ...
        {/* Study Links */}
        <section className="mt-8 bg-white rounded-2xl shadow-lg p-6 border border-blue-100">
          <h2 className="text-xl font-bold text-gray-800 mb-4">과목별 학습하기</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Link
              href="/category/finance/credit-analyst/study/accounting-principles"
              className="p-4 bg-blue-50 rounded-xl text-center hover:bg-blue-100 transition group"
            >
              <p className="font-bold text-blue-700 group-hover:scale-105 transition">회계원리</p>
              <p className="text-sm text-blue-500">20문항</p>
            </Link>
            <Link
              href="/category/finance/credit-analyst/study/financial-accounting"
              className="p-4 bg-indigo-50 rounded-xl text-center hover:bg-indigo-100 transition group"
            >
              <p className="font-bold text-indigo-700 group-hover:scale-105 transition">재무회계</p>
              <p className="text-sm text-indigo-500">20문항</p>
            </Link>
            <Link
              href="/category/finance/credit-analyst/study/credit-analysis"
              className="p-4 bg-violet-50 rounded-xl text-center hover:bg-violet-100 transition group"
            >
              <p className="font-bold text-violet-700 group-hover:scale-105 transition">신용분석</p>
              <p className="text-sm text-violet-500">20문항</p>
            </Link>
            <Link
              href="/category/finance/credit-analyst/study/corporate-analysis"
              className="p-4 bg-purple-50 rounded-xl text-center hover:bg-purple-100 transition group"
            >
              <p className="font-bold text-purple-700 group-hover:scale-105 transition">기업분석</p>
              <p className="text-sm text-purple-500">20문항</p>
            </Link>
          </div>
        </section>
