...
export default function SeedEngineerPage() {
  const subjects = [
    ...
    { id: 'crop-protection', name: '작물보호학', icon: '🛡️', desc: '병해충 방제', questions: 50 },
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">종자기사</h1>
          ...
          <Link
            href="/category/agriculture/seed-engineer/exam"
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          ...
          <div className="space-y-3">
            {subjects.map((subject) => (
              <Link
                key={subject.id}
                href={`/category/agriculture/seed-engineer/study/${subject.id}`}
