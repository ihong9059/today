export default function InformationProcessorPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-indigo-600 font-medium">정보처리기사</span>
          </nav>
        </div>
      </header>

      {/* Hero Section */}
      <section className="bg-gradient-to-r from-indigo-600 to-purple-500 text-white py-12">
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                <h1 className="text-3xl font-bold">정보처리기사</h1>
                <span className="bg-white/20 px-3 py-1 rounded-full text-sm">국가기술자격</span>
              </div>
              <p className="text-indigo-100 text-lg mb-4">Engineer Information Processing</p>
              <div className="flex flex-wrap gap-4 text-sm">
                ...
                <div className="flex items-center gap-2">
                  <span>👥</span>
                  <span>연간 응시자: 약 15만명</span>
                </div>
                <div className="flex items-center gap-2">
                  <span>✅</span>
                  <span>합격률: 필기 40% / 실기 50%</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-4 -mt-6">
        <div className="grid md:grid-cols-4 gap-4">
          <a href="/category/it/information-processor/exam" className="bg-white rounded-xl shadow-md p-4 text-center hover:shadow-lg hover:border-indigo-300 border-2 border-transparent transition cursor-pointer">
            <span className="text-2xl">📝</span>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white rounded-xl shadow-md p-6">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                정보처리기사는 컴퓨터를 이용한 정보시스템 구축에 필요한 업무를 수행하는 국가기술자격으로,
                프로그램 설계, 개발, 데이터베이스 구축, 시스템 운영 등 IT 전반에 걸친 전문 능력을 갖춘 기술인력입니다.
              </p>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-indigo-50 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-gray-600 space-y-1">
                    ...
                    <li>• 시스템 분석 및 요구사항 정의</li>
                    <li>• 정보시스템 운영 및 유지보수</li>
                  </ul>
                </div>
                <div className="bg-purple-50 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-800 mb-2">취업 분야</h3>
                  <ul className="text-sm text-gray-600 space-y-1">
                    <li>• SI 기업 (삼성SDS, LG CNS 등)</li>
                    <li>• 금융IT (카카오뱅크, 토스 등)</li>
            ...
            <section className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="space-y-3">
                {[
                  { name: '소프트웨어 설계', difficulty: 3, tip: '요구사항 분석, UML, 아키텍처' },
                  { name: '소프트웨어 개발', difficulty: 3, tip: '자료구조, 알고리즘, 테스트' },
                  { name: '데이터베이스 구축', difficulty: 3, tip: 'SQL, 정규화, 트랜잭션' },
                  { name: '프로그래밍 언어 활용', difficulty: 4, tip: 'C, Java, Python 코드 해석' },
                  { name: '정보시스템 구축관리', difficulty: 2, tip: '네트워크, 보안, 프로젝트관리' },
                ].map((subject, i) => (
            ...
            <section className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="mb-4">
                <div className="flex items-center gap-2 mb-2">
                  <span className="font-semibold text-gray-800">정보처리 실무</span>
                  <span className="text-sm text-gray-500">(필답형 - 서술, 약술, 단답)</span>
                </div>
              </div>
              <div className="grid md:grid-cols-2 gap-3">
                {[
                  { name: '프로그래밍 언어', ratio: '30%', desc: 'C, Java, Python 코드 실행 결과' },
                  { name: 'SQL 작성', ratio: '25%', desc: 'SELECT, JOIN, 서브쿼리' },
                  { name: '화면설계/요구분석', ratio: '20%', desc: 'UML, 유스케이스, 클래스' },
                  { name: '신기술/보안', ratio: '25%', desc: '네트워크, 암호화, 애자일' },
                ].map((item, i) => (
            ...
            <section className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="border-2 border-indigo-200 rounded-xl p-4">
                  <h3 className="font-bold text-indigo-600 mb-3">👨‍🎓 비전공자 (3개월)</h3>
                  <div className="space-y-2">
                    {[
                      { step: 1, name: '프로그래밍 언어', period: '4주', note: '핵심!' },
                      { step: 2, name: '데이터베이스', period: '3주', note: 'SQL' },
                      { step: 3, name: '소프트웨어 개발', period: '2주', note: '' },
                      { step: 4, name: '소프트웨어 설계', period: '2주', note: '' },
                      { step: 5, name: '정보시스템 구축관리', period: '1주', note: '암기' },
                    ].map((item) => (
                ...
                <div className="border-2 border-green-200 rounded-xl p-4">
                  ...
                  <div className="space-y-2">
                    {[
                      { step: 1, name: '프로그래밍 + DB', period: '3주', note: '복습' },
                      { step: 2, name: '개발 + 설계', period: '2주', note: '심화' },
                      { step: 3, name: '구축관리', period: '1주', note: '암기' },
            ...
            <section className="bg-gradient-to-r from-purple-500 to-indigo-500 rounded-xl shadow-md p-6 text-white">
              ...
              <p className="text-purple-100 mb-4">Claude AI에게 정보처리기사 관련 질문을 해보세요!</p>
              <div className="space-y-3">
                <div className="bg-white/10 rounded-lg p-3">
                  <p className="text-sm text-purple-200 mb-1">개념 질문</p>
                  <p className="text-white">&quot;정규화 1NF, 2NF, 3NF, BCNF 차이를 쉽게 설명해줘&quot;</p>
                </div>
                <div className="bg-white/10 rounded-lg p-3">
                  <p className="text-sm text-purple-200 mb-1">코드 해석</p>
                  <p className="text-white">&quot;Java 상속과 다형성 관련 코드 문제 5개 만들어줘&quot;</p>
                </div>
                <div className="bg-white/10 rounded-lg p-3">
                  <p className="text-sm text-purple-200 mb-1">SQL 연습</p>
                  <p className="text-white">&quot;JOIN과 서브쿼리 실기 예상 문제 풀어보자&quot;</p>
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-md p-5">
              ...
              <div className="space-y-3">
                {[
                  { name: '소프트웨어 설계', target: 65, color: 'bg-indigo-500' },
                  { name: '소프트웨어 개발', target: 65, color: 'bg-blue-500' },
                  { name: '데이터베이스 구축', target: 70, color: 'bg-cyan-500' },
                  { name: '프로그래밍 언어', target: 55, color: 'bg-purple-500' },
                  { name: '정보시스템 구축관리', target: 75, color: 'bg-pink-500' },
                ].map((item) => (
                  <div key={item.name}>
              ...
              <div className="mt-4 p-3 bg-indigo-50 rounded-lg text-center">
                ...
                <p className="text-2xl font-bold text-indigo-600">66점</p>
            ...
            <div className="bg-white rounded-xl shadow-md p-5">
              ...
              <div className="space-y-2">
                {[
                  ...
                  { name: '빅데이터분석기사', desc: '데이터 분석' },
                  { name: 'SQLD/SQLP', desc: 'DB 전문 자격' },
            ...
            <div className="bg-white rounded-xl shadow-md p-5">
              ...
              <div className="space-y-3">
                <a href="https://www.youtube.com/@2Woo_-" target="_blank" rel="noopener noreferrer"
                  className="block p-3 border rounded-lg hover:border-indigo-400 transition">
                  <p className="font-medium text-gray-800">두목넷</p>
