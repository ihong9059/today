...
export default function ITCategoryPage() {
  const certifications = [
    ...
    {
      id: 'computer-org-engineer',
      name: '전자계산기조직응용기사',
      englishName: 'Engineer Computer Organization',
      icon: '🖥️',
      color: 'from-purple-500 to-violet-600',
      difficulty: 4,
      description: '컴퓨터 구조 및 시스템 전문',
      subjects: ['전자계산기구조', '마이크로프로세서', '운영체제'],
      hasStudyPage: true,
      href: '/category/it/computer-org-engineer',
    },
    {
      id: 'computer-system-pe',
      name: '컴퓨터시스템응용기술사',
      englishName: 'Professional Engineer Computer System',
      icon: '🏆',
      color: 'from-amber-500 to-yellow-600',
      difficulty: 5,
      description: '컴퓨터 시스템 최고 기술 자격',
      subjects: ['컴퓨터구조', '데이터베이스', '네트워크'],
      hasStudyPage: true,
      href: '/category/it/computer-system-pe',
    },
    {
      id: 'info-management-pe',
      name: '정보관리기술사',
      englishName: 'Professional Engineer Information Management',
      icon: '📊',
      color: 'from-teal-500 to-cyan-600',
      difficulty: 5,
      description: '정보 관리 최고 기술 자격',
      subjects: ['정보전략계획', '소프트웨어공학', '데이터베이스'],
      hasStudyPage: true,
      href: '/category/it/info-management-pe',
    },
  ];
