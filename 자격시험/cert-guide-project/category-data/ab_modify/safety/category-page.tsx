...
export default function SafetyCategoryPage() {
  const certifications: {
    ...
    {
      id: 'hazardous-craftsman',
      name: '위험물기능사',
      englishName: 'Craftsman Hazardous Materials',
      icon: '☢️',
      color: 'from-red-500 to-orange-500',
      difficulty: 2,
      description: '위험물 안전 관리 및 취급 기능 인력',
      subjects: ['일반화학', '화재예방과 소화방법', '위험물의 성질과 취급'],
      hasStudyPage: true,
      href: '/category/safety/hazardous-craftsman',
    },
    {
      id: 'gas-engineer',
      name: '가스기사',
    ...
    },
    {
      ...
      name: '산업위생관리기사',
      englishName: 'Engineer Industrial Hygiene Management',
      icon: '🏭',
      color: 'from-green-500 to-teal-500',
      difficulty: 4,
      description: '작업환경 측정 및 산업보건 관리 전문가',
      subjects: ['산업위생학개론', '작업환경측정', '작업환경관리', '산업독성학', '실기'],
      hasStudyPage: true,
      href: '/category/safety/industrial-hygiene',
    },
  ];
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="bg-red-50 rounded-xl p-6 border border-red-200">
            ...
            <ul className="text-sm text-red-700 space-y-1">
              ...
              <li>• 위험물기사/기능사: 위험물 제조소·저장소·취급소 안전관리자 선임 가능</li>
