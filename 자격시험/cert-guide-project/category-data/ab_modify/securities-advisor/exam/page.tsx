...
export default function SecuritiesAdvisorExamPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm flex-wrap">
            ...
            <span className="text-gray-300">/</span>
            <Link href="/category/finance/securities-advisor" className="text-gray-600 hover:text-emerald-600">증권투자권유자문인력</Link>
            <span className="text-gray-300">/</span>
      ...
      {/* Hero */}
      <section className="bg-gradient-to-r from-emerald-600 to-green-500 text-white py-10">
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 bg-white/20 rounded-xl flex items-center justify-center text-3xl">📝</div>
            <div>
              <h1 className="text-2xl font-bold">증권투자권유자문인력 시험정보</h1>
              <p className="text-emerald-100">시험 구조, 과목별 상세 내용, 합격 전략</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
          ...
          <div className="space-y-6">
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white rounded-xl shadow-sm p-6 border text-center">
                ...
                <p className="text-2xl font-bold text-emerald-600">CBT</p>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border">
                ...
                {subjectDetails.map((subject, idx) => (
                  <div key={idx} className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div className="text-right">
                      <p className="text-xl font-bold text-emerald-600">{subject.questions}</p>
              ...
              <div className="mt-4 p-4 bg-emerald-50 rounded-lg">
                <div className="flex justify-between items-center">
                  <span className="font-bold text-emerald-800">총계</span>
                  <span className="text-xl font-bold text-emerald-600">100문항 / 100점</span>
                </div>
              </div>
            </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-emerald-100">{subject.questions}문항 출제</p>
                      </div>
                    </div>
                    <Link
                      href={`/category/finance/securities-advisor/study/${subject.name === '금융투자상품' ? 'investment-products' : subject.name === '증권분석' ? 'securities-analysis' : subject.name === '투자권유' ? 'investment-recommendation' : 'securities-law-ethics'}`}
        ...
        {activeSection === 'tips' && (
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm p-6 border">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-emerald-50 rounded-lg border-l-4 border-emerald-500">
                  <h3 className="font-bold text-emerald-800">금융투자상품 (25문항)</h3>
                  <p className="text-sm text-emerald-700 mt-1">
                    주식, 채권, 파생상품의 기본 개념과 특성을 정확히 이해해야 합니다.
                    특히 각 상품의 위험-수익 특성과 투자자 적합성 판단이 중요합니다.
                  </p>
                </div>
                <div className="p-4 bg-green-50 rounded-lg border-l-4 border-green-500">
                  <h3 className="font-bold text-green-800">증권분석 (25문항)</h3>
                  <p className="text-sm text-green-700 mt-1">
                    기본적 분석(재무제표, 기업가치)과 기술적 분석(차트, 지표)을 균형있게 학습하세요.
                    포트폴리오 이론과 자산배분 전략도 중요한 출제 영역입니다.
                  </p>
                </div>
                <div className="p-4 bg-teal-50 rounded-lg border-l-4 border-teal-500">
                  <h3 className="font-bold text-teal-800">투자권유 (25문항)</h3>
                  <p className="text-sm text-teal-700 mt-1">
                    적합성·적정성 원칙과 설명의무의 적용 상황을 명확히 구분해야 합니다.
                    투자자 유형별(일반/전문) 적용 규정을 확실히 이해하세요.
                  </p>
                </div>
                <div className="p-4 bg-indigo-50 rounded-lg border-l-4 border-indigo-500">
                  <h3 className="font-bold text-indigo-800">직무윤리 및 법규 (25문항)</h3>
                  <p className="text-sm text-indigo-700 mt-1">
                    자본시장법의 핵심 조문과 용어 정의를 암기하세요.
                    불공정거래 유형의 구성요건을 정확히 이해하는 것이 중요합니다.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border">
              <h2 className="text-lg font-bold text-gray-800 mb-4">⏰ 추천 학습 일정 (6주)</h2>
              <div className="space-y-4">
                {[
                  { week: '1주차', content: '금융투자상품 - 주식, 채권, 파생상품 기초', hours: '12시간' },
                  { week: '2주차', content: '증권분석 - 기본적 분석, 재무제표', hours: '12시간' },
                  { week: '3주차', content: '증권분석 - 기술적 분석, 포트폴리오', hours: '12시간' },
                  { week: '4주차', content: '투자권유 - 적합성, 설명의무', hours: '12시간' },
                  { week: '5주차', content: '직무윤리 및 법규 - 자본시장법', hours: '12시간' },
                  { week: '6주차', content: '기출문제 풀이 + 오답정리', hours: '20시간' },
                ].map((item, idx) => (
                  <div key={idx} className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
                    <div className="w-16 h-16 bg-emerald-500 text-white rounded-lg flex items-center justify-center font-bold text-sm">
                      {item.week}
                    </div>
                    <div className="flex-1">
            ...
            <div className="bg-gradient-to-r from-emerald-500 to-green-500 rounded-xl p-6 text-white">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-white/10 rounded-lg p-4">
                  <h3 className="font-bold mb-2">펀드자격과 연계 학습</h3>
                  <p className="text-sm text-emerald-100">투자권유, 법규 파트는 펀드자격과 유사합니다. 함께 준비하면 효율적입니다.</p>
                </div>
                <div className="bg-white/10 rounded-lg p-4">
                  <h3 className="font-bold mb-2">금융상품 이해 우선</h3>
                  <p className="text-sm text-emerald-100">주식, 채권, 파생상품의 특성 이해가 다른 과목 학습의 기초가 됩니다.</p>
                </div>
                <div className="bg-white/10 rounded-lg p-4">
                  <h3 className="font-bold mb-2">기출문제 반복</h3>
                  <p className="text-sm text-emerald-100">최근 3개년 기출문제를 최소 3회 이상 풀어보세요.</p>
                </div>
                <div className="bg-white/10 rounded-lg p-4">
                  <h3 className="font-bold mb-2">시간 관리</h3>
                  <p className="text-sm text-emerald-100">1문항 1분 원칙. 어려운 문제는 표시 후 나중에 풀이하세요.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 flex justify-between">
          ...
          <Link href="/category/finance/securities-advisor/study/investment-products" className="px-4 py-2 bg-emerald-500 text-white rounded-lg hover:bg-emerald-600">
            학습 시작하기 →
          </Link>
        </div>
      </main>
