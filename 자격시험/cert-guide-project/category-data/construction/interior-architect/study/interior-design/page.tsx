...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '실내공간 구성요소를 설명하시오.',
        answer: '바닥, 벽, 천장, 가구, 조명',
        prompt: `실내건축기사 실내디자인론 문제입니다.\n\n문제: 실내공간 구성요소를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },      {
        id: 2,
        question: '인간공학적 치수 적용 예를 드시오.',
        answer: '의자높이 420mm, 작업면 720mm 등',
        prompt: `실내건축기사 실내디자인론 문제입니다.\n\n문제: 인간공학적 치수 적용 예를 드시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
];

export default function InteriordesignStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('interior-design-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('interior-design-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-purple-600 font-medium">실내디자인론</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">실내디자인론 학습</h1>
