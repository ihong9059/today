...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '흙의 다짐 시험에서 최적함수비와 최대건조밀도를 설명하시오.',
        answer: '다짐곡선에서 최대값과 그때의 함수비',
        prompt: `토목기사 토질 및 기초 문제입니다.\n\n문제: 흙의 다짐 시험에서 최적함수비와 최대건조밀도를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },      {
        id: 2,
        question: '연약지반 개량공법의 종류를 설명하시오.',
        answer: '치환공법, 압밀공법, 고결공법',
        prompt: `토목기사 토질 및 기초 문제입니다.\n\n문제: 연약지반 개량공법의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
];
...
export default function SoilmechanicsStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('soil-mechanics-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('soil-mechanics-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-amber-600 font-medium">토질 및 기초</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">토질 및 기초 학습</h1>
