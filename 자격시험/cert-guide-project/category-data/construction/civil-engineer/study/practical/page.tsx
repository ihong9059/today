...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '토목 구조물 설계 시 하중조합을 설명하시오.',
        answer: '고정하중, 활하중, 충격, 풍하중, 지진',
        prompt: `토목기사 실기 문제입니다.\n\n문제: 토목 구조물 설계 시 하중조합을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
];
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-amber-600 font-medium">실기</span>
          </nav>
        </div>
      </header>
