...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '직접수준측량과 간접수준측량의 차이점을 설명하시오.',
        answer: '레벨 사용 vs 삼각측량 이용',
        prompt: `토목기사 측량학 문제입니다.\n\n문제: 직접수준측량과 간접수준측량의 차이점을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },      {
        id: 2,
        question: '레벨 조정법(양차법)을 설명하시오.',
        answer: '기계오차 소거를 위해 중간에 레벨 설치',
        prompt: `토목기사 측량학 문제입니다.\n\n문제: 레벨 조정법(양차법)을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  },  {
    id: 'traversing',
    ...
    questions: [
      {
        id: 1,
        question: '폐합트래버스의 조정 방법을 설명하시오.',
        answer: '위거조정법, 콤파스법칙',
        prompt: `토목기사 측량학 문제입니다.\n\n문제: 폐합트래버스의 조정 방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
];
...
export default function SurveyingStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('surveying-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('surveying-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-amber-600 font-medium">측량학</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">측량학 학습</h1>
