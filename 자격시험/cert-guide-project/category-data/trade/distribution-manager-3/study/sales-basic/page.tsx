...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '판매 5단계를 설명하시오.',
        answer: '접근→니즈파악→상품설명→이의극복→마무리',
        prompt: `유통관리사 3급 판매기초 문제입니다.\n\n문제: 판매 5단계를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '상향판매(Up-selling)를 설명하시오.',
        answer: '더 비싼 상품 권유',
        prompt: `유통관리사 3급 판매기초 문제입니다.\n\n문제: 상향판매(Up-selling)를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '교차판매(Cross-selling)를 설명하시오.',
        answer: '관련 상품 추가 권유',
        prompt: `유통관리사 3급 판매기초 문제입니다.\n\n문제: 교차판매(Cross-selling)를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '판매촉진 수단을 설명하시오.',
        answer: '쿠폰, 샘플, 경품, 할인, POP',
        prompt: `유통관리사 3급 판매기초 문제입니다.\n\n문제: 판매촉진 수단을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '계산대 응대를 설명하시오.',
        answer: '신속정확, 감사인사, 포장, 영수증',
        prompt: `유통관리사 3급 판매기초 문제입니다.\n\n문제: 계산대 응대를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function SalesbasicStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('sales-basic-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('sales-basic-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-teal-600 font-medium">판매기초</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">판매기초 학습</h1>
