...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: 'Bill of Lading의 기능을 설명하시오.',
        answer: '운송계약증거, 화물수령증, 권리증권',
        prompt: `무역영어 2급 무역용어 문제입니다.\n\n문제: Bill of Lading의 기능을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'Packing List의 내용을 설명하시오.',
        answer: '포장명세, 개수, 중량, 용적',
        prompt: `무역영어 2급 무역용어 문제입니다.\n\n문제: Packing List의 내용을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'Commercial Invoice의 기능을 설명하시오.',
        answer: '상업송장, 대금청구, 통관서류',
        prompt: `무역영어 2급 무역용어 문제입니다.\n\n문제: Commercial Invoice의 기능을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: 'Certificate of Origin의 용도를 설명하시오.',
        answer: '원산지증명, 관세혜택, FTA 적용',
        prompt: `무역영어 2급 무역용어 문제입니다.\n\n문제: Certificate of Origin의 용도를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: 'Insurance Policy의 종류를 설명하시오.',
        answer: '개별보험, 포괄예정보험',
        prompt: `무역영어 2급 무역용어 문제입니다.\n\n문제: Insurance Policy의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
];

export default function TradevocabStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('trade-vocab-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('trade-vocab-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/trade/trade-english-2" className="text-gray-600 hover:text-teal-600">무역영어 2급</Link>
            <span className="text-gray-300">›</span>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-teal-100">무역영어 2급</p>
              </div>
            </div>
