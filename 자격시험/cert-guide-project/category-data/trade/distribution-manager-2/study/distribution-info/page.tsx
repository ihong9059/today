...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: 'POS시스템의 기능을 설명하시오.',
        answer: '판매관리, 재고관리, 고객관리, 분석',
        prompt: `유통관리사 2급 유통정보 문제입니다.\n\n문제: POS시스템의 기능을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '바코드 체계를 설명하시오.',
        answer: 'EAN-13, UPC, 국가/제조업체/상품코드',
        prompt: `유통관리사 2급 유통정보 문제입니다.\n\n문제: 바코드 체계를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'RFID를 설명하시오.',
        answer: '무선인식, 재고추적, SCM 효율화',
        prompt: `유통관리사 2급 유통정보 문제입니다.\n\n문제: RFID를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: 'EDI를 설명하시오.',
        answer: '전자문서교환, 표준양식, 자동처리',
        prompt: `유통관리사 2급 유통정보 문제입니다.\n\n문제: EDI를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '빅데이터 활용을 설명하시오.',
        answer: '구매패턴 분석, 수요예측, 개인화',
        prompt: `유통관리사 2급 유통정보 문제입니다.\n\n문제: 빅데이터 활용을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function DistributioninfoStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('distribution-info-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('distribution-info-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-teal-600 font-medium">유통정보</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">유통정보 학습</h1>
