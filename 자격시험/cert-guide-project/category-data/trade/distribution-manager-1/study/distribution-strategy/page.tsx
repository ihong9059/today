...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '유통경로의 유형을 설명하시오.',
        answer: '직접/간접유통, 전속/선택/개방유통',
        prompt: `유통관리사 1급 유통전략 문제입니다.\n\n문제: 유통경로의 유형을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '수직적 마케팅시스템을 설명하시오.',
        answer: '기업형, 계약형, 관리형 VMS',
        prompt: `유통관리사 1급 유통전략 문제입니다.\n\n문제: 수직적 마케팅시스템을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        ...
        id: 4,
        question: '채널갈등 관리를 설명하시오.',
        answer: '수평/수직갈등, 조정메커니즘',
        prompt: `유통관리사 1급 유통전략 문제입니다.\n\n문제: 채널갈등 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '채널파워의 원천을 설명하시오.',
        answer: '보상, 강압, 전문성, 준거, 합법적 파워',
        prompt: `유통관리사 1급 유통전략 문제입니다.\n\n문제: 채널파워의 원천을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '소매업태의 종류를 설명하시오.',
        answer: '백화점, 할인점, 편의점, 전문점, 온라인',
        prompt: `유통관리사 1급 유통전략 문제입니다.\n\n문제: 소매업태의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '소매믹스 전략을 설명하시오.',
        answer: '상품, 가격, 촉진, 입지, 서비스',
        prompt: `유통관리사 1급 유통전략 문제입니다.\n\n문제: 소매믹스 전략을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '머천다이징을 설명하시오.',
        answer: '적정상품, 적정가격, 적정시기, 적정장소',
        prompt: `유통관리사 1급 유통전략 문제입니다.\n\n문제: 머천다이징을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '카테고리 관리를 설명하시오.',
        answer: '카테고리별 수익극대화, 역할/전략 설정',
        prompt: `유통관리사 1급 유통전략 문제입니다.\n\n문제: 카테고리 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '고객관계관리(CRM)를 설명하시오.',
        answer: '고객데이터 분석, 맞춤 마케팅, 충성도',
...
export default function DistributionstrategyStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('distribution-strategy-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('distribution-strategy-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/trade/distribution-manager-1" className="text-gray-600 hover:text-teal-600">유통관리사 1급</Link>
            <span className="text-gray-300">›</span>
            <span className="text-teal-600 font-medium">유통전략</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">유통전략 학습</h1>
                <p className="text-teal-100">유통관리사 1급</p>
              </div>
            </div>
