...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: 'Inquiry Letter의 구성요소를 설명하시오.',
        answer: '상품문의, 가격조건, 납기, 결제조건 요청',
        prompt: `무역영어 1급 무역서신 문제입니다.\n\n문제: Inquiry Letter의 구성요소를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'Firm Offer와 Free Offer의 차이를 설명하시오.',
        answer: 'Firm: 구속력 있음, Free: 구속력 없음',
        prompt: `무역영어 1급 무역서신 문제입니다.\n\n문제: Firm Offer와 Free Offer의 차이를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'Counter Offer의 효력을 설명하시오.',
        answer: '원래 청약 거절+새로운 청약 제시',
        prompt: `무역영어 1급 무역서신 문제입니다.\n\n문제: Counter Offer의 효력을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: 'Acceptance의 요건을 설명하시오.',
        answer: '무조건적 승낙, 유효기간 내, 통지',
        prompt: `무역영어 1급 무역서신 문제입니다.\n\n문제: Acceptance의 요건을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: 'Proforma Invoice의 용도를 설명하시오.',
        answer: '견적서, 수입허가, 신용장 개설 근거',
        prompt: `무역영어 1급 무역서신 문제입니다.\n\n문제: Proforma Invoice의 용도를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    id: 'contract-claim',
    ...
    questions: [
      {
        id: 1,
        question: 'Sales Contract의 필수조항을 설명하시오.',
        answer: '품명, 수량, 가격, 선적, 결제, 보험조건',
        prompt: `무역영어 1급 무역서신 문제입니다.\n\n문제: Sales Contract의 필수조항을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'Force Majeure 조항을 설명하시오.',
        answer: '불가항력 사유로 인한 면책조항',
        prompt: `무역영어 1급 무역서신 문제입니다.\n\n문제: Force Majeure 조항을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'Claim Letter 작성요령을 설명하시오.',
        answer: '사실관계, 증빙서류, 보상요구 명확히',
        prompt: `무역영어 1급 무역서신 문제입니다.\n\n문제: Claim Letter 작성요령을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: 'Arbitration 조항을 설명하시오.',
        answer: '분쟁 시 중재기관 통한 해결 합의',
        prompt: `무역영어 1급 무역서신 문제입니다.\n\n문제: Arbitration 조항을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: 'Letter of Guarantee의 종류를 설명하시오.',
        answer: '이행보증, 입찰보증, 선수금환급보증',
        prompt: `무역영어 1급 무역서신 문제입니다.\n\n문제: Letter of Guarantee의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
];

export default function BusinessletterStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('business-letter-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('business-letter-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-teal-600 font-medium">무역서신</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">무역서신 학습</h1>
