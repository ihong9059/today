...
const topics = [
  {
    id: 'customs-procedure',
    name: '통관절차',
    color: 'from-teal-500 to-cyan-500',
    questions: [
      {
        id: 1,
        question: '수입통관절차를 설명하시오.',
        answer: '입항→하역→장치→신고→심사→납부→반출',
        prompt: `국제무역사 관세법규 문제입니다.\n\n문제: 수입통관절차를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '수출통관절차를 설명하시오.',
        answer: '신고→심사→검사→적재→출항',
        prompt: `국제무역사 관세법규 문제입니다.\n\n문제: 수출통관절차를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '과세가격 결정을 설명하시오.',
        answer: '거래가격, 합산요소, 공제요소',
        prompt: `국제무역사 관세법규 문제입니다.\n\n문제: 과세가격 결정을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '관세의 종류를 설명하시오.',
        answer: '기본관세, 탄력관세, 보복관세',
        prompt: `국제무역사 관세법규 문제입니다.\n\n문제: 관세의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: 'FTA 활용을 설명하시오.',
        answer: '원산지증명, 협정세율 적용',
        prompt: `국제무역사 관세법규 문제입니다.\n\n문제: FTA 활용을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function CustomslawStudyPage() {
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('customs-law-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-teal-600 font-medium">관세법규</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">관세법규 학습</h1>
