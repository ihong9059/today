...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '운송수단별 특성을 설명하시오.',
        answer: '도로(문전), 철도(대량), 해상(저렴), 항공(신속)',
        prompt: `물류관리사 수송론 문제입니다.\n\n문제: 운송수단별 특성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '복합운송의 장점을 설명하시오.',
        answer: '일관운송, 단일책임, 비용절감',
        prompt: `물류관리사 수송론 문제입니다.\n\n문제: 복합운송의 장점을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '운송경로 최적화를 설명하시오.',
        answer: '최단경로, 차량배차, 배송계획',
        prompt: `물류관리사 수송론 문제입니다.\n\n문제: 운송경로 최적화를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '공동배송을 설명하시오.',
        answer: '여러 화주 화물 혼적, 효율화',
        prompt: `물류관리사 수송론 문제입니다.\n\n문제: 공동배송을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '밀크런 시스템을 설명하시오.',
        answer: '순회집하, 다수 공급처 순환',
        prompt: `물류관리사 수송론 문제입니다.\n\n문제: 밀크런 시스템을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '포워더의 역할을 설명하시오.',
        answer: '운송주선, 서류처리, 통관대행',
        prompt: `물류관리사 수송론 문제입니다.\n\n문제: 포워더의 역할을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'FCL과 LCL을 설명하시오.',
        answer: 'FCL: 컨테이너 전용, LCL: 혼적',
        prompt: `물류관리사 수송론 문제입니다.\n\n문제: FCL과 LCL을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '해상운임 구조를 설명하시오.',
        answer: '기본운임+BAF+CAF+THC',
        prompt: `물류관리사 수송론 문제입니다.\n\n문제: 해상운임 구조를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '항공화물 운임을 설명하시오.',
        answer: '중량/용적 중 큰 것 적용',
        prompt: `물류관리사 수송론 문제입니다.\n\n문제: 항공화물 운임을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '보세운송을 설명하시오.',
        answer: '관세 미납상태 국내이동',
        prompt: `물류관리사 수송론 문제입니다.\n\n문제: 보세운송을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
...
export default function TransporttheoryStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('transport-theory-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('transport-theory-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/trade/logistics-manager" className="text-gray-600 hover:text-teal-600">물류관리사</Link>
            <span className="text-gray-300">›</span>
            <span className="text-teal-600 font-medium">수송론</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">수송론 학습</h1>
                <p className="text-teal-100">물류관리사</p>
              </div>
            </div>
