...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '창고의 종류를 설명하시오.',
        answer: '자가창고, 영업창고, 보세창고',
        prompt: `물류관리사 보관하역론 문제입니다.\n\n문제: 창고의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '입출고 방식을 설명하시오.',
        answer: 'FIFO, LIFO, FEFO',
        prompt: `물류관리사 보관하역론 문제입니다.\n\n문제: 입출고 방식을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '로케이션 관리를 설명하시오.',
        answer: '고정/프리로케이션, 존/랙/셀',
        prompt: `물류관리사 보관하역론 문제입니다.\n\n문제: 로케이션 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '재고관리 기법을 설명하시오.',
        answer: 'ABC분석, 안전재고, 발주점',
        prompt: `물류관리사 보관하역론 문제입니다.\n\n문제: 재고관리 기법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: 'WMS의 기능을 설명하시오.',
        answer: '입출고관리, 재고관리, 피킹, 재고실사',
        prompt: `물류관리사 보관하역론 문제입니다.\n\n문제: WMS의 기능을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        ...
        id: 3,
        question: '자동창고 시스템을 설명하시오.',
        answer: 'AS/RS, 스태커크레인, 셔틀',
        prompt: `물류관리사 보관하역론 문제입니다.\n\n문제: 자동창고 시스템을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '파렛트의 규격을 설명하시오.',
        answer: 'T-11(1100×1100), 표준화',
        prompt: `물류관리사 보관하역론 문제입니다.\n\n문제: 파렛트의 규격을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '유닛로드 시스템을 설명하시오.',
        answer: '단위화물화, 하역효율 향상',
        prompt: `물류관리사 보관하역론 문제입니다.\n\n문제: 유닛로드 시스템을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function WarehousemanagementStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('warehouse-management-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('warehouse-management-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-teal-600 font-medium">보관하역론</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">보관하역론 학습</h1>
