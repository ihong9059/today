...
const topics = [
  {
    id: 'logistics-regulation',
    name: '물류법규',
    color: 'from-teal-500 to-cyan-500',
    questions: [
      {
        id: 1,
        question: '물류정책기본법의 목적을 설명하시오.',
        answer: '물류체계 효율화, 국가경쟁력 강화',
        prompt: `물류관리사 물류관련법규 문제입니다.\n\n문제: 물류정책기본법의 목적을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '화물자동차운수사업법을 설명하시오.',
        answer: '운송사업 허가, 운임/요금 규정',
        prompt: `물류관리사 물류관련법규 문제입니다.\n\n문제: 화물자동차운수사업법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '물류시설법을 설명하시오.',
        answer: '물류단지 개발, 시설확충',
        prompt: `물류관리사 물류관련법규 문제입니다.\n\n문제: 물류시설법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '유통산업발전법을 설명하시오.',
        answer: '대형마트 영업규제, 전통시장 보호',
        prompt: `물류관리사 물류관련법규 문제입니다.\n\n문제: 유통산업발전법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '항만운송사업법을 설명하시오.',
        answer: '항만하역, 검수, 검량 사업 규정',
        prompt: `물류관리사 물류관련법규 문제입니다.\n\n문제: 항만운송사업법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function LogisticslawStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('logistics-law-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('logistics-law-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-teal-600 font-medium">물류관련법규</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">물류관련법규 학습</h1>
