...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: 'VLOOKUP 함수를 설명하시오.',
        answer: '수직검색, =VLOOKUP(검색값,범위,열번호,옵션)',
        prompt: `컴퓨터활용능력 1급 스프레드시트 문제입니다.\n\n문제: VLOOKUP 함수를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'INDEX/MATCH 함수를 설명하시오.',
        answer: 'INDEX(범위,행번호), MATCH(검색값,범위,옵션)',
        prompt: `컴퓨터활용능력 1급 스프레드시트 문제입니다.\n\n문제: INDEX/MATCH 함수를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '피벗테이블을 설명하시오.',
        answer: '데이터 요약/분석, 행/열/값 필드 구성',
        prompt: `컴퓨터활용능력 1급 스프레드시트 문제입니다.\n\n문제: 피벗테이블을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '조건부 서식을 설명하시오.',
        answer: '조건에 따른 셀 서식 자동 변경',
        prompt: `컴퓨터활용능력 1급 스프레드시트 문제입니다.\n\n문제: 조건부 서식을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '배열 수식을 설명하시오.',
        answer: 'Ctrl+Shift+Enter, 여러 값 동시 계산',
        prompt: `컴퓨터활용능력 1급 스프레드시트 문제입니다.\n\n문제: 배열 수식을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: 'SUMIF/SUMIFS를 설명하시오.',
        answer: '조건부 합계, 단일/다중 조건',
        prompt: `컴퓨터활용능력 1급 스프레드시트 문제입니다.\n\n문제: SUMIF/SUMIFS를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'IF 중첩을 설명하시오.',
        answer: '다중 조건 판단, IF(조건1,값1,IF(조건2,값2,값3))',
        prompt: `컴퓨터활용능력 1급 스프레드시트 문제입니다.\n\n문제: IF 중첩을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'DATE 함수들을 설명하시오.',
        answer: 'YEAR, MONTH, DAY, TODAY, NOW',
        prompt: `컴퓨터활용능력 1급 스프레드시트 문제입니다.\n\n문제: DATE 함수들을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: 'TEXT 함수를 설명하시오.',
        answer: '숫자→텍스트 변환, 서식 지정',
        prompt: `컴퓨터활용능력 1급 스프레드시트 문제입니다.\n\n문제: TEXT 함수를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: 'OFFSET 함수를 설명하시오.',
        answer: '기준셀에서 이동한 범위 참조',
        prompt: `컴퓨터활용능력 1급 스프레드시트 문제입니다.\n\n문제: OFFSET 함수를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function Spreadsheet1StudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('spreadsheet-1-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('spreadsheet-1-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/office/computer-skills-1" className="text-gray-600 hover:text-violet-600">컴퓨터활용능력 1급</Link>
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">스프레드시트</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">스프레드시트 학습</h1>
                <p className="text-violet-100">컴퓨터활용능력 1급</p>
              </div>
            </div>
