...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '전화응대 요령을 설명하시오.',
        answer: '3콜내 수신, 인사, 메모, 전달',
        prompt: `비서 2급 비서 실무 문제입니다.\n\n문제: 전화응대 요령을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '방문객 응대를 설명하시오.',
        answer: '안내, 명함접수, 음료제공, 배웅',
        prompt: `비서 2급 비서 실무 문제입니다.\n\n문제: 방문객 응대를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '우편물 처리를 설명하시오.',
        answer: '수신/발신 분류, 등기관리, 배포',
        prompt: `비서 2급 비서 실무 문제입니다.\n\n문제: 우편물 처리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '비품관리를 설명하시오.',
        answer: '재고확인, 발주, 입고, 불출',
        prompt: `비서 2급 비서 실무 문제입니다.\n\n문제: 비품관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '환경관리를 설명하시오.',
        answer: '사무실 정리, 시설점검, 안전관리',
        prompt: `비서 2급 비서 실무 문제입니다.\n\n문제: 환경관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '일정표 작성을 설명하시오.',
        answer: '일간/주간/월간, 우선순위 표시',
        prompt: `비서 2급 비서 실무 문제입니다.\n\n문제: 일정표 작성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '약속잡기 요령을 설명하시오.',
        answer: '일정확인, 장소/시간 조율, 확인',
        prompt: `비서 2급 비서 실무 문제입니다.\n\n문제: 약속잡기 요령을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '회의록 작성을 설명하시오.',
        answer: '일시/참석자, 안건, 결정사항, 추후일정',
        prompt: `비서 2급 비서 실무 문제입니다.\n\n문제: 회의록 작성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '자료준비를 설명하시오.',
        answer: '관련문서 수집, 복사, 배포',
        prompt: `비서 2급 비서 실무 문제입니다.\n\n문제: 자료준비를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '알림 관리를 설명하시오.',
        answer: '리마인더, 사전 알림, 팔로업',
        prompt: `비서 2급 비서 실무 문제입니다.\n\n문제: 알림 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function SecretarypracticeStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('secretary-practice-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('secretary-practice-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/office/secretary-2" className="text-gray-600 hover:text-violet-600">비서 2급</Link>
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">비서 실무</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">비서 실무 학습</h1>
                <p className="text-violet-100">비서 2급</p>
              </div>
            </div>
