...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '이메일 작성법을 설명하시오.',
        answer: '제목, 인사, 본문, 서명, CC/BCC',
        prompt: `비서 2급 커뮤니케이션 문제입니다.\n\n문제: 이메일 작성법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '보고 기법을 설명하시오.',
        answer: '결론우선, 간결, 시각화, 구두/서면',
        prompt: `비서 2급 커뮤니케이션 문제입니다.\n\n문제: 보고 기법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '경청 기법을 설명하시오.',
        answer: '적극적 청취, 공감, 질문, 피드백',
        prompt: `비서 2급 커뮤니케이션 문제입니다.\n\n문제: 경청 기법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '호칭 예절을 설명하시오.',
        answer: '직함+성명, 존칭, 사내/외 구분',
        prompt: `비서 2급 커뮤니케이션 문제입니다.\n\n문제: 호칭 예절을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '갈등 해결을 설명하시오.',
        answer: '원인파악, 조정, 합의도출',
        prompt: `비서 2급 커뮤니케이션 문제입니다.\n\n문제: 갈등 해결을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
...
export default function CommunicationStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('communication-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('communication-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">커뮤니케이션</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">커뮤니케이션 학습</h1>
