...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: 'HTML5의 특징을 설명하시오.',
        answer: '시맨틱 태그, 멀티미디어, 로컬스토리지',
        prompt: `전자상거래관리사 1급 전자상거래 기술 문제입니다.\n\n문제: HTML5의 특징을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '반응형 웹을 설명하시오.',
        answer: 'CSS 미디어쿼리, 다양한 기기 대응',
        prompt: `전자상거래관리사 1급 전자상거래 기술 문제입니다.\n\n문제: 반응형 웹을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'API의 개념을 설명하시오.',
        answer: 'Application Programming Interface, 서비스 연동',
        prompt: `전자상거래관리사 1급 전자상거래 기술 문제입니다.\n\n문제: API의 개념을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: 'CDN을 설명하시오.',
        answer: '콘텐츠 전송 네트워크, 속도 향상',
        prompt: `전자상거래관리사 1급 전자상거래 기술 문제입니다.\n\n문제: CDN을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '클라우드 호스팅을 설명하시오.',
        answer: 'AWS, Azure, 확장성/가용성',
        prompt: `전자상거래관리사 1급 전자상거래 기술 문제입니다.\n\n문제: 클라우드 호스팅을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '전자결제 방식을 설명하시오.',
        answer: '신용카드, 계좌이체, 간편결제, 가상화폐',
        prompt: `전자상거래관리사 1급 전자상거래 기술 문제입니다.\n\n문제: 전자결제 방식을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'PG사의 역할을 설명하시오.',
        answer: '결제대행, 정산, 가맹점관리',
        prompt: `전자상거래관리사 1급 전자상거래 기술 문제입니다.\n\n문제: PG사의 역할을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'SSL 인증서를 설명하시오.',
        answer: '암호화 통신, HTTPS, 신뢰성',
        prompt: `전자상거래관리사 1급 전자상거래 기술 문제입니다.\n\n문제: SSL 인증서를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '개인정보보호를 설명하시오.',
        answer: '개인정보보호법, 동의/수집/이용/파기',
        prompt: `전자상거래관리사 1급 전자상거래 기술 문제입니다.\n\n문제: 개인정보보호를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: 'PCI-DSS를 설명하시오.',
        answer: '카드산업 데이터보안표준',
        prompt: `전자상거래관리사 1급 전자상거래 기술 문제입니다.\n\n문제: PCI-DSS를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
...
export default function EcommercetechStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('ecommerce-tech-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('ecommerce-tech-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">전자상거래 기술</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">전자상거래 기술 학습</h1>
