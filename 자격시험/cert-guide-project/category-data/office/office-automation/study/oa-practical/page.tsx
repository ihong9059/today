...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '스프레드시트 함수 활용을 설명하시오.',
        answer: 'VLOOKUP, SUMIF, 피벗테이블 등 고급함수',
        prompt: `사무자동화산업기사 실기 문제입니다.\n\n문제: 스프레드시트 함수 활용을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '데이터베이스 설계를 설명하시오.',
        answer: '테이블 생성, 관계 설정, 쿼리 작성',
        prompt: `사무자동화산업기사 실기 문제입니다.\n\n문제: 데이터베이스 설계를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '프레젠테이션 작성을 설명하시오.',
        answer: '슬라이드 구성, 애니메이션, 전환효과',
        prompt: `사무자동화산업기사 실기 문제입니다.\n\n문제: 프레젠테이션 작성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '매크로 작성을 설명하시오.',
        answer: 'VBA 코딩, 자동화 프로그램',
        prompt: `사무자동화산업기사 실기 문제입니다.\n\n문제: 매크로 작성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '보고서 작성을 설명하시오.',
        answer: '데이터 추출, 서식 지정, 인쇄 설정',
        prompt: `사무자동화산업기사 실기 문제입니다.\n\n문제: 보고서 작성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function OapracticalStudyPage() {
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('oa-practical-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">실기</span>
          </nav>
        </div>
      </header>
