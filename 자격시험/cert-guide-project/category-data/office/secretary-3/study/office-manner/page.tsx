...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '복장 규정을 설명하시오.',
        answer: '비즈니스 정장, TPO 고려',
        prompt: `비서 3급 사무 매너 문제입니다.\n\n문제: 복장 규정을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '인사 예절을 설명하시오.',
        answer: '목례, 악수, 적절한 인사말',
        prompt: `비서 3급 사무 매너 문제입니다.\n\n문제: 인사 예절을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '명함 예절을 설명하시오.',
        answer: '양손 교환, 테이블위 정리',
        prompt: `비서 3급 사무 매너 문제입니다.\n\n문제: 명함 예절을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '좌석 예절을 설명하시오.',
        answer: '상석 위치, 안내 순서',
        prompt: `비서 3급 사무 매너 문제입니다.\n\n문제: 좌석 예절을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '식사 예절을 설명하시오.',
        answer: '테이블매너, 건배예절',
        prompt: `비서 3급 사무 매너 문제입니다.\n\n문제: 식사 예절을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
...
export default function OfficemannerStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('office-manner-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('office-manner-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">사무 매너</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">사무 매너 학습</h1>
