...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '문서 분류체계를 설명하시오.',
        answer: '주제별, 기능별, 보존연한별',
        prompt: `비서 1급 사무관리 문제입니다.\n\n문제: 문서 분류체계를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '기안문 작성을 설명하시오.',
        answer: '제목, 본문, 붙임, 결재라인',
        prompt: `비서 1급 사무관리 문제입니다.\n\n문제: 기안문 작성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '비밀문서 관리를 설명하시오.',
        answer: '등급분류, 보관, 열람기록, 폐기',
        prompt: `비서 1급 사무관리 문제입니다.\n\n문제: 비밀문서 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '전자문서 관리를 설명하시오.',
        answer: 'EDMS, 결재시스템, 보존',
        prompt: `비서 1급 사무관리 문제입니다.\n\n문제: 전자문서 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '기록물 관리를 설명하시오.',
        answer: '생성, 분류, 보존, 폐기주기',
        prompt: `비서 1급 사무관리 문제입니다.\n\n문제: 기록물 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '정보수집 방법을 설명하시오.',
        answer: '인터넷, DB, 네트워킹, 보고서',
        prompt: `비서 1급 사무관리 문제입니다.\n\n문제: 정보수집 방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '정보분석 방법을 설명하시오.',
        answer: 'SWOT, 벤치마킹, 트렌드분석',
        prompt: `비서 1급 사무관리 문제입니다.\n\n문제: 정보분석 방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '개인정보 관리를 설명하시오.',
        answer: '수집동의, 안전조치, 파기',
        prompt: `비서 1급 사무관리 문제입니다.\n\n문제: 개인정보 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '보안관리를 설명하시오.',
        answer: '문서보안, PC보안, 출입통제',
        prompt: `비서 1급 사무관리 문제입니다.\n\n문제: 보안관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '위기관리를 설명하시오.',
        answer: '위기감지, 대응계획, 커뮤니케이션',
        prompt: `비서 1급 사무관리 문제입니다.\n\n문제: 위기관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function OfficemanagementStudyPage() {
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('office-management-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/office/secretary-1" className="text-gray-600 hover:text-violet-600">비서 1급</Link>
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">사무관리</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">사무관리 학습</h1>
                <p className="text-violet-100">비서 1급</p>
              </div>
            </div>
