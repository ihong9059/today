...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '워드프로세서의 정의를 설명하시오.',
        answer: '문서 작성/편집/저장/인쇄하는 소프트웨어',
        prompt: `워드프로세서 워드 필기 문제입니다.\n\n문제: 워드프로세서의 정의를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'WYSIWYG의 의미를 설명하시오.',
        answer: 'What You See Is What You Get, 화면과 출력 일치',
        prompt: `워드프로세서 워드 필기 문제입니다.\n\n문제: WYSIWYG의 의미를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '클립보드의 기능을 설명하시오.',
        answer: '잘라내기/복사 데이터 임시 저장 메모리 영역',
        prompt: `워드프로세서 워드 필기 문제입니다.\n\n문제: 클립보드의 기능을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '매크로의 기능을 설명하시오.',
        answer: '반복작업 자동화, 명령어 기록/재생',
        prompt: `워드프로세서 워드 필기 문제입니다.\n\n문제: 매크로의 기능을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: 'OLE의 개념을 설명하시오.',
        answer: 'Object Linking and Embedding, 개체 연결/삽입',
        prompt: `워드프로세서 워드 필기 문제입니다.\n\n문제: OLE의 개념을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '들여쓰기와 내어쓰기를 설명하시오.',
        answer: '들여쓰기: 첫줄 안쪽, 내어쓰기: 첫줄 바깥쪽',
        prompt: `워드프로세서 워드 필기 문제입니다.\n\n문제: 들여쓰기와 내어쓰기를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '머리글과 바닥글을 설명하시오.',
        answer: '페이지 상단/하단 반복 영역, 페이지번호 등',
        prompt: `워드프로세서 워드 필기 문제입니다.\n\n문제: 머리글과 바닥글을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '스타일의 기능을 설명하시오.',
        answer: '서식 모음 저장, 일관된 문서 형식 적용',
        prompt: `워드프로세서 워드 필기 문제입니다.\n\n문제: 스타일의 기능을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '찾기/바꾸기 기능을 설명하시오.',
        answer: '특정 문자열 검색, 다른 문자열로 치환',
        prompt: `워드프로세서 워드 필기 문제입니다.\n\n문제: 찾기/바꾸기 기능을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '단축키 Ctrl+S의 기능을 설명하시오.',
        answer: '저장(Save), 현재 문서 저장',
        prompt: `워드프로세서 워드 필기 문제입니다.\n\n문제: 단축키 Ctrl+S의 기능을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
];
...
export default function WordtheoryStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('word-theory-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('word-theory-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/office/word-processor" className="text-gray-600 hover:text-violet-600">워드프로세서</Link>
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">워드 필기</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">워드 필기 학습</h1>
                <p className="text-violet-100">워드프로세서</p>
              </div>
            </div>
