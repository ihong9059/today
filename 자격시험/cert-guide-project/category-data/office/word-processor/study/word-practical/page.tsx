...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '문서 여백 설정방법을 설명하시오.',
        answer: '페이지 설정→여백탭, 상하좌우 지정',
        prompt: `워드프로세서 실기 문제입니다.\n\n문제: 문서 여백 설정방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '표 작성 방법을 설명하시오.',
        answer: '삽입→표, 행/열 지정, 셀 병합/분할',
        prompt: `워드프로세서 실기 문제입니다.\n\n문제: 표 작성 방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '그림 삽입 방법을 설명하시오.',
        answer: '삽입→그림, 파일선택, 크기/위치 조절',
        prompt: `워드프로세서 실기 문제입니다.\n\n문제: 그림 삽입 방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '글머리 기호 설정을 설명하시오.',
        answer: '단락→글머리기호, 기호선택, 들여쓰기',
        prompt: `워드프로세서 실기 문제입니다.\n\n문제: 글머리 기호 설정을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '인쇄 설정 방법을 설명하시오.',
        answer: '파일→인쇄, 용지/방향/매수 설정',
        prompt: `워드프로세서 실기 문제입니다.\n\n문제: 인쇄 설정 방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function WordpracticalStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('word-practical-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('word-practical-progress', JSON.stringify(newCompleted));
  };
