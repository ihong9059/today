...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '브러시 관리를 설명하시오.',
        answer: '세척, 건조, 정기 교체',
        prompt: `미용사(메이크업) 위생관리 문제입니다.\n\n문제: 브러시 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '화장품 위생을 설명하시오.',
        answer: '스패츌라 사용, 직접접촉 피함',
        prompt: `미용사(메이크업) 위생관리 문제입니다.\n\n문제: 화장품 위생을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '일회용품 관리를 설명하시오.',
        answer: '마스카라봉, 립글로스팁, 스펀지',
        prompt: `미용사(메이크업) 위생관리 문제입니다.\n\n문제: 일회용품 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '피부트러블 대응을 설명하시오.',
        answer: '알레르기 확인, 청결유지',
        prompt: `미용사(메이크업) 위생관리 문제입니다.\n\n문제: 피부트러블 대응을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '도구 보관을 설명하시오.',
        answer: '건조한 곳, 파우치, 정리',
        prompt: `미용사(메이크업) 위생관리 문제입니다.\n\n문제: 도구 보관을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
...
export default function MakeuphygieneStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('makeup-hygiene-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('makeup-hygiene-progress', JSON.stringify(newCompleted));
  };
