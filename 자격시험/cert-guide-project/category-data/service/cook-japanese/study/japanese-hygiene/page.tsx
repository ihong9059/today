...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '생선 신선도 판별을 설명하시오.',
        answer: '눈 맑음, 아가미 선홍색, 탄력있는 살',
        prompt: `일식조리기능사 식품위생 문제입니다.\n\n문제: 생선 신선도 판별을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '회 취급시 주의사항을 설명하시오.',
        answer: '저온유지, 교차오염 방지, 빠른 제공',
        prompt: `일식조리기능사 식품위생 문제입니다.\n\n문제: 회 취급시 주의사항을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '쌀 보관법을 설명하시오.',
        answer: '밀폐용기, 서늘한 곳, 습기 방지',
        prompt: `일식조리기능사 식품위생 문제입니다.\n\n문제: 쌀 보관법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '도마와 칼 관리를 설명하시오.',
        answer: '생선/채소 분리, 세척소독, 건조보관',
        prompt: `일식조리기능사 식품위생 문제입니다.\n\n문제: 도마와 칼 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '식초의 살균효과를 설명하시오.',
        answer: 'pH 저하, 세균억제, 초밥에 활용',
        prompt: `일식조리기능사 식품위생 문제입니다.\n\n문제: 식초의 살균효과를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function JapanesehygieneStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('japanese-hygiene-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('japanese-hygiene-progress', JSON.stringify(newCompleted));
  };
