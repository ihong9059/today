...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '기름 관리법을 설명하시오.',
        answer: '적정온도 유지, 정기 교체, 찌꺼기 제거',
        prompt: `중식조리기능사 식품위생 문제입니다.\n\n문제: 기름 관리법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '식재료 전처리를 설명하시오.',
        answer: '세척, 소독, 물기제거, 적정크기 손질',
        prompt: `중식조리기능사 식품위생 문제입니다.\n\n문제: 식재료 전처리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '해산물 취급법을 설명하시오.',
        answer: '신선도 확인, 저온보관, 빠른 조리',
        prompt: `중식조리기능사 식품위생 문제입니다.\n\n문제: 해산물 취급법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '튀김 안전수칙을 설명하시오.',
        answer: '물기제거, 적정온도, 과다투입 금지',
        prompt: `중식조리기능사 식품위생 문제입니다.\n\n문제: 튀김 안전수칙을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '주방 화재예방을 설명하시오.',
        answer: '가스점검, 후드청소, 소화기 비치',
        prompt: `중식조리기능사 식품위생 문제입니다.\n\n문제: 주방 화재예방을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function ChinesehygieneStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('chinese-hygiene-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('chinese-hygiene-progress', JSON.stringify(newCompleted));
  };
