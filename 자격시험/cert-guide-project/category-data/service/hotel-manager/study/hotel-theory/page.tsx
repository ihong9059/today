...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '호텔의 분류를 설명하시오.',
        answer: '등급별(1-5성급), 형태별(리조트,비즈니스)',
        prompt: `호텔경영사 호텔경영론 문제입니다.\n\n문제: 호텔의 분류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '호텔 조직구조를 설명하시오.',
        answer: '객실부, 식음료부, 판촉부, 관리부',
        prompt: `호텔경영사 호텔경영론 문제입니다.\n\n문제: 호텔 조직구조를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '객실관리를 설명하시오.',
        answer: '예약, 체크인/아웃, 하우스키핑',
        prompt: `호텔경영사 호텔경영론 문제입니다.\n\n문제: 객실관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '식음료 관리를 설명하시오.',
        answer: '레스토랑, 바, 연회, 룸서비스',
        prompt: `호텔경영사 호텔경영론 문제입니다.\n\n문제: 식음료 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '수익관리를 설명하시오.',
        answer: '객실가격전략, 점유율, RevPAR',
        prompt: `호텔경영사 호텔경영론 문제입니다.\n\n문제: 수익관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '고객서비스를 설명하시오.',
        answer: '고객만족, 불만처리, 충성도관리',
        prompt: `호텔경영사 호텔경영론 문제입니다.\n\n문제: 고객서비스를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '프론트 업무를 설명하시오.',
        answer: '리셉션, 컨시어지, 벨서비스',
        prompt: `호텔경영사 호텔경영론 문제입니다.\n\n문제: 프론트 업무를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '하우스키핑을 설명하시오.',
        answer: '객실청소, 린넨관리, 미니바',
        prompt: `호텔경영사 호텔경영론 문제입니다.\n\n문제: 하우스키핑을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '식음료 서비스를 설명하시오.',
        answer: '테이블서비스, 와인서비스',
        prompt: `호텔경영사 호텔경영론 문제입니다.\n\n문제: 식음료 서비스를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '연회 서비스를 설명하시오.',
        answer: '행사기획, 세팅, 진행, 정산',
        prompt: `호텔경영사 호텔경영론 문제입니다.\n\n문제: 연회 서비스를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function HoteltheoryStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('hotel-theory-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('hotel-theory-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-rose-600 font-medium">호텔경영론</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">호텔경영론 학습</h1>
                <p className="text-rose-100">호텔경영사</p>
              </div>
            </div>
