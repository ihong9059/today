...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '이스트 보관법을 설명하시오.',
        answer: '생이스트(냉장), 드라이이스트(밀봉)',
        prompt: `제빵기능사 식품위생 문제입니다.\n\n문제: 이스트 보관법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '밀가루 보관법을 설명하시오.',
        answer: '서늘/건조, 밀폐, 해충방지',
        prompt: `제빵기능사 식품위생 문제입니다.\n\n문제: 밀가루 보관법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '믹싱기 관리를 설명하시오.',
        answer: '사용 후 세척, 정기점검, 안전수칙',
        prompt: `제빵기능사 식품위생 문제입니다.\n\n문제: 믹싱기 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '발효실 관리를 설명하시오.',
        answer: '온습도 유지, 청결, 정기 소독',
        prompt: `제빵기능사 식품위생 문제입니다.\n\n문제: 발효실 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '오븐 관리를 설명하시오.',
        answer: '예열, 청소, 온도 확인, 안전점검',
        prompt: `제빵기능사 식품위생 문제입니다.\n\n문제: 오븐 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function BakeryhygieneStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('bakery-hygiene-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('bakery-hygiene-progress', JSON.stringify(newCompleted));
  };
