...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '피부의 구조를 설명하시오.',
        answer: '표피, 진피, 피하조직의 3층 구조',
        prompt: `미용사(피부) 피부 이론 문제입니다.\n\n문제: 피부의 구조를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '피부 유형을 설명하시오.',
        answer: '건성, 지성, 중성, 복합성, 민감성',
        prompt: `미용사(피부) 피부 이론 문제입니다.\n\n문제: 피부 유형을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '피부의 기능을 설명하시오.',
        answer: '보호, 체온조절, 분비, 감각, 흡수',
        prompt: `미용사(피부) 피부 이론 문제입니다.\n\n문제: 피부의 기능을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '피부 노화 원인을 설명하시오.',
        answer: '자연노화, 광노화, 활성산소',
        prompt: `미용사(피부) 피부 이론 문제입니다.\n\n문제: 피부 노화 원인을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '피부 트러블 원인을 설명하시오.',
        answer: '호르몬, 스트레스, 세균, 환경',
        prompt: `미용사(피부) 피부 이론 문제입니다.\n\n문제: 피부 트러블 원인을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '클렌징 방법을 설명하시오.',
        answer: '1차(유성)→2차(수성) 더블클렌징',
        prompt: `미용사(피부) 피부 이론 문제입니다.\n\n문제: 클렌징 방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '딥클렌징을 설명하시오.',
        answer: '각질제거, 모공관리, 스크럽/필링',
        prompt: `미용사(피부) 피부 이론 문제입니다.\n\n문제: 딥클렌징을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '마사지 효과를 설명하시오.',
        answer: '혈액순환, 림프순환, 이완, 영양공급',
        prompt: `미용사(피부) 피부 이론 문제입니다.\n\n문제: 마사지 효과를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '팩의 종류를 설명하시오.',
        answer: '모델링팩, 시트팩, 워시오프팩',
        prompt: `미용사(피부) 피부 이론 문제입니다.\n\n문제: 팩의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '기기관리를 설명하시오.',
        answer: '갈바닉, 고주파, 초음파, LED',
        prompt: `미용사(피부) 피부 이론 문제입니다.\n\n문제: 기기관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function SkintheoryStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('skin-theory-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('skin-theory-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/service/beauty-skin" className="text-gray-600 hover:text-rose-600">미용사(피부)</Link>
            <span className="text-gray-300">›</span>
            <span className="text-rose-600 font-medium">피부 이론</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">피부 이론 학습</h1>
                <p className="text-rose-100">미용사(피부)</p>
              </div>
            </div>
