...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '예약시스템을 설명하시오.',
        answer: 'PMS, 채널매니저, 오버부킹 관리',
        prompt: `호텔관리사 호텔실무 문제입니다.\n\n문제: 예약시스템을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '체크인 절차를 설명하시오.',
        answer: '신분확인→룸배정→키발급→안내',
        prompt: `호텔관리사 호텔실무 문제입니다.\n\n문제: 체크인 절차를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '체크아웃 절차를 설명하시오.',
        answer: '미니바체크→정산→영수증→배웅',
        prompt: `호텔관리사 호텔실무 문제입니다.\n\n문제: 체크아웃 절차를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '객실등급을 설명하시오.',
        answer: '스탠다드, 디럭스, 스위트, 펜트하우스',
        prompt: `호텔관리사 호텔실무 문제입니다.\n\n문제: 객실등급을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '컴플레인 처리를 설명하시오.',
        answer: '경청→사과→해결→보상→피드백',
        prompt: `호텔관리사 호텔실무 문제입니다.\n\n문제: 컴플레인 처리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '에너지 관리를 설명하시오.',
        answer: '전기/가스/수도 절감, 친환경',
        prompt: `호텔관리사 호텔실무 문제입니다.\n\n문제: 에너지 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '안전관리를 설명하시오.',
        answer: '소방, 보안, 비상대피, CCTV',
        prompt: `호텔관리사 호텔실무 문제입니다.\n\n문제: 안전관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '청결관리를 설명하시오.',
        answer: '청소표준, 점검체크, 해충방제',
        prompt: `호텔관리사 호텔실무 문제입니다.\n\n문제: 청결관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '비품관리를 설명하시오.',
        answer: '재고관리, 구매, 폐기, 자산관리',
        prompt: `호텔관리사 호텔실무 문제입니다.\n\n문제: 비품관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '유지보수를 설명하시오.',
        answer: '정기점검, 수리, 리모델링 계획',
        prompt: `호텔관리사 호텔실무 문제입니다.\n\n문제: 유지보수를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function HotelopsStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('hotel-ops-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('hotel-ops-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-rose-600 font-medium">호텔실무</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">호텔실무 학습</h1>
