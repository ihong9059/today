...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '도구 소독을 설명하시오.',
        answer: '알코올, 자외선, 고압증기 소독',
        prompt: `미용사(네일) 위생관리 문제입니다.\n\n문제: 도구 소독을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '작업환경 관리를 설명하시오.',
        answer: '환기, 분진관리, 조명',
        prompt: `미용사(네일) 위생관리 문제입니다.\n\n문제: 작업환경 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '화학물질 안전을 설명하시오.',
        answer: '아세톤, 프라이머 취급주의',
        prompt: `미용사(네일) 위생관리 문제입니다.\n\n문제: 화학물질 안전을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '피부 보호를 설명하시오.',
        answer: '장갑착용, 피부접촉 최소화',
        prompt: `미용사(네일) 위생관리 문제입니다.\n\n문제: 피부 보호를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '고객 위생을 설명하시오.',
        answer: '손소독, 일회용품, 도구소독',
        prompt: `미용사(네일) 위생관리 문제입니다.\n\n문제: 고객 위생을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function NailhygieneStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('nail-hygiene-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('nail-hygiene-progress', JSON.stringify(newCompleted));
  };
