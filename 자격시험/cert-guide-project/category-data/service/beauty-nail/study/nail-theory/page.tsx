...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '손톱의 구조를 설명하시오.',
        answer: '네일플레이트, 큐티클, 네일베드, 매트릭스',
        prompt: `미용사(네일) 네일 이론 문제입니다.\n\n문제: 손톱의 구조를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '손톱의 성장속도를 설명하시오.',
        answer: '하루 0.1mm, 완전성장 4-6개월',
        prompt: `미용사(네일) 네일 이론 문제입니다.\n\n문제: 손톱의 성장속도를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '손톱 건강 판단을 설명하시오.',
        answer: '색상, 모양, 두께, 표면상태',
        prompt: `미용사(네일) 네일 이론 문제입니다.\n\n문제: 손톱 건강 판단을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '네일 도구를 설명하시오.',
        answer: '파일, 푸셔, 니퍼, 폴리셔',
        prompt: `미용사(네일) 네일 이론 문제입니다.\n\n문제: 네일 도구를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '손톱 질환을 설명하시오.',
        answer: '무좀, 조갑박리증, 조주위염',
        prompt: `미용사(네일) 네일 이론 문제입니다.\n\n문제: 손톱 질환을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '매니큐어 시술을 설명하시오.',
        answer: '모양잡기→큐티클정리→베이스→폴리시→탑',
        prompt: `미용사(네일) 네일 이론 문제입니다.\n\n문제: 매니큐어 시술을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '젤네일 시술을 설명하시오.',
        answer: '샌딩→베이스젤→컬러→탑젤→경화',
        prompt: `미용사(네일) 네일 이론 문제입니다.\n\n문제: 젤네일 시술을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '아크릴 네일을 설명하시오.',
        answer: '모노머+파우더, 연장/보강용',
        prompt: `미용사(네일) 네일 이론 문제입니다.\n\n문제: 아크릴 네일을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '네일 아트 기법을 설명하시오.',
        answer: '마블, 프렌치, 그라데이션, 스톤',
        prompt: `미용사(네일) 네일 이론 문제입니다.\n\n문제: 네일 아트 기법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '네일 제거법을 설명하시오.',
        answer: '아세톤+호일랩, 소킹오프',
        prompt: `미용사(네일) 네일 이론 문제입니다.\n\n문제: 네일 제거법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
...
export default function NailtheoryStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('nail-theory-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('nail-theory-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/service/beauty-nail" className="text-gray-600 hover:text-rose-600">미용사(네일)</Link>
            <span className="text-gray-300">›</span>
            <span className="text-rose-600 font-medium">네일 이론</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">네일 이론 학습</h1>
                <p className="text-rose-100">미용사(네일)</p>
              </div>
            </div>
