...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '장소 섭외를 설명하시오.',
        answer: '장소조건, 비용, 접근성, 편의시설',
        prompt: `컨벤션기획사2급 실무지식 문제입니다.\n\n문제: 장소 섭외를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '케이터링을 설명하시오.',
        answer: '식음료 공급, 메뉴구성, 서비스',
        prompt: `컨벤션기획사2급 실무지식 문제입니다.\n\n문제: 케이터링을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '인쇄물 관리를 설명하시오.',
        answer: '초대장, 프로그램북, 네임택',
        prompt: `컨벤션기획사2급 실무지식 문제입니다.\n\n문제: 인쇄물 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '숙박 관리를 설명하시오.',
        answer: '호텔블록, 룸배정, 입출금',
        prompt: `컨벤션기획사2급 실무지식 문제입니다.\n\n문제: 숙박 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '운송 관리를 설명하시오.',
        answer: '공항픽업, 셔틀버스, 의전차량',
        prompt: `컨벤션기획사2급 실무지식 문제입니다.\n\n문제: 운송 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function ConventionpracticeStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('convention-practice-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('convention-practice-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/service/convention-planner-2" className="text-gray-600 hover:text-rose-600">컨벤션기획사2급</Link>
            <span className="text-gray-300">›</span>
            <span className="text-rose-600 font-medium">실무지식</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">실무지식 학습</h1>
                <p className="text-rose-100">컨벤션기획사2급</p>
              </div>
            </div>
