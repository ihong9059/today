...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '복어의 독소를 설명하시오.',
        answer: '테트로도톡신, 신경마비, 해독제 없음',
        prompt: `복어조리기능사 복어 조리이론 문제입니다.\n\n문제: 복어의 독소를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '독성 부위를 설명하시오.',
        answer: '난소, 간, 피부, 내장(종류별 상이)',
        prompt: `복어조리기능사 복어 조리이론 문제입니다.\n\n문제: 독성 부위를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '복어의 종류를 설명하시오.',
        answer: '자주복, 까치복, 흰점복, 검복 등',
        prompt: `복어조리기능사 복어 조리이론 문제입니다.\n\n문제: 복어의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '법적 규정을 설명하시오.',
        answer: '복어조리기능사 자격 필수, 독성부위 폐기',
        prompt: `복어조리기능사 복어 조리이론 문제입니다.\n\n문제: 법적 규정을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '계절별 특성을 설명하시오.',
        answer: '겨울철 최고, 산란기(봄) 독성 강함',
        prompt: `복어조리기능사 복어 조리이론 문제입니다.\n\n문제: 계절별 특성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '복어 손질 순서를 설명하시오.',
        answer: '독성부위 제거→세척→포뜨기',
        prompt: `복어조리기능사 복어 조리이론 문제입니다.\n\n문제: 복어 손질 순서를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '회 뜨는 법을 설명하시오.',
        answer: '얇게 저미기, 접시에 국화꽃 모양',
        prompt: `복어조리기능사 복어 조리이론 문제입니다.\n\n문제: 회 뜨는 법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '복어탕 조리법을 설명하시오.',
        answer: '뼈→살 순서, 맑은 육수, 미나리',
        prompt: `복어조리기능사 복어 조리이론 문제입니다.\n\n문제: 복어탕 조리법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '복어튀김을 설명하시오.',
        answer: '밑간→튀김옷→170°C 튀기기',
        prompt: `복어조리기능사 복어 조리이론 문제입니다.\n\n문제: 복어튀김을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '복어 지느러미술을 설명하시오.',
        answer: '지느러미 구워서 청주에 넣기',
        prompt: `복어조리기능사 복어 조리이론 문제입니다.\n\n문제: 복어 지느러미술을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function PuffertheoryStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('puffer-theory-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('puffer-theory-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/service/cook-puffer" className="text-gray-600 hover:text-rose-600">복어조리기능사</Link>
            <span className="text-gray-300">›</span>
            <span className="text-rose-600 font-medium">복어 조리이론</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">복어 조리이론 학습</h1>
                <p className="text-rose-100">복어조리기능사</p>
              </div>
            </div>
