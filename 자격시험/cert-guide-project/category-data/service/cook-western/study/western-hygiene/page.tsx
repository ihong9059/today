    ...
    questions: [
      {
        ...
        answer: '청결한 복장, 손씻기, 건강관리, 장신구 제거',
        prompt: `양식조리기능사 식품위생 문제입니다.\n\n문제: 개인위생 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '식재료 보관법을 설명하시오.',
        answer: 'FIFO 원칙, 적정온도, 교차오염 방지',
        prompt: `양식조리기능사 식품위생 문제입니다.\n\n문제: 식재료 보관법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '해동방법을 설명하시오.',
        answer: '냉장해동, 유수해동, 전자레인지 해동',
        prompt: `양식조리기능사 식품위생 문제입니다.\n\n문제: 해동방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '주방청소 방법을 설명하시오.',
        answer: '작업 전후 청소, 소독, 해충방지',
        prompt: `양식조리기능사 식품위생 문제입니다.\n\n문제: 주방청소 방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '온도관리의 중요성을 설명하시오.',
        answer: '위험온도대(5-60°C) 피하기, 신속 냉각',
        prompt: `양식조리기능사 식품위생 문제입니다.\n\n문제: 온도관리의 중요성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function WesternhygieneStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('western-hygiene-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('western-hygiene-progress', JSON.stringify(newCompleted));
  };
