...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '한국의 건국신화를 설명하시오.',
        answer: '단군신화, 고조선 건국(BC 2333)',
        prompt: `관광통역안내사 국사 문제입니다.\n\n문제: 한국의 건국신화를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '삼국시대를 설명하시오.',
        answer: '고구려, 백제, 신라의 정립과 발전',
        prompt: `관광통역안내사 국사 문제입니다.\n\n문제: 삼국시대를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '고려의 특징을 설명하시오.',
        answer: '불교국가, 과거제, 금속활자',
        prompt: `관광통역안내사 국사 문제입니다.\n\n문제: 고려의 특징을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '조선의 특징을 설명하시오.',
        answer: '유교국가, 한글창제, 양반제도',
        prompt: `관광통역안내사 국사 문제입니다.\n\n문제: 조선의 특징을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '근현대사를 설명하시오.',
        answer: '일제강점기, 광복, 분단, 발전',
        prompt: `관광통역안내사 국사 문제입니다.\n\n문제: 근현대사를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function KoreanhistoryStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('korean-history-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('korean-history-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-rose-600 font-medium">국사</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">국사 학습</h1>
