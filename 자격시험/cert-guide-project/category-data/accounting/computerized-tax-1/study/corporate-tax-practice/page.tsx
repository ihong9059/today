    ...
    questions: [
      {
        id: 1,
        question: '익금산입이란?',
        answer: '회계상 수익이 아니지만 세법상 익금으로 가산하는 조정',
        prompt: `전산세무 1급 시험 문제입니다.
...
상세히 설명해주세요.`
      },
      {
        id: 2,
        question: '손금불산입이란?',
        answer: '회계상 비용이지만 세법상 손금으로 인정하지 않아 가산하는 조정',
        prompt: `전산세무 1급 시험 문제입니다.
...
상세히 설명해주세요.`
      ...
      {
        id: 3,
        question: '접대비 한도초과액 처리는?',
        answer: '손금불산입하여 과세소득에 가산',
        prompt: `전산세무 1급 시험 문제입니다.
...
상세히 설명해주세요.`
      ...
      {
        id: 4,
        question: '감가상각비 한도초과액 처리는?',
        answer: '세법상 상각한도 초과분은 손금불산입',
        prompt: `전산세무 1급 시험 문제입니다.
...
상세히 설명해주세요.`
      },
      {
        id: 5,
        question: '대손충당금 한도는?',
        answer: '채권잔액의 1%(금융업 2%) 또는 대손실적률 중 큰 금액',
        prompt: `전산세무 1급 시험 문제입니다.
...
export default function CorporatetaxpracticeStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('computerized-tax-1-corporate-tax-practice-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('computerized-tax-1-corporate-tax-practice-progress', JSON.stringify(updated));
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-emerald-600 font-medium">법인세 실무</span>
          </nav>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-800 mb-2">법인세 실무</h1>
