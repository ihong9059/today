...
export default function IndustrialSafetyExamPage() {
      ...
      <section className="bg-gradient-to-r from-red-500 to-orange-500 text-white py-8">
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold">산업안전기사 시험정보</h1>
              <p className="text-red-100">Engineer Industrial Safety</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="font-medium text-gray-800">과목당 20문항 (총 120문항)</p>
                </div>
                <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-800">기계위험방지기술</p>
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-3">
                    <span className="text-2xl">⚡</span>
                    <div>
                      <p className="font-medium text-gray-800">전기위험방지기술</p>
                      <p className="text-sm text-gray-500">감전재해, 전기화재, 정전기</p>
                    </div>
                  </div>
                  <span className="text-sm text-gray-500">20문항</span>
                </div>
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-3">
                    <span className="text-2xl">🧪</span>
                    <div>
                      <p className="font-medium text-gray-800">화학설비위험방지기술</p>
                      <p className="text-sm text-gray-500">위험물, 폭발방지, 화학설비 안전</p>
                    </div>
                  </div>
                  <span className="text-sm text-gray-500">20문항</span>
                </div>
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-3">
                    <span className="text-2xl">🏗️</span>
                    <div>
                      <p className="font-medium text-gray-800">건설안전기술</p>
                      <p className="text-sm text-gray-500">건설재해, 거푸집, 비계, 굴착</p>
                    </div>
                  </div>
                  <span className="text-sm text-gray-500">20문항</span>
                </div>
              ...
              <div className="space-y-4">
                <div className="p-4 border rounded-lg">
                  ...
                  <ul className="text-sm text-gray-600 space-y-1">
                    <li>• 위험성평가 (KRAS, 체크리스트법 등)</li>
                    <li>• 재해조사 및 분석 (4M 분석, 재해발생형태)</li>
                    <li>• 안전점검표 작성 및 활용</li>
                    <li>• 기계·전기·화학·건설 안전관리 실무</li>
                    <li>• 산업안전보건법령 적용</li>
                  </ul>
                </div>
                <div className="p-4 border rounded-lg">
                  ...
                  <ul className="text-sm text-gray-600 space-y-1">
                    <li>• 재해사례 분석 및 대책 수립</li>
                    <li>• 안전보건표지 의미 및 적용</li>
                    <li>• 보호구 선정 및 관리</li>
                    <li>• 작업허가서 작성</li>
                    <li>• MSDS 해석 및 활용</li>
                  </ul>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-600">위험성평가 기법(KRAS, 체크리스트 등)을 철저히 익히세요.</p>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-600">재해사례 분석 시 4M(Man, Machine, Media, Management) 분류를 정확히 하세요.</p>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-600">산업안전보건법 핵심 조항과 시행규칙을 암기하세요.</p>
                </div>
                <div className="flex items-start gap-3">
