...
export default function HazardousEngineerPage() {
  const subjects = [
    { id: 'general-chemistry', name: '일반화학', icon: '⚗️', color: 'from-blue-500 to-indigo-500', questions: 25 },
    { id: 'fire-prevention', name: '화재예방과 소화방법', icon: '🔥', color: 'from-red-500 to-pink-500', questions: 25 },
    { id: 'hazardous-properties', name: '위험물의 성질과 취급', icon: '⚠️', color: 'from-orange-500 to-red-500', questions: 25 },
    { id: 'hazardous-law', name: '위험물안전관리법', icon: '📋', color: 'from-yellow-500 to-orange-500', questions: 25 },
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-red-600 font-medium">위험물기사</span>
          </nav>
        </div>
      </header>
      ...
      <section className="bg-gradient-to-r from-red-500 to-orange-500 text-white py-12">
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold">위험물기사</h1>
              <p className="text-orange-100 mt-1">Engineer Hazardous Materials</p>
      ...
      <section className="max-w-6xl mx-auto px-4 py-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white rounded-xl p-4 shadow-sm text-center">
            <p className="text-2xl font-bold text-red-600">높음</p>
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                위험물기사는 위험물의 저장·취급·운반에 관한 전문적인 지식과 기술을 보유한
                기술자격입니다. 석유화학, 정유, 위험물저장소 등에서 안전관리 업무를 수행하며,
                위험물안전관리자로 선임될 수 있습니다. 위험물산업기사의 상위 자격으로,
                보다 전문적인 위험물 관리 업무를 담당합니다.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="grid md:grid-cols-2 gap-3">
                {subjects.slice(0, 4).map((subject) => (
                  <Link
                    key={subject.id}
                    href={`/category/safety/hazardous-engineer/study/${subject.id}`}
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="p-3 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600 mt-1">필답형 - 위험물 안전관리, 소화설비, 법규 적용 등</p>
                </div>
                <Link
                  href="/category/safety/hazardous-engineer/study/practical"
                  className="flex items-center gap-3 p-3 rounded-lg border hover:border-red-300 hover:bg-red-50 transition"
                >
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-3 text-sm">
                <div className="p-3 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-gray-600">필기: 3월 / 실기: 5-6월</p>
                </div>
                <div className="p-3 bg-gray-50 rounded-lg">
                  <p className="font-medium text-gray-800">2026년 2회</p>
                  <p className="text-gray-600">필기: 5월 / 실기: 7-8월</p>
                </div>
                <div className="p-3 bg-gray-50 rounded-lg">
                  <p className="font-medium text-gray-800">2026년 3회</p>
                  <p className="text-gray-600">필기: 9월 / 실기: 10-11월</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                <p>• 관련학과 4년제 졸업(예정)자</p>
                <p>• 관련학과 전문대 졸업 + 실무 1년</p>
                <p>• 위험물산업기사 + 실무 1년</p>
                <p>• 동일직무분야 산업기사 + 실무 2년</p>
                <p>• 기능사 + 실무 3년</p>
                <p>• 실무경력 4년 이상</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">위험물 성질·취급</span>
                  <span className="font-medium text-red-600">60점 이상</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">위험물안전관리법</span>
                  <span className="font-medium text-red-600">60점 이상</span>
                </div>
                <hr className="my-2" />
                <div className="flex justify-between items-center">
            ...
            <Link
              href="/category/safety/hazardous-engineer/exam"
