...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '상담이론 통합의 유형을 설명하시오.',
        answer: '기술적 절충, 이론적 통합, 동화적 통합, 공통요인',
        prompt: `상담심리사 1급 상담이론 심화 문제입니다.\n\n문제: 상담이론 통합의 유형을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '상담에서의 치료적 동맹을 설명하시오.',
        answer: '목표합의, 과제합의, 정서적 유대',
        prompt: `상담심리사 1급 상담이론 심화 문제입니다.\n\n문제: 상담에서의 치료적 동맹을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '상담 효과 연구를 설명하시오.',
        answer: '효과성 연구, 효과 크기, 근거기반 실무',
        prompt: `상담심리사 1급 상담이론 심화 문제입니다.\n\n문제: 상담 효과 연구를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '다문화상담 역량을 설명하시오.',
        answer: '인식, 지식, 기술 3차원',
        prompt: `상담심리사 1급 상담이론 심화 문제입니다.\n\n문제: 다문화상담 역량을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '상담자 발달단계를 설명하시오.',
        answer: '초보-중급-숙련-전문가 단계별 특성',
        prompt: `상담심리사 1급 상담이론 심화 문제입니다.\n\n문제: 상담자 발달단계를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
...
export default function AdvancedcounselingStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('advanced-counseling-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('advanced-counseling-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">상담이론 심화</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">상담이론 심화 학습</h1>
