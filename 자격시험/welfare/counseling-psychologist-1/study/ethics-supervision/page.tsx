...
const topics = [
  {
    id: 'counseling-ethics',
    name: '상담윤리',
    color: 'from-violet-500 to-purple-600',
    questions: [
      {
        id: 1,
        question: '상담윤리의 원칙을 설명하시오.',
        answer: '자율성, 선행, 무해성, 정의, 충실성',
        prompt: `상담심리사 1급 윤리 및 수퍼비전 문제입니다.\n\n문제: 상담윤리의 원칙을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '비밀보장의 예외를 설명하시오.',
        answer: '자타해 위험, 법적요구, 아동학대, 수퍼비전',
        prompt: `상담심리사 1급 윤리 및 수퍼비전 문제입니다.\n\n문제: 비밀보장의 예외를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '다중관계의 윤리적 문제를 설명하시오.',
        answer: '역할혼란, 객관성 상실, 착취위험',
        prompt: `상담심리사 1급 윤리 및 수퍼비전 문제입니다.\n\n문제: 다중관계의 윤리적 문제를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '윤리적 의사결정 모델을 설명하시오.',
        answer: '문제확인-관련규정-자문-대안탐색-결정-평가',
        prompt: `상담심리사 1급 윤리 및 수퍼비전 문제입니다.\n\n문제: 윤리적 의사결정 모델을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '상담자 소진과 자기돌봄을 설명하시오.',
        answer: '소진 3요소, 예방전략, 자기돌봄 계획',
        prompt: `상담심리사 1급 윤리 및 수퍼비전 문제입니다.\n\n문제: 상담자 소진과 자기돌봄을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
];

export default function EthicssupervisionStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('ethics-supervision-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('ethics-supervision-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/welfare/counseling-psychologist-1" className="text-gray-600 hover:text-violet-600">상담심리사 1급</Link>
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">윤리 및 수퍼비전</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">윤리 및 수퍼비전 학습</h1>
                <p className="text-violet-100">상담심리사 1급</p>
              </div>
            </div>
