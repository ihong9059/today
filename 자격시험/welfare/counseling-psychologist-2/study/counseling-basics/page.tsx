...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '정신분석의 발달을 설명하시오.',
        answer: '프로이트→자아심리학→대상관계→자기심리학',
        prompt: `상담심리사 2급 상담심리학 기초 문제입니다.\n\n문제: 정신분석의 발달을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '행동주의 상담의 기법을 설명하시오.',
        answer: '체계적 둔감화, 혐오치료, 토큰경제, 모델링',
        prompt: `상담심리사 2급 상담심리학 기초 문제입니다.\n\n문제: 행동주의 상담의 기법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '실존주의 상담의 주제를 설명하시오.',
        answer: '죽음, 자유, 고립, 무의미',
        prompt: `상담심리사 2급 상담심리학 기초 문제입니다.\n\n문제: 실존주의 상담의 주제를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '현실치료(선택이론)를 설명하시오.',
        answer: '5가지 욕구, 전행동, WDEP',
        prompt: `상담심리사 2급 상담심리학 기초 문제입니다.\n\n문제: 현실치료(선택이론)를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '동기강화상담의 원리를 설명하시오.',
        answer: '공감표현, 불일치 유발, 저항수용, 자기효능감',
        prompt: `상담심리사 2급 상담심리학 기초 문제입니다.\n\n문제: 동기강화상담의 원리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
];

export default function CounselingbasicsStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('counseling-basics-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('counseling-basics-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/welfare/counseling-psychologist-2" className="text-gray-600 hover:text-violet-600">상담심리사 2급</Link>
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">상담심리학 기초</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">상담심리학 기초 학습</h1>
                <p className="text-violet-100">상담심리사 2급</p>
              </div>
            </div>
