...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '적극적 경청의 요소를 설명하시오.',
        answer: '언어적/비언어적 반응, 반영, 요약, 명료화',
        prompt: `상담심리사 2급 상담실습 문제입니다.\n\n문제: 적극적 경청의 요소를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '감정반영 기술을 설명하시오.',
        answer: '감정명명, 감정강도, 감정맥락 반영',
        prompt: `상담심리사 2급 상담실습 문제입니다.\n\n문제: 감정반영 기술을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '상담목표 설정 방법을 설명하시오.',
        answer: '구체적, 측정가능, 현실적, 내담자 합의',
        prompt: `상담심리사 2급 상담실습 문제입니다.\n\n문제: 상담목표 설정 방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '상담기록 작성을 설명하시오.',
        answer: 'SOAP형식, 축어록, 사례개념화',
        prompt: `상담심리사 2급 상담실습 문제입니다.\n\n문제: 상담기록 작성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '상담 종결 다루기를 설명하시오.',
        answer: '종결시점, 성과정리, 추수상담 계획',
        prompt: `상담심리사 2급 상담실습 문제입니다.\n\n문제: 상담 종결 다루기를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
...
export default function CounselingpracticeStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('counseling-practice-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('counseling-practice-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">상담실습</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">상담실습 학습</h1>
