...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '위기의 유형을 설명하시오.',
        answer: '발달적, 상황적, 실존적, 환경적 위기',
        prompt: `청소년상담사 1급 위기개입론 문제입니다.\n\n문제: 위기의 유형을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '위기개입 6단계 모델을 설명하시오.',
        answer: '문제정의-안전확보-지지제공-대안탐색-계획수립-추수',
        prompt: `청소년상담사 1급 위기개입론 문제입니다.\n\n문제: 위기개입 6단계 모델을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '자살위험성 평가를 설명하시오.',
        answer: '자살사고, 계획, 의도, 수단, 보호요인 평가',
        prompt: `청소년상담사 1급 위기개입론 문제입니다.\n\n문제: 자살위험성 평가를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '외상 후 스트레스 상담을 설명하시오.',
        answer: '안정화, 외상기억처리, 재통합, 회복',
        prompt: `청소년상담사 1급 위기개입론 문제입니다.\n\n문제: 외상 후 스트레스 상담을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '학교폭력 피해자 상담을 설명하시오.',
        answer: '심리적 안정, 신고절차, 후유증 치료, 관계회복',
        prompt: `청소년상담사 1급 위기개입론 문제입니다.\n\n문제: 학교폭력 피해자 상담을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
];

export default function CrisisinterventionStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('crisis-intervention-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('crisis-intervention-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">위기개입론</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">위기개입론 학습</h1>
