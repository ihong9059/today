...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '면접의 기본원리를 설명하시오.',
        answer: '경청, 공감, 수용, 비심판적 태도',
        prompt: `사회복지사 2급 사회복지실천기술론 문제입니다.\n\n문제: 면접의 기본원리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '관계형성 기술을 설명하시오.',
        answer: '라포형성, 신뢰구축, 감정반영, 명료화',
        prompt: `사회복지사 2급 사회복지실천기술론 문제입니다.\n\n문제: 관계형성 기술을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '사정도구(제노그램, 생태도)를 설명하시오.',
        answer: '제노그램: 가족관계도, 생태도: 환경체계 시각화',
        prompt: `사회복지사 2급 사회복지실천기술론 문제입니다.\n\n문제: 사정도구(제노그램, 생태도)를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '기록의 유형을 설명하시오.',
        answer: '과정기록, 요약기록, 문제중심기록(SOAP)',
        prompt: `사회복지사 2급 사회복지실천기술론 문제입니다.\n\n문제: 기록의 유형을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '집단사회복지실천의 단계를 설명하시오.',
        answer: '계획-초기-중간(작업)-종결단계',
        prompt: `사회복지사 2급 사회복지실천기술론 문제입니다.\n\n문제: 집단사회복지실천의 단계를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
];
...
export default function PracticeskillsStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('practice-skills-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('practice-skills-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">사회복지실천기술론</span>
          </nav>
        </div>
      </header>
