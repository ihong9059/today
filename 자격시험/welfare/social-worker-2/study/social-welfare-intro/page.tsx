...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '사회복지의 개념과 목적을 설명하시오.',
        answer: '인간다운 삶 보장, 사회문제 해결, 삶의 질 향상',
        prompt: `사회복지사 2급 사회복지개론 문제입니다.\n\n문제: 사회복지의 개념과 목적을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '사회복지의 동기(이타주의, 상호부조 등)를 설명하시오.',
        answer: '이타주의, 상호부조, 종교적 동기, 정치경제적 동기',
        prompt: `사회복지사 2급 사회복지개론 문제입니다.\n\n문제: 사회복지의 동기(이타주의, 상호부조 등)를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '잔여적 복지와 제도적 복지의 차이를 설명하시오.',
        answer: '잔여적: 가족/시장 실패시 개입, 제도적: 보편적 권리',
        prompt: `사회복지사 2급 사회복지개론 문제입니다.\n\n문제: 잔여적 복지와 제도적 복지의 차이를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '사회복지사의 역할을 설명하시오.',
        answer: '조력자, 중개자, 옹호자, 교육자, 행정가',
        prompt: `사회복지사 2급 사회복지개론 문제입니다.\n\n문제: 사회복지사의 역할을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '사회복지실천 현장의 종류를 설명하시오.',
        answer: '1차현장(복지관), 2차현장(병원/학교), 행정기관',
        prompt: `사회복지사 2급 사회복지개론 문제입니다.\n\n문제: 사회복지실천 현장의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
];
...
export default function SocialwelfareintroStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('social-welfare-intro-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('social-welfare-intro-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">사회복지개론</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">사회복지개론 학습</h1>
