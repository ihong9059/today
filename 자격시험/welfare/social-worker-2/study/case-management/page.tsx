...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '사례관리의 정의와 목적을 설명하시오.',
        answer: '복합욕구 대상자에게 포괄적 서비스 제공, 서비스 조정/연계',
        prompt: `사회복지사 2급 사례관리론 문제입니다.\n\n문제: 사례관리의 정의와 목적을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '사례관리의 과정을 설명하시오.',
        answer: '접수-사정-계획-개입-점검-평가-종결',
        prompt: `사회복지사 2급 사례관리론 문제입니다.\n\n문제: 사례관리의 과정을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '사례관리자의 역할을 설명하시오.',
        answer: '조정자, 옹호자, 중개자, 상담자, 교육자',
        prompt: `사회복지사 2급 사례관리론 문제입니다.\n\n문제: 사례관리자의 역할을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '서비스 연계의 원칙을 설명하시오.',
        answer: '포괄성, 연속성, 적절성, 접근성, 책임성',
        prompt: `사회복지사 2급 사례관리론 문제입니다.\n\n문제: 서비스 연계의 원칙을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '통합사례관리의 특성을 설명하시오.',
        answer: '공공-민간 협력, 지역사회 자원 연계, 대상자 중심',
        prompt: `사회복지사 2급 사례관리론 문제입니다.\n\n문제: 통합사례관리의 특성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
];

export default function CasemanagementStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('case-management-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('case-management-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/welfare/social-worker-2" className="text-gray-600 hover:text-violet-600">사회복지사 2급</Link>
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">사례관리론</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">사례관리론 학습</h1>
                <p className="text-violet-100">사회복지사 2급</p>
              </div>
            </div>
