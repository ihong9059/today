...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '영유아 발달의 원리를 설명하시오.',
        answer: '일정순서, 개인차, 상호작용, 연속성, 결정적 시기',
        prompt: `보육교사 1급 아동발달론 문제입니다.\n\n문제: 영유아 발달의 원리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '애착발달 이론(볼비)을 설명하시오.',
        answer: '애착형성 4단계, 내적작동모델, 안정/불안정 애착',
        prompt: `보육교사 1급 아동발달론 문제입니다.\n\n문제: 애착발달 이론(볼비)을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '언어발달 단계를 설명하시오.',
        answer: '옹알이-한단어기-두단어기-다단어기-문법발달',
        prompt: `보육교사 1급 아동발달론 문제입니다.\n\n문제: 언어발달 단계를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '사회성 발달 과정을 설명하시오.',
        answer: '자아인식-자기조절-또래관계-사회적 기술 발달',
        prompt: `보육교사 1급 아동발달론 문제입니다.\n\n문제: 사회성 발달 과정을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '영유아기 인지발달 특성을 설명하시오.',
        answer: '감각운동기-전조작기, 대상영속성, 자기중심성',
        prompt: `보육교사 1급 아동발달론 문제입니다.\n\n문제: 영유아기 인지발달 특성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
];
...
export default function ChilddevelopmentStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('child-development-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('child-development-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">아동발달론</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">아동발달론 학습</h1>
