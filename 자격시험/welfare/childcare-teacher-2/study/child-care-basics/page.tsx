...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '보육의 개념과 필요성을 설명하시오.',
        answer: '영유아 보호와 교육, 부모 양육지원, 아동 발달 촉진',
        prompt: `보육교사 2급 영유아보육 기초 문제입니다.\n\n문제: 보육의 개념과 필요성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '보육의 역사적 발전을 설명하시오.',
        answer: '탁아소-어린이집, 영유아보육법 제정, 무상보육',
        prompt: `보육교사 2급 영유아보육 기초 문제입니다.\n\n문제: 보육의 역사적 발전을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '보육시설의 유형을 설명하시오.',
        answer: '국공립, 사회복지법인, 민간, 가정, 직장어린이집',
        prompt: `보육교사 2급 영유아보육 기초 문제입니다.\n\n문제: 보육시설의 유형을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '보육교사의 역할과 자질을 설명하시오.',
        answer: '양육자, 교육자, 상담자, 전문성, 인성',
        prompt: `보육교사 2급 영유아보육 기초 문제입니다.\n\n문제: 보육교사의 역할과 자질을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '영유아 권리와 보육 철학을 설명하시오.',
        answer: 'UN아동권리협약, 생존권, 보호권, 발달권, 참여권',
        prompt: `보육교사 2급 영유아보육 기초 문제입니다.\n\n문제: 영유아 권리와 보육 철학을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
];

export default function ChildcarebasicsStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('child-care-basics-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('child-care-basics-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/welfare/childcare-teacher-2" className="text-gray-600 hover:text-violet-600">보육교사 2급</Link>
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">영유아보육 기초</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">영유아보육 기초 학습</h1>
                <p className="text-violet-100">보육교사 2급</p>
              </div>
            </div>
