...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '노동시장의 수요와 공급을 설명하시오.',
        answer: '기업의 노동수요, 개인의 노동공급, 균형임금',
        prompt: `직업상담사 1급 노동시장론 문제입니다.\n\n문제: 노동시장의 수요와 공급을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '실업의 유형을 설명하시오.',
        answer: '마찰적, 구조적, 경기적, 계절적 실업',
        prompt: `직업상담사 1급 노동시장론 문제입니다.\n\n문제: 실업의 유형을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '임금결정이론을 설명하시오.',
        answer: '한계생산력이론, 효율임금이론, 내부노동시장',
        prompt: `직업상담사 1급 노동시장론 문제입니다.\n\n문제: 임금결정이론을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '노동시장 이중구조론을 설명하시오.',
        answer: '1차(안정)/2차(불안정) 노동시장, 분절이론',
        prompt: `직업상담사 1급 노동시장론 문제입니다.\n\n문제: 노동시장 이중구조론을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '비정규직의 유형과 특성을 설명하시오.',
        answer: '기간제, 파견, 용역, 시간제, 처우격차',
        prompt: `직업상담사 1급 노동시장론 문제입니다.\n\n문제: 비정규직의 유형과 특성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
];

export default function LabormarketanalysisStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('labor-market-analysis-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('labor-market-analysis-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/welfare/career-counselor-1" className="text-gray-600 hover:text-violet-600">직업상담사 1급</Link>
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">노동시장론</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">노동시장론 학습</h1>
                <p className="text-violet-100">직업상담사 1급</p>
              </div>
            </div>
