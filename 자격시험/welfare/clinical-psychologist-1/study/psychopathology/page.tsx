...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '조현병의 증상을 설명하시오.',
        answer: '양성(망상,환각)/음성(무욕,정서둔마)증상',
        prompt: `임상심리사 1급 정신병리학 문제입니다.\n\n문제: 조현병의 증상을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '우울장애의 진단기준을 설명하시오.',
        answer: '우울기분, 흥미상실, 수면/식욕변화, 무가치감',
        prompt: `임상심리사 1급 정신병리학 문제입니다.\n\n문제: 우울장애의 진단기준을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '불안장애의 유형을 설명하시오.',
        answer: '범불안, 공황, 특정공포, 사회불안, 분리불안',
        prompt: `임상심리사 1급 정신병리학 문제입니다.\n\n문제: 불안장애의 유형을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '성격장애의 군집을 설명하시오.',
        answer: 'A군(기이), B군(극적), C군(불안) 성격장애',
        prompt: `임상심리사 1급 정신병리학 문제입니다.\n\n문제: 성격장애의 군집을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '외상 및 스트레스 장애를 설명하시오.',
        answer: 'PTSD, 급성스트레스장애, 적응장애',
        prompt: `임상심리사 1급 정신병리학 문제입니다.\n\n문제: 외상 및 스트레스 장애를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
];

export default function PsychopathologyStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('psychopathology-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('psychopathology-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">정신병리학</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">정신병리학 학습</h1>
