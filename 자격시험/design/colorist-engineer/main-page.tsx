  ...
  const subjects = [
    {
      ...
      topics: [
            ...
            },
            {
              id: 'color-system',
              name: '색체계',
              href: '/category/design/colorist-engineer/study/color-system'
            },
            {
              id: 'color-harmony',
              name: '색채 조화',
              href: '/category/design/colorist-engineer/study/color-harmony'
            },
      ]
    },
    {
      ...
      topics: [
            {
              id: 'color-psychology',
              name: '색채 심리',
              href: '/category/design/colorist-engineer/study/color-psychology'
            },
            {
              id: 'color-planning',
              name: '색채 기획',
              href: '/category/design/colorist-engineer/study/color-planning'
            },
      ]
    },
  ];
