...
export default function StudyPage() {
  ...
  const questions = [
      {
        id: 1,
        question: '디자인의 4대 조형요소는?',
        answer: '점, 선, 면, 입체. 점은 위치, 선은 방향, 면은 공간, 입체는 부피 표현',
        prompt: '컴퓨터그래픽스운용기능사 시험 관련 질문입니다: 디자인의 4대 조형요소는? 자세히 설명해주세요.'
      },
      {
        id: 2,
        question: '통일성(Unity)의 원리란?',
        answer: '디자인 요소들이 조화롭게 하나로 보이는 것. 반복, 유사성, 연속으로 달성',
        prompt: '컴퓨터그래픽스운용기능사 시험 관련 질문입니다: 통일성(Unity)의 원리란? 자세히 설명해주세요.'
      },
      {
        id: 3,
        question: '황금비율의 값은?',
        answer: '1:1.618. 자연과 예술에서 아름다운 비례로 인정되는 황금분할',
        prompt: '컴퓨터그래픽스운용기능사 시험 관련 질문입니다: 황금비율의 값은? 자세히 설명해주세요.'
      },
      {
        id: 4,
        question: '게슈탈트 이론이란?',
        answer: '전체는 부분의 합보다 크다. 근접성, 유사성, 연속성, 폐쇄성 법칙',
        prompt: '컴퓨터그래픽스운용기능사 시험 관련 질문입니다: 게슈탈트 이론이란? 자세히 설명해주세요.'
      },
      {
        id: 5,
        question: '대비(Contrast)의 종류는?',
        answer: '형태대비, 색채대비, 질감대비, 크기대비. 시각적 긴장감과 강조 효과',
        prompt: '컴퓨터그래픽스운용기능사 시험 관련 질문입니다: 대비(Contrast)의 종류는? 자세히 설명해주세요.'
      },
  ];

  useEffect(() => {
    const saved = localStorage.getItem('computer-graphics-design-basics-progress');
    if (saved) {
  ...
  const toggleComplete = (id: number) => {
    ...
    localStorage.setItem('computer-graphics-design-basics-progress', JSON.stringify(updated));
  };
