...
export default function StudyPage() {
  ...
  const questions = [
      {
        id: 1,
        question: 'UI와 UX 차이는?',
        answer: 'UI(인터페이스 디자인), UX(사용자 경험 전체). UX가 더 넓은 개념',
        prompt: '웹디자인기능사 시험 관련 질문입니다: UI와 UX 차이는? 자세히 설명해주세요.'
      },
      {
        id: 2,
        question: '와이어프레임이란?',
        answer: '웹페이지 레이아웃 기본 골격. 저해상도 설계도, 기능 배치 중심',
        prompt: '웹디자인기능사 시험 관련 질문입니다: 와이어프레임이란? 자세히 설명해주세요.'
      },
      {
        id: 3,
        question: '사용성 5가지 요소는?',
        answer: '학습성, 효율성, 기억성, 오류방지, 만족도. 닐슨의 사용성 원칙',
        prompt: '웹디자인기능사 시험 관련 질문입니다: 사용성 5가지 요소는? 자세히 설명해주세요.'
      },
      {
        id: 4,
        question: '반응형 웹 디자인이란?',
        answer: '화면 크기에 맞게 레이아웃 자동 조절. 미디어 쿼리, 유동적 그리드 활용',
        prompt: '웹디자인기능사 시험 관련 질문입니다: 반응형 웹 디자인이란? 자세히 설명해주세요.'
      },
      {
        id: 5,
        question: '웹 접근성이란?',
        answer: '모든 사용자가 웹 이용 가능. WCAG 가이드라인, 대체 텍스트, 키보드 접근',
        prompt: '웹디자인기능사 시험 관련 질문입니다: 웹 접근성이란? 자세히 설명해주세요.'
      },
  ];

  useEffect(() => {
    const saved = localStorage.getItem('web-design-ui-ux-progress');
    if (saved) {
  ...
  const toggleComplete = (id: number) => {
    ...
    localStorage.setItem('web-design-ui-ux-progress', JSON.stringify(updated));
  };
