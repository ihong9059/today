...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '객체지향의 4대 특성을 설명하시오.',
        answer: '캡슐화, 상속, 다형성, 추상화',
        prompt: `정보처리기사 프로그래밍 언어 문제입니다.\n\n문제: 객체지향의 4대 특성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'SOLID 원칙을 설명하시오.',
        answer: '단일책임, 개방폐쇄, 리스코프, 인터페이스분리, 의존역전',
        prompt: `정보처리기사 프로그래밍 언어 문제입니다.\n\n문제: SOLID 원칙을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 3,
        question: '디자인 패턴의 종류를 설명하시오.',
        answer: '생성(Singleton), 구조(Adapter), 행위(Observer)',
        prompt: `정보처리기사 프로그래밍 언어 문제입니다.\n\n문제: 디자인 패턴의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 4,
        question: '오버로딩과 오버라이딩을 비교하시오.',
        answer: '오버로딩: 같은이름 다른매개변수, 오버라이딩: 상속후 재정의',
        prompt: `정보처리기사 프로그래밍 언어 문제입니다.\n\n문제: 오버로딩과 오버라이딩을 비교하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 5,
        question: '추상클래스와 인터페이스를 비교하시오.',
        answer: '추상클래스: 단일상속/구현포함, 인터페이스: 다중상속/명세만',
        prompt: `정보처리기사 프로그래밍 언어 문제입니다.\n\n문제: 추상클래스와 인터페이스를 비교하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
];
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-blue-600 font-medium">프로그래밍 언어</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">프로그래밍 언어 학습</h1>
