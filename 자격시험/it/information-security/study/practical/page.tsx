...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '취약점 진단 절차를 설명하시오.',
        answer: '정보수집→취약점분석→침투테스트→보고서',
        prompt: `정보보안기사 실기 문제입니다.\n\n문제: 취약점 진단 절차를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 2,
        question: '포렌식 분석 절차를 설명하시오.',
        answer: '수집→보존→분석→보고',
        prompt: `정보보안기사 실기 문제입니다.\n\n문제: 포렌식 분석 절차를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 3,
        question: '보안 정책 구성요소를 설명하시오.',
        answer: '목표, 범위, 역할, 절차, 제재',
        prompt: `정보보안기사 실기 문제입니다.\n\n문제: 보안 정책 구성요소를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 4,
        question: 'ISMS 인증 요건을 설명하시오.',
        answer: '관리체계, 보호대책, 기술적 통제',
        prompt: `정보보안기사 실기 문제입니다.\n\n문제: ISMS 인증 요건을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 5,
        question: '위험분석 방법론을 설명하시오.',
        answer: '자산식별→위협분석→취약점분석→위험평가',
        prompt: `정보보안기사 실기 문제입니다.\n\n문제: 위험분석 방법론을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
