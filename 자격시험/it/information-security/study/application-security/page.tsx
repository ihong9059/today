...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: 'OWASP Top 10을 설명하시오.',
        answer: '인젝션, 인증, XSS, CSRF 등',
        prompt: `정보보안기사 어플리케이션 보안 문제입니다.\n\n문제: OWASP Top 10을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'SQL Injection 대응책을 설명하시오.',
        answer: 'PreparedStatement, 입력값 검증',
        prompt: `정보보안기사 어플리케이션 보안 문제입니다.\n\n문제: SQL Injection 대응책을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'XSS 공격 유형을 설명하시오.',
        answer: 'Stored, Reflected, DOM-based',
        prompt: `정보보안기사 어플리케이션 보안 문제입니다.\n\n문제: XSS 공격 유형을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 4,
        question: 'CSRF 방어 기법을 설명하시오.',
        answer: 'CSRF 토큰, SameSite 쿠키, Referer 검증',
        prompt: `정보보안기사 어플리케이션 보안 문제입니다.\n\n문제: CSRF 방어 기법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 5,
        question: '세션 하이재킹 대응책을 설명하시오.',
        answer: '세션 타임아웃, 세션 재생성, HTTPS',
        prompt: `정보보안기사 어플리케이션 보안 문제입니다.\n\n문제: 세션 하이재킹 대응책을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
];

export default function ApplicationsecurityStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('application-security-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('application-security-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/it/information-security" className="text-gray-600 hover:text-blue-600">정보보안기사</Link>
            <span className="text-gray-300">›</span>
            <span className="text-blue-600 font-medium">어플리케이션 보안</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">어플리케이션 보안 학습</h1>
                <p className="text-blue-100">정보보안기사</p>
              </div>
            </div>
