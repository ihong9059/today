...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '접근통제 모델을 설명하시오.',
        answer: 'DAC, MAC, RBAC',
        prompt: `정보보안기사 시스템 보안 문제입니다.\n\n문제: 접근통제 모델을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 2,
        question: '버퍼 오버플로우 대응책을 설명하시오.',
        answer: '스택가드, ASLR, DEP',
        prompt: `정보보안기사 시스템 보안 문제입니다.\n\n문제: 버퍼 오버플로우 대응책을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 3,
        question: '리눅스 파일 권한을 설명하시오.',
        answer: 'r(4)w(2)x(1), chmod 755',
        prompt: `정보보안기사 시스템 보안 문제입니다.\n\n문제: 리눅스 파일 권한을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 4,
        question: '프로세스 격리 기법을 설명하시오.',
        answer: '샌드박스, 컨테이너, 가상화',
        prompt: `정보보안기사 시스템 보안 문제입니다.\n\n문제: 프로세스 격리 기법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 5,
        question: '시스템 로그 분석 항목을 설명하시오.',
        answer: 'syslog, auth.log, secure',
        prompt: `정보보안기사 시스템 보안 문제입니다.\n\n문제: 시스템 로그 분석 항목을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
];

export default function SystemsecurityStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('system-security-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('system-security-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-blue-600 font-medium">시스템 보안</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">시스템 보안 학습</h1>
