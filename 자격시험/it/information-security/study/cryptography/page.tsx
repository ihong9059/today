...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '대칭키와 비대칭키 암호화를 비교하시오.',
        answer: '대칭키: 같은키, 비대칭키: 공개키/개인키',
        prompt: `정보보안기사 암호학 문제입니다.\n\n문제: 대칭키와 비대칭키 암호화를 비교하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 2,
        question: '해시함수의 특성을 설명하시오.',
        answer: '일방향성, 충돌저항성, 역상저항성',
        prompt: `정보보안기사 암호학 문제입니다.\n\n문제: 해시함수의 특성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'AES와 RSA를 비교하시오.',
        answer: 'AES: 대칭키 128/192/256비트, RSA: 비대칭키',
        prompt: `정보보안기사 암호학 문제입니다.\n\n문제: AES와 RSA를 비교하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 4,
        question: '전자서명의 원리를 설명하시오.',
        answer: '개인키로 서명, 공개키로 검증',
        prompt: `정보보안기사 암호학 문제입니다.\n\n문제: 전자서명의 원리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 5,
        question: 'PKI 구성요소를 설명하시오.',
        answer: 'CA, RA, CRL, 인증서',
        prompt: `정보보안기사 암호학 문제입니다.\n\n문제: PKI 구성요소를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
...
export default function CryptographyStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('cryptography-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('cryptography-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-blue-600 font-medium">암호학</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">암호학 학습</h1>
