...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '기술사로서의 역할을 설명하시오.',
        answer: '기술자문, 감리, 설계, 품질관리',
        prompt: `컴퓨터시스템응용기술사 면접 문제입니다.\n\n문제: 기술사로서의 역할을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 2,
        question: '디지털 전환(DX)을 설명하시오.',
        answer: '디지털 기술로 비즈니스 혁신',
        prompt: `컴퓨터시스템응용기술사 면접 문제입니다.\n\n문제: 디지털 전환(DX)을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 3,
        question: '제로 트러스트 보안을 설명하시오.',
        answer: 'Never Trust, Always Verify',
        prompt: `컴퓨터시스템응용기술사 면접 문제입니다.\n\n문제: 제로 트러스트 보안을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 4,
        question: 'DevSecOps를 설명하시오.',
        answer: '개발+보안+운영 통합, 보안 내재화',
        prompt: `컴퓨터시스템응용기술사 면접 문제입니다.\n\n문제: DevSecOps를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 5,
        question: '그린 IT를 설명하시오.',
        answer: '에너지 효율, 탄소배출 감소, 친환경 데이터센터',
        prompt: `컴퓨터시스템응용기술사 면접 문제입니다.\n\n문제: 그린 IT를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-blue-600 font-medium">면접</span>
          </nav>
        </div>
      </header>
