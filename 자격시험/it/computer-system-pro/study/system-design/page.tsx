...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '엔터프라이즈 아키텍처를 설명하시오.',
        answer: '비즈니스, 데이터, 기술, 어플리케이션 아키텍처',
        prompt: `컴퓨터시스템응용기술사 시스템 설계 문제입니다.\n\n문제: 엔터프라이즈 아키텍처를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 2,
        question: '마이크로서비스 아키텍처를 설명하시오.',
        answer: '독립적 서비스 단위로 분리, API 통신',
        prompt: `컴퓨터시스템응용기술사 시스템 설계 문제입니다.\n\n문제: 마이크로서비스 아키텍처를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'SOA와 MSA를 비교하시오.',
        answer: 'SOA: ESB중심, MSA: API게이트웨이중심',
        prompt: `컴퓨터시스템응용기술사 시스템 설계 문제입니다.\n\n문제: SOA와 MSA를 비교하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 4,
        question: '이벤트 드리븐 아키텍처를 설명하시오.',
        answer: '이벤트 발행/구독, 비동기 처리, 느슨한 결합',
        prompt: `컴퓨터시스템응용기술사 시스템 설계 문제입니다.\n\n문제: 이벤트 드리븐 아키텍처를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 5,
        question: 'CQRS 패턴을 설명하시오.',
        answer: '명령(Write)과 조회(Read) 분리',
        prompt: `컴퓨터시스템응용기술사 시스템 설계 문제입니다.\n\n문제: CQRS 패턴을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
...
export default function SystemdesignStudyPage() {
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('system-design-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/it/computer-system-pro" className="text-gray-600 hover:text-blue-600">컴퓨터시스템응용기술사</Link>
            <span className="text-gray-300">›</span>
            <span className="text-blue-600 font-medium">시스템 설계</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">시스템 설계 학습</h1>
                <p className="text-blue-100">컴퓨터시스템응용기술사</p>
              </div>
            </div>
