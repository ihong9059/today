...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: 'CPU의 구성요소를 설명하시오.',
        answer: 'ALU, 제어장치, 레지스터',
        prompt: `전자계산기조직응용기사 전자계산기 구조 문제입니다.\n\n문제: CPU의 구성요소를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 2,
        question: '파이프라이닝을 설명하시오.',
        answer: '명령어 중첩 실행으로 성능 향상',
        prompt: `전자계산기조직응용기사 전자계산기 구조 문제입니다.\n\n문제: 파이프라이닝을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 3,
        question: '명령어 사이클을 설명하시오.',
        answer: '인출→해독→실행→저장',
        prompt: `전자계산기조직응용기사 전자계산기 구조 문제입니다.\n\n문제: 명령어 사이클을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 4,
        question: 'RISC와 CISC를 비교하시오.',
        answer: 'RISC: 단순명령어/빠른실행, CISC: 복잡명령어/많은기능',
        prompt: `전자계산기조직응용기사 전자계산기 구조 문제입니다.\n\n문제: RISC와 CISC를 비교하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 5,
        question: '인터럽트의 종류를 설명하시오.',
        answer: '하드웨어, 소프트웨어, 외부, 내부 인터럽트',
        prompt: `전자계산기조직응용기사 전자계산기 구조 문제입니다.\n\n문제: 인터럽트의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '캐시 메모리의 사상 방식을 설명하시오.',
        answer: '직접, 연관, 집합연관 사상',
        prompt: `전자계산기조직응용기사 전자계산기 구조 문제입니다.\n\n문제: 캐시 메모리의 사상 방식을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 2,
        question: '가상 메모리를 설명하시오.',
        answer: '보조기억장치를 주기억장치처럼 사용',
        prompt: `전자계산기조직응용기사 전자계산기 구조 문제입니다.\n\n문제: 가상 메모리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 3,
        question: '메모리 계층 구조를 설명하시오.',
        answer: '레지스터→캐시→RAM→SSD→HDD',
        prompt: `전자계산기조직응용기사 전자계산기 구조 문제입니다.\n\n문제: 메모리 계층 구조를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 4,
        question: '페이지 교체 알고리즘을 설명하시오.',
        answer: 'FIFO, LRU, LFU, Optimal',
        prompt: `전자계산기조직응용기사 전자계산기 구조 문제입니다.\n\n문제: 페이지 교체 알고리즘을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 5,
        question: 'TLB의 역할을 설명하시오.',
        answer: '가상주소→물리주소 변환 캐시',
        prompt: `전자계산기조직응용기사 전자계산기 구조 문제입니다.\n\n문제: TLB의 역할을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
...
export default function ComputerarchitectureStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('computer-architecture-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('computer-architecture-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/it/computer-organization" className="text-gray-600 hover:text-blue-600">전자계산기조직응용기사</Link>
            <span className="text-gray-300">›</span>
            <span className="text-blue-600 font-medium">전자계산기 구조</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">전자계산기 구조 학습</h1>
                <p className="text-blue-100">전자계산기조직응용기사</p>
              </div>
            </div>
