...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '데이터 전송 방식을 설명하시오.',
        answer: '단방향, 반이중, 전이중',
        prompt: `전자계산기조직응용기사 데이터통신 문제입니다.\n\n문제: 데이터 전송 방식을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 2,
        question: '다중화 기법을 설명하시오.',
        answer: 'FDM, TDM, CDM, WDM',
        prompt: `전자계산기조직응용기사 데이터통신 문제입니다.\n\n문제: 다중화 기법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 3,
        question: '변조 방식을 설명하시오.',
        answer: 'AM, FM, PM, PCM',
        prompt: `전자계산기조직응용기사 데이터통신 문제입니다.\n\n문제: 변조 방식을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 4,
        question: '오류 검출/정정 방식을 설명하시오.',
        answer: '패리티, CRC, 해밍코드',
        prompt: `전자계산기조직응용기사 데이터통신 문제입니다.\n\n문제: 오류 검출/정정 방식을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 5,
        question: '흐름제어 방식을 설명하시오.',
        answer: 'Stop-and-Wait, 슬라이딩 윈도우',
        prompt: `전자계산기조직응용기사 데이터통신 문제입니다.\n\n문제: 흐름제어 방식을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
...
export default function DatacommunicationStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('data-communication-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('data-communication-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-blue-600 font-medium">데이터통신</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">데이터통신 학습</h1>
