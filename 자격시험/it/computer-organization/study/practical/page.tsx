...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '시스템 성능 분석 지표를 설명하시오.',
        answer: '처리량, 응답시간, 가용성, 신뢰성',
        prompt: `전자계산기조직응용기사 실기 문제입니다.\n\n문제: 시스템 성능 분석 지표를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 2,
        question: '병렬처리 기법을 설명하시오.',
        answer: 'SISD, SIMD, MISD, MIMD',
        prompt: `전자계산기조직응용기사 실기 문제입니다.\n\n문제: 병렬처리 기법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 3,
        question: '입출력 방식을 설명하시오.',
        answer: '프로그램 I/O, 인터럽트, DMA',
        prompt: `전자계산기조직응용기사 실기 문제입니다.\n\n문제: 입출력 방식을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 4,
        question: 'RAID 레벨을 설명하시오.',
        answer: 'RAID 0(스트라이핑), 1(미러링), 5(패리티)',
        prompt: `전자계산기조직응용기사 실기 문제입니다.\n\n문제: RAID 레벨을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 5,
        question: '클러스터링을 설명하시오.',
        answer: 'Active-Active, Active-Standby 구성',
        prompt: `전자계산기조직응용기사 실기 문제입니다.\n\n문제: 클러스터링을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
