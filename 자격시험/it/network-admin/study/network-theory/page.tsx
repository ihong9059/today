...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: 'OSI 7계층을 설명하시오.',
        answer: '물리-데이터링크-네트워크-전송-세션-표현-응용',
        prompt: `네트워크관리사 네트워크 이론 문제입니다.\n\n문제: OSI 7계층을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'TCP/IP 4계층을 설명하시오.',
        answer: '네트워크액세스-인터넷-전송-응용',
        prompt: `네트워크관리사 네트워크 이론 문제입니다.\n\n문제: TCP/IP 4계층을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 3,
        question: '각 계층별 PDU를 설명하시오.',
        answer: '비트-프레임-패킷-세그먼트-데이터',
        prompt: `네트워크관리사 네트워크 이론 문제입니다.\n\n문제: 각 계층별 PDU를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 4,
        question: '캡슐화와 역캡슐화를 설명하시오.',
        answer: '헤더추가(캡슐화), 헤더제거(역캡슐화)',
        prompt: `네트워크관리사 네트워크 이론 문제입니다.\n\n문제: 캡슐화와 역캡슐화를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 5,
        question: '계층별 프로토콜을 설명하시오.',
        answer: 'L2:이더넷, L3:IP, L4:TCP/UDP, L7:HTTP',
        prompt: `네트워크관리사 네트워크 이론 문제입니다.\n\n문제: 계층별 프로토콜을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
...
export default function NetworktheoryStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('network-theory-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('network-theory-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-blue-600 font-medium">네트워크 이론</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">네트워크 이론 학습</h1>
