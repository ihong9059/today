...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: 'TCP와 UDP의 차이를 설명하시오.',
        answer: 'TCP: 연결지향/신뢰성, UDP: 비연결/빠른속도',
        prompt: `네트워크관리사 프로토콜 문제입니다.\n\n문제: TCP와 UDP의 차이를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'IP 주소 클래스를 설명하시오.',
        answer: 'A(0-127), B(128-191), C(192-223)',
        prompt: `네트워크관리사 프로토콜 문제입니다.\n\n문제: IP 주소 클래스를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 3,
        question: '서브넷팅을 설명하시오.',
        answer: '네트워크 분할, 서브넷마스크 활용',
        prompt: `네트워크관리사 프로토콜 문제입니다.\n\n문제: 서브넷팅을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 4,
        question: 'ARP와 RARP를 설명하시오.',
        answer: 'ARP: IP→MAC, RARP: MAC→IP',
        prompt: `네트워크관리사 프로토콜 문제입니다.\n\n문제: ARP와 RARP를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 5,
        question: 'DHCP 동작 원리를 설명하시오.',
        answer: 'Discover→Offer→Request→Ack',
        prompt: `네트워크관리사 프로토콜 문제입니다.\n\n문제: DHCP 동작 원리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
];
...
export default function ProtocolStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('protocol-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('protocol-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-blue-600 font-medium">프로토콜</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">프로토콜 학습</h1>
