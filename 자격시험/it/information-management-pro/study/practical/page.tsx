...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: 'IT 거버넌스를 설명하시오.',
        answer: 'IT 자원과 정보의 효율적 활용을 위한 의사결정 체계',
        prompt: `정보관리기술사 면접 문제입니다.\n\n문제: IT 거버넌스를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 2,
        question: '디지털 플랫폼 정부를 설명하시오.',
        answer: '데이터 기반 행정, 원스톱 서비스',
        prompt: `정보관리기술사 면접 문제입니다.\n\n문제: 디지털 플랫폼 정부를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 3,
        question: '데이터 3법을 설명하시오.',
        answer: '개인정보보호법, 정보통신망법, 신용정보법 개정',
        prompt: `정보관리기술사 면접 문제입니다.\n\n문제: 데이터 3법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 4,
        question: '공공 클라우드 도입을 설명하시오.',
        answer: '클라우드 우선정책, 보안인증, 비용절감',
        prompt: `정보관리기술사 면접 문제입니다.\n\n문제: 공공 클라우드 도입을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 5,
        question: 'AI 윤리를 설명하시오.',
        answer: '투명성, 공정성, 책임성, 안전성',
        prompt: `정보관리기술사 면접 문제입니다.\n\n문제: AI 윤리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
