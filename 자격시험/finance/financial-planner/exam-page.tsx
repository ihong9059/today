...
export default function FinancialplannerExamPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <h1 className="text-2xl font-bold text-gray-800 mb-6">자산관리사(FP) 시험정보</h1>
        ...
        <div className="text-center">
          <Link
            href="/category/finance/financial-planner"
