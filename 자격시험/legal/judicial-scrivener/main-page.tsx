...
const subjects = [
      { id: 'civil-law', name: '민법' }
];

export default function JudicialscrivenerMainPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-violet-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-800">법무사</h1>
          <p className="text-gray-600">법률사무 전문가</p>
        </div>

        <div className="grid gap-4 mb-8">
          <Link href="/category/legal/judicial-scrivener/exam">
        ...
        <div className="grid gap-3">
          {subjects.map((subject) => (
            <Link key={subject.id} href={`/category/legal/judicial-scrivener/study/${subject.id}`}>
