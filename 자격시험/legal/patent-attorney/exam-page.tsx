  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-violet-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <h1 className="text-2xl font-bold text-gray-800 mb-6">📋 변리사 시험 정보</h1>

        <div className="space-y-4">
          <div className="bg-white rounded-xl p-5 shadow">
            <h3 className="font-bold text-gray-800 mb-2">📅 시험 일정</h3>
            <p className="text-gray-600">1차 2월, 2차 7월</p>
          </div>

          <div className="bg-white rounded-xl p-5 shadow">
            <h3 className="font-bold text-gray-800 mb-2">📝 시험 과목</h3>
            <p className="text-gray-600">산업재산권법, 민법개론, 자연과학개론, 특허법, 상표법 등</p>
          </div>

          <div className="bg-white rounded-xl p-5 shadow">
            <h3 className="font-bold text-gray-800 mb-2">📊 합격률</h3>
            <p className="text-gray-600">약 15~20%</p>
          </div>

          <div className="bg-white rounded-xl p-5 shadow">
            <h3 className="font-bold text-gray-800 mb-2">📄 시험 형식</h3>
            <p className="text-gray-600">1차 객관식, 2차 주관식 논술</p>
          </div>
