...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: 'HTML의 구조를 설명하시오.',
        answer: '<html>, <head>, <body> 기본태그',
        prompt: `전자상거래관리사 2급 웹 기초 문제입니다.\n\n문제: HTML의 구조를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'CSS의 역할을 설명하시오.',
        answer: '스타일 정의, 디자인 표현',
        prompt: `전자상거래관리사 2급 웹 기초 문제입니다.\n\n문제: CSS의 역할을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '링크 태그를 설명하시오.',
        answer: '<a href=\'URL\'>텍스트</a>',
        prompt: `전자상거래관리사 2급 웹 기초 문제입니다.\n\n문제: 링크 태그를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '이미지 태그를 설명하시오.',
        answer: '<img src=\'경로\' alt=\'설명\'>',
        prompt: `전자상거래관리사 2급 웹 기초 문제입니다.\n\n문제: 이미지 태그를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '테이블 태그를 설명하시오.',
    ...
    questions: [
      {
        id: 1,
        question: 'UI/UX의 개념을 설명하시오.',
        answer: 'UI: 사용자인터페이스, UX: 사용자경험',
        prompt: `전자상거래관리사 2급 웹 기초 문제입니다.\n\n문제: UI/UX의 개념을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'GNB의 역할을 설명하시오.',
        answer: 'Global Navigation Bar, 주요메뉴',
        prompt: `전자상거래관리사 2급 웹 기초 문제입니다.\n\n문제: GNB의 역할을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '배너 디자인을 설명하시오.',
        answer: '광고영역, 이벤트/상품 홍보',
        prompt: `전자상거래관리사 2급 웹 기초 문제입니다.\n\n문제: 배너 디자인을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '상품 상세페이지를 설명하시오.',
        answer: '상품정보, 이미지, 구매버튼',
        prompt: `전자상거래관리사 2급 웹 기초 문제입니다.\n\n문제: 상품 상세페이지를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '장바구니 기능을 설명하시오.',
        answer: '상품담기, 수량변경, 결제연동',
        prompt: `전자상거래관리사 2급 웹 기초 문제입니다.\n\n문제: 장바구니 기능을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function WebbasicStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('web-basic-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('web-basic-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">웹 기초</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">웹 기초 학습</h1>
