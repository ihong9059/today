...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: 'SUM 함수를 설명하시오.',
        answer: '합계 함수, =SUM(범위)',
        prompt: `컴퓨터활용능력 2급 스프레드시트 문제입니다.\n\n문제: SUM 함수를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'AVERAGE 함수를 설명하시오.',
        answer: '평균 함수, =AVERAGE(범위)',
        prompt: `컴퓨터활용능력 2급 스프레드시트 문제입니다.\n\n문제: AVERAGE 함수를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'MAX/MIN 함수를 설명하시오.',
        answer: '최대값/최소값, =MAX(범위), =MIN(범위)',
        prompt: `컴퓨터활용능력 2급 스프레드시트 문제입니다.\n\n문제: MAX/MIN 함수를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: 'COUNT/COUNTA를 설명하시오.',
        answer: 'COUNT: 숫자개수, COUNTA: 비어있지 않은 셀',
        prompt: `컴퓨터활용능력 2급 스프레드시트 문제입니다.\n\n문제: COUNT/COUNTA를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: 'IF 함수를 설명하시오.',
        answer: '조건판단, =IF(조건,참값,거짓값)',
        prompt: `컴퓨터활용능력 2급 스프레드시트 문제입니다.\n\n문제: IF 함수를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '셀 서식을 설명하시오.',
        answer: '숫자/통화/날짜/텍스트 형식 지정',
        prompt: `컴퓨터활용능력 2급 스프레드시트 문제입니다.\n\n문제: 셀 서식을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '조건부 서식을 설명하시오.',
        answer: '조건 충족시 자동 서식 적용',
        prompt: `컴퓨터활용능력 2급 스프레드시트 문제입니다.\n\n문제: 조건부 서식을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '차트의 종류를 설명하시오.',
        answer: '세로막대, 꺾은선, 원형, 분산형',
        prompt: `컴퓨터활용능력 2급 스프레드시트 문제입니다.\n\n문제: 차트의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '인쇄영역 설정을 설명하시오.',
        answer: '페이지레이아웃→인쇄영역→설정',
        prompt: `컴퓨터활용능력 2급 스프레드시트 문제입니다.\n\n문제: 인쇄영역 설정을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '틀고정을 설명하시오.',
        answer: '보기→틀고정, 특정 행/열 고정',
        prompt: `컴퓨터활용능력 2급 스프레드시트 문제입니다.\n\n문제: 틀고정을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function Spreadsheet2StudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('spreadsheet-2-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('spreadsheet-2-progress', JSON.stringify(newCompleted));
  };
