...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '비서의 역할을 설명하시오.',
        answer: '일정관리, 문서처리, 의전, 정보관리',
        prompt: `비서 1급 비서 고급실무 문제입니다.\n\n문제: 비서의 역할을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '일정관리 방법을 설명하시오.',
        answer: '캘린더 관리, 우선순위, 변경조율',
        prompt: `비서 1급 비서 고급실무 문제입니다.\n\n문제: 일정관리 방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '회의 준비를 설명하시오.',
        answer: '안건정리, 자료준비, 장소/참석자 확인',
        prompt: `비서 1급 비서 고급실무 문제입니다.\n\n문제: 회의 준비를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '출장 지원을 설명하시오.',
        answer: '항공/숙박 예약, 일정표, 현지정보',
        prompt: `비서 1급 비서 고급실무 문제입니다.\n\n문제: 출장 지원을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '보고서 작성을 설명하시오.',
        answer: '핵심요약, 논리적구성, 시각화',
        prompt: `비서 1급 비서 고급실무 문제입니다.\n\n문제: 보고서 작성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '국제의전 서열을 설명하시오.',
        answer: '직위, 연공서열, 외교관례',
        prompt: `비서 1급 비서 고급실무 문제입니다.\n\n문제: 국제의전 서열을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '좌석배치를 설명하시오.',
        answer: '상석 위치, 회의/만찬 배치',
        prompt: `비서 1급 비서 고급실무 문제입니다.\n\n문제: 좌석배치를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '명함교환 예절을 설명하시오.',
        answer: '두 손으로, 상대방 먼저, 확인',
        prompt: `비서 1급 비서 고급실무 문제입니다.\n\n문제: 명함교환 예절을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '인사예절을 설명하시오.',
        answer: '악수, 명함, 호칭, 소개순서',
        prompt: `비서 1급 비서 고급실무 문제입니다.\n\n문제: 인사예절을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '접대 예절을 설명하시오.',
        answer: 'VIP 응대, 식사예절, 선물',
        prompt: `비서 1급 비서 고급실무 문제입니다.\n\n문제: 접대 예절을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function SecretaryadvancedStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('secretary-advanced-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('secretary-advanced-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">비서 고급실무</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">비서 고급실무 학습</h1>
