...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '운영체제의 역할을 설명하시오.',
        answer: '하드웨어 관리, 사용자 인터페이스, 자원 할당',
        prompt: `워드프로세서 PC 운영체제 문제입니다.\n\n문제: 운영체제의 역할을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '파일 확장자의 역할을 설명하시오.',
        answer: '파일 형식 구분, 연결 프로그램 지정',
        prompt: `워드프로세서 PC 운영체제 문제입니다.\n\n문제: 파일 확장자의 역할을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '바로가기의 기능을 설명하시오.',
        answer: '원본 파일/폴더 빠른 접근, .lnk 확장자',
        prompt: `워드프로세서 PC 운영체제 문제입니다.\n\n문제: 바로가기의 기능을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '휴지통의 기능을 설명하시오.',
        answer: '삭제 파일 임시 보관, 복원 가능',
        prompt: `워드프로세서 PC 운영체제 문제입니다.\n\n문제: 휴지통의 기능을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '제어판의 역할을 설명하시오.',
        answer: '시스템 설정 변경, 프로그램 관리',
        prompt: `워드프로세서 PC 운영체제 문제입니다.\n\n문제: 제어판의 역할을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: 'IP 주소의 역할을 설명하시오.',
        answer: '인터넷 장치 식별 주소, 통신 목적지',
        prompt: `워드프로세서 PC 운영체제 문제입니다.\n\n문제: IP 주소의 역할을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'URL의 구성을 설명하시오.',
        answer: '프로토콜://도메인/경로, 웹 자원 위치',
        prompt: `워드프로세서 PC 운영체제 문제입니다.\n\n문제: URL의 구성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '브라우저의 기능을 설명하시오.',
        answer: '웹페이지 요청/표시, HTML 해석',
        prompt: `워드프로세서 PC 운영체제 문제입니다.\n\n문제: 브라우저의 기능을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '이메일 프로토콜을 설명하시오.',
        answer: 'SMTP(발신), POP3/IMAP(수신)',
        prompt: `워드프로세서 PC 운영체제 문제입니다.\n\n문제: 이메일 프로토콜을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '방화벽의 역할을 설명하시오.',
        answer: '네트워크 보안, 불법 접근 차단',
        prompt: `워드프로세서 PC 운영체제 문제입니다.\n\n문제: 방화벽의 역할을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function PcbasicStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('pc-basic-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('pc-basic-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">PC 운영체제</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">PC 운영체제 학습</h1>
