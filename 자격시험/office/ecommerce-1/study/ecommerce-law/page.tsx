...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '전자상거래법을 설명하시오.',
        answer: '전자상거래 소비자보호, 청약철회',
        prompt: `전자상거래관리사 1급 전자상거래 법규 문제입니다.\n\n문제: 전자상거래법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '전자서명법을 설명하시오.',
        answer: '공인인증, 전자문서 법적효력',
        prompt: `전자상거래관리사 1급 전자상거래 법규 문제입니다.\n\n문제: 전자서명법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '통신판매업 신고를 설명하시오.',
        answer: '사업자등록, 통신판매업 등록',
        prompt: `전자상거래관리사 1급 전자상거래 법규 문제입니다.\n\n문제: 통신판매업 신고를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '소비자 청약철회를 설명하시오.',
        answer: '7일 이내, 환불규정, 예외사항',
        prompt: `전자상거래관리사 1급 전자상거래 법규 문제입니다.\n\n문제: 소비자 청약철회를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '표시광고법을 설명하시오.',
        answer: '허위/과장광고 금지, 필수표시사항',
        prompt: `전자상거래관리사 1급 전자상거래 법규 문제입니다.\n\n문제: 표시광고법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function EcommercelawStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('ecommerce-law-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('ecommerce-law-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">전자상거래 법규</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">전자상거래 법규 학습</h1>
