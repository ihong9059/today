...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '비서의 정의를 설명하시오.',
        answer: '상사 업무보좌, 사무지원 전문가',
        prompt: `비서 3급 비서 기초 문제입니다.\n\n문제: 비서의 정의를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '비서의 자질을 설명하시오.',
        answer: '성실, 책임감, 기밀유지, 융통성',
        prompt: `비서 3급 비서 기초 문제입니다.\n\n문제: 비서의 자질을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '비서의 유형을 설명하시오.',
        answer: '개인비서, 그룹비서, 법률/의료비서',
        prompt: `비서 3급 비서 기초 문제입니다.\n\n문제: 비서의 유형을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '직업윤리를 설명하시오.',
        answer: '기밀유지, 정직, 충성, 전문성',
        prompt: `비서 3급 비서 기초 문제입니다.\n\n문제: 직업윤리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '업무태도를 설명하시오.',
        answer: '적극적, 신속정확, 협조적',
        prompt: `비서 3급 비서 기초 문제입니다.\n\n문제: 업무태도를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
    ...
    questions: [
      {
        id: 1,
        question: '문서작성 기초를 설명하시오.',
        answer: '워드프로세서, 한글맞춤법, 서식',
        prompt: `비서 3급 비서 기초 문제입니다.\n\n문제: 문서작성 기초를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '엑셀 활용을 설명하시오.',
        answer: '표작성, 함수, 차트, 데이터정리',
        prompt: `비서 3급 비서 기초 문제입니다.\n\n문제: 엑셀 활용을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '프레젠테이션을 설명하시오.',
        answer: 'PPT 작성, 발표자료 구성',
        prompt: `비서 3급 비서 기초 문제입니다.\n\n문제: 프레젠테이션을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '이메일 기초를 설명하시오.',
        answer: '작성, 첨부, 회신, 전달',
        prompt: `비서 3급 비서 기초 문제입니다.\n\n문제: 이메일 기초를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '캘린더 관리를 설명하시오.',
        answer: '일정등록, 공유, 알림설정',
        prompt: `비서 3급 비서 기초 문제입니다.\n\n문제: 캘린더 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
...
export default function SecretarybasicStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('secretary-basic-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('secretary-basic-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/office/secretary-3" className="text-gray-600 hover:text-violet-600">비서 3급</Link>
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">비서 기초</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">비서 기초 학습</h1>
                <p className="text-violet-100">비서 3급</p>
              </div>
            </div>
