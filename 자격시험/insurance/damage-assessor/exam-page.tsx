    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-cyan-50">
      ...
      <section className="bg-gradient-to-r from-cyan-500 to-teal-500 text-white py-12">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-3xl font-bold mb-2">손해평가사</h1>
      ...
      <section className="max-w-4xl mx-auto px-4 py-10">
        <div className="bg-white rounded-xl shadow-md p-6 mb-6">
          ...
          <p className="text-gray-600">농작물재해 손해평가 전문가 자격시험입니다.</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          ...
          <ul className="space-y-2">
            <li className="text-gray-600">• 농작물재해보험</li><li className="text-gray-600">• 손해평가 실무</li>
          </ul>
        </div>
      </section>
