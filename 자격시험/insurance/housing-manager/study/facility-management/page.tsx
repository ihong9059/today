...
const topics = [
  {
    id: 'facility-management-1',
    name: '건축물 유지관리',
    color: 'from-teal-500 to-emerald-500',
    questions: [
      {
        id: 1,
        question: '승강기 안전관리 기준은?',
        answer: '월 1회 자체점검, 연 1회 정기검사 등을 실시합니다.',
        prompt: `공동주택 승강기 안전관리 기준과 점검 항목을 설명해주세요.`
      },      {
        id: 2,
        question: '소방시설 점검 주기는?',
        answer: '작동기능점검 연 1회, 종합정밀점검 연 1회 실시합니다.',
        prompt: `공동주택 소방시설 점검 종류와 주기를 설명해주세요.`
      },      {
        id: 3,
        question: '급수시설 관리 방법은?',
        answer: '저수조 청소 연 2회, 수질검사 연 1회 이상 실시합니다.',
        prompt: `공동주택 급수시설 관리 기준과 수질관리 방법을 설명해주세요.`
      },      {
        id: 4,
        question: '전기시설 안전관리는?',
        answer: '수전설비 점검, 접지저항 측정, 절연저항 측정 등을 수행합니다.',
        prompt: `공동주택 전기시설 안전관리 점검 항목을 설명해주세요.`
      },      {
        id: 5,
        question: '에너지 절약 관리 방안은?',
        answer: 'LED 조명 교체, 심야전력 활용, 태양광 설치 등이 있습니다.',
        prompt: `공동주택 에너지 절약을 위한 관리 방안을 설명해주세요.`
      }
    ]
  }
];
...
export default function StudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('facility-management-progress');
  ...
  const toggleQuestion = (questionId: string) => {
    ...
    localStorage.setItem('facility-management-progress', JSON.stringify(updated));
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-cyan-50">
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-cyan-600 font-medium">시설관리실무</span>
          </nav>
        </div>
      </header>
      ...
      <section className="bg-gradient-to-r from-cyan-500 to-teal-500 text-white py-8">
        <div className="max-w-4xl mx-auto px-4">
          <h1 className="text-2xl font-bold mb-2">시설관리실무</h1>
          <p className="text-cyan-100">주택관리사(보) - 시설관리실무 학습</p>
