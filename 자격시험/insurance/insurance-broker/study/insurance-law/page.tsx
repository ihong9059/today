...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '보험중개사의 법적 지위는?',
        answer: '보험계약자를 위해 보험계약 체결을 중개하는 독립된 사업자입니다.',
        prompt: `보험중개사의 법적 지위와 보험대리점과의 차이를 설명해주세요.`
      },      {
        id: 2,
        question: '보험중개사 등록 요건은?',
        answer: '자본금, 전문인력, 시설 등의 요건을 갖추어야 합니다.',
        prompt: `보험중개사 등록 요건과 등록 절차를 설명해주세요.`
      },      {
        id: 3,
        question: '보험중개사의 의무는?',
        answer: '선량한 관리자의 주의의무, 설명의무, 비밀유지의무 등이 있습니다.',
        prompt: `보험중개사의 법적 의무와 책임을 설명해주세요.`
      },      {
        id: 4,
        question: '중개수수료 체계는?',
        answer: '보험회사로부터 수수료를 받으며, 요율은 상품별로 다릅니다.',
        prompt: `보험중개사 수수료 체계와 수취 방법을 설명해주세요.`
      },      {
        id: 5,
        question: '손해배상책임보험 가입 의무는?',
        answer: '중개행위로 인한 손해배상을 위해 의무적으로 가입해야 합니다.',
        prompt: `보험중개사 손해배상책임보험의 가입 의무와 보상 범위를 설명해주세요.`
      }
    ]
  }
];
...
export default function StudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('insurance-law-progress');
  ...
  const toggleQuestion = (questionId: string) => {
    ...
    localStorage.setItem('insurance-law-progress', JSON.stringify(updated));
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-cyan-50">
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-cyan-600 font-medium">보험법규</span>
          </nav>
        </div>
      </header>
      ...
      <section className="bg-gradient-to-r from-cyan-500 to-teal-500 text-white py-8">
        <div className="max-w-4xl mx-auto px-4">
          <h1 className="text-2xl font-bold mb-2">보험법규</h1>
          <p className="text-cyan-100">보험중개사 - 보험법규 학습</p>
