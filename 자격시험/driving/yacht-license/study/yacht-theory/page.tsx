...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '요트의 주요 부위를 설명하시오.',
        answer: '선수(Bow), 선미(Stern), 좌현(Port), 우현(Starboard)',
        prompt: `요트조종면허 요트 이론 문제입니다.\n\n문제: 요트의 주요 부위를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '세일의 종류를 설명하시오.',
        answer: '메인세일, 집(Jib), 스피네이커, 제노아',
        prompt: `요트조종면허 요트 이론 문제입니다.\n\n문제: 세일의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '킬(Keel)의 역할을 설명하시오.',
        answer: '횡류방지, 복원력 제공, 균형유지',
        prompt: `요트조종면허 요트 이론 문제입니다.\n\n문제: 킬(Keel)의 역할을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '러더(Rudder)의 기능을 설명하시오.',
        answer: '방향조종, 물흐름 이용, 틸러/휠 조작',
        prompt: `요트조종면허 요트 이론 문제입니다.\n\n문제: 러더(Rudder)의 기능을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '리깅의 종류를 설명하시오.',
        answer: '스탠딩 리깅(고정), 러닝 리깅(조작용 로프)',
        prompt: `요트조종면허 요트 이론 문제입니다.\n\n문제: 리깅의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '포인트 오브 세일을 설명하시오.',
        answer: '클로즈홀드, 빔리치, 브로드리치, 러닝',
        prompt: `요트조종면허 요트 이론 문제입니다.\n\n문제: 포인트 오브 세일을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '태킹(Tacking)을 설명하시오.',
        answer: '역풍상태 방향전환, 선수가 풍상 통과',
        prompt: `요트조종면허 요트 이론 문제입니다.\n\n문제: 태킹(Tacking)을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '자이빙(Gybing)을 설명하시오.',
        answer: '순풍상태 방향전환, 선미가 풍상 통과',
        prompt: `요트조종면허 요트 이론 문제입니다.\n\n문제: 자이빙(Gybing)을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '헬름(Helm) 조작을 설명하시오.',
        answer: '러프(풍상전환), 베어어웨이(풍하전환)',
        prompt: `요트조종면허 요트 이론 문제입니다.\n\n문제: 헬름(Helm) 조작을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '노고존(No Go Zone)을 설명하시오.',
        answer: '바람방향 좌우 45도, 전진불가 구역',
        prompt: `요트조종면허 요트 이론 문제입니다.\n\n문제: 노고존(No Go Zone)을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
];

export default function YachttheoryStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('yacht-theory-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('yacht-theory-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/driving/yacht-license" className="text-gray-600 hover:text-gray-600">요트조종면허</Link>
            <span className="text-gray-300">›</span>
            <span className="text-gray-600 font-medium">요트 이론</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">요트 이론 학습</h1>
                <p className="text-gray-100">요트조종면허</p>
              </div>
            </div>
