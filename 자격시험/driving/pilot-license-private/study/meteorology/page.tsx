...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '대기권의 구조를 설명하시오.',
        answer: '대류권(날씨), 성층권, 중간권, 열권',
        prompt: `자가용조종사 항공기상 문제입니다.\n\n문제: 대기권의 구조를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '전선의 종류를 설명하시오.',
        answer: '한랭전선, 온난전선, 폐색전선, 정체전선',
        prompt: `자가용조종사 항공기상 문제입니다.\n\n문제: 전선의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '난기류의 원인을 설명하시오.',
        answer: '대류, 전선, 산악, 바람시어, 제트기류',
        prompt: `자가용조종사 항공기상 문제입니다.\n\n문제: 난기류의 원인을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '착빙의 종류를 설명하시오.',
        answer: '투명빙, 무빙, 서리빙, 위험성',
        prompt: `자가용조종사 항공기상 문제입니다.\n\n문제: 착빙의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '시정장애 현상을 설명하시오.',
        answer: '안개, 박무, 연기, 먼지, 강수',
        prompt: `자가용조종사 항공기상 문제입니다.\n\n문제: 시정장애 현상을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function MeteorologyStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('meteorology-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('meteorology-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-gray-600 font-medium">항공기상</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">항공기상 학습</h1>
