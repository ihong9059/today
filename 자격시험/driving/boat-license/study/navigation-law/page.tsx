...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '우현 우선원칙을 설명하시오.',
        answer: '마주칠때 우현으로 변침, 우측에서 오는 배 우선',
        prompt: `소형선박조종사 항해법규 문제입니다.\n\n문제: 우현 우선원칙을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '항해등의 종류를 설명하시오.',
        answer: '마스트등(백색), 현등(녹/홍), 선미등(백색)',
        prompt: `소형선박조종사 항해법규 문제입니다.\n\n문제: 항해등의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '음향신호의 종류를 설명하시오.',
        answer: '단음(우현), 장음(좌현), 경고(5회이상)',
        prompt: `소형선박조종사 항해법규 문제입니다.\n\n문제: 음향신호의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '우선피항선의 의무를 설명하시오.',
        answer: '조기변침, 대각도변침, 상대선 진로방해금지',
        prompt: `소형선박조종사 항해법규 문제입니다.\n\n문제: 우선피항선의 의무를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '협수로 통항규칙을 설명하시오.',
        answer: '우측통행, 소형선 대형선 피항, 앞지르기 금지',
        prompt: `소형선박조종사 항해법규 문제입니다.\n\n문제: 협수로 통항규칙을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '구명설비의 종류를 설명하시오.',
        answer: '구명동의, 구명부환, 구명뗏목, 구명정',
        prompt: `소형선박조종사 항해법규 문제입니다.\n\n문제: 구명설비의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '소화설비를 설명하시오.',
        answer: '분말소화기, 자동소화장치, 소화펌프',
        prompt: `소형선박조종사 항해법규 문제입니다.\n\n문제: 소화설비를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '통신설비를 설명하시오.',
        answer: 'VHF 무선전화, 휴대용 위치발신장치(EPIRB)',
        prompt: `소형선박조종사 항해법규 문제입니다.\n\n문제: 통신설비를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '항해계기를 설명하시오.',
        answer: '나침의, GPS, 어탐기, 레이더',
        prompt: `소형선박조종사 항해법규 문제입니다.\n\n문제: 항해계기를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '법정비품을 설명하시오.',
        answer: '조명, 닻, 계류색, 구급함, 공구류',
        prompt: `소형선박조종사 항해법규 문제입니다.\n\n문제: 법정비품을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function NavigationlawStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('navigation-law-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('navigation-law-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-gray-600 font-medium">항해법규</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">항해법규 학습</h1>
