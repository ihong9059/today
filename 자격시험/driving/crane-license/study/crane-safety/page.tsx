...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '전도사고 원인을 설명하시오.',
        answer: '과부하, 지반침하, 강풍, 급선회, 경사지',
        prompt: `기중기운전기능사 안전관리 문제입니다.\n\n문제: 전도사고 원인을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '낙하사고 예방을 설명하시오.',
        answer: '와이어로프 점검, 훅래치확인, 균형유지, 급조작금지',
        prompt: `기중기운전기능사 안전관리 문제입니다.\n\n문제: 낙하사고 예방을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '끼임사고 예방을 설명하시오.',
        answer: '접근금지구역, 신호준수, 로프접촉금지',
        prompt: `기중기운전기능사 안전관리 문제입니다.\n\n문제: 끼임사고 예방을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '감전사고 예방을 설명하시오.',
        answer: '송전선 이격거리, 접지, 절연보호구',
        prompt: `기중기운전기능사 안전관리 문제입니다.\n\n문제: 감전사고 예방을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '정기검사 기준을 설명하시오.',
        answer: '와이어로프, 후크, 제동장치, 권과방지장치',
        prompt: `기중기운전기능사 안전관리 문제입니다.\n\n문제: 정기검사 기준을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function CranesafetyStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('crane-safety-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('crane-safety-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-gray-600 font-medium">안전관리</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">안전관리 학습</h1>
