...
export default function PlantProtectionTechnicianExamPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="mb-6">
          <Link href="/category/agriculture/plant-protection-technician" className="text-green-700 hover:text-green-900 flex items-center gap-2">
            ← 식물보호산업기사로 돌아가기
          </Link>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 rounded-xl p-4">
                  ...
                  <p className="text-sm text-gray-600">작물 재배의 기초이론</p>
                </div>
                <div className="bg-gray-50 rounded-xl p-4">
                  ...
                  <p className="text-sm text-gray-600">식물병의 원인과 방제</p>
                </div>
                <div className="bg-gray-50 rounded-xl p-4">
                  <div className="flex items-center justify-between mb-2"><span className="font-medium">🐛 해충학</span><span className="text-sm text-gray-500">20문항</span></div>
                  <p className="text-sm text-gray-600">해충의 생태와 방제</p>
                </div>
                <div className="bg-gray-50 rounded-xl p-4">
                  ...
                  <p className="text-sm text-gray-600">농약의 종류와 안전사용</p>
                </div>
              </div>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4">
                ...
                <ul className="text-sm text-yellow-700 space-y-1">
                  <li>• 기사보다 기초적인 내용 위주 출제</li>
                  <li>• 주요 병해충의 특성과 방제법 암기</li>
                  <li>• 농약 희석 계산 문제 연습</li>
                  <li>• 기출문제 반복 풀이로 유형 파악</li>
                </ul>
              </div>
            </div>
          )}
