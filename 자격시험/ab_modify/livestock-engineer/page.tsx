...
export default function LivestockEngineerPage() {
  const subjects = [
    { id: 'animal-breeding', name: '가축육종학', icon: '🧬', desc: '유전과 개량', questions: 50 },
    { id: 'reproduction', name: '가축번식생리학', icon: '🐄', desc: '번식과 생리', questions: 50 },
    { id: 'nutrition', name: '가축영양학', icon: '🥗', desc: '영양소와 대사', questions: 50 },
    { id: 'feed-science', name: '사료학', icon: '🌾', desc: '사료의 종류와 가공', questions: 50 },
    { id: 'farm-management', name: '축산경영학', icon: '📊', desc: '경영과 관리', questions: 50 },
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">축산기사</h1>
              <p className="text-gray-600">축산업 전문기술인력</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-teal-50 rounded-xl p-4 text-center">
              ...
              <p className="text-xl font-bold text-teal-800">125분</p>
            </div>
          ...
          <Link
            href="/category/agriculture/livestock-engineer/exam"
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          ...
          <div className="space-y-3">
            {subjects.map((subject) => (
              <Link
                key={subject.id}
                href={`/category/agriculture/livestock-engineer/study/${subject.id}`}
          ...
          <div className="mt-6 p-4 bg-green-50 rounded-xl">
            ...
            <ul className="text-sm text-green-700 space-y-1">
              <li>• 가축 유전학과 육종 원리 이해</li>
              <li>• 번식생리와 인공수정 기술 파악</li>
              <li>• 영양소 대사와 사료 배합 학습</li>
              <li>• 축산 경영 및 위생관리 숙지</li>
            </ul>
          </div>
        </div>
      </div>
