...
export default function AgriMachineTechnicianPage() {
  const subjects = [
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">농업기계산업기사</h1>
              <p className="text-gray-600">농업기계 기술인력</p>
            </div>
          </div>
          ...
          <Link
            href="/category/agriculture/agri-machine-technician/exam"
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          ...
          <div className="space-y-3">
            {subjects.map((subject) => (
              <Link
                key={subject.id}
                href={`/category/agriculture/agri-machine-technician/study/${subject.id}`}
