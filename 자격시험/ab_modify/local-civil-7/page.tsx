...
export default function LocalCivil7Page() {
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">지방직 7급</h1>
              <p className="text-gray-600">지방공무원 7급 공개경쟁임용시험</p>
            </div>
          </div>
          ...
          <Link
            href="/category/civil/local-civil-7/exam"
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
          ...
          <div className="space-y-3">
            {requiredSubjects.map((subject) => (
              <Link
                key={subject.id}
                href={`/category/civil/local-civil-7/study/${subject.id}`}
