...
export default function OrganicFarmingTechnicianExamPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="mb-6">
          <Link href="/category/agriculture/organic-farming-technician" className="text-green-700 hover:text-green-900 flex items-center gap-2">
            ← 유기농업산업기사로 돌아가기
          </Link>
        </div>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-green-50 rounded-xl p-4 text-center">
                  ...
                  <p className="text-2xl font-bold text-green-800">60문항</p>
                </div>
                <div className="bg-emerald-50 rounded-xl p-4 text-center">
                  <p className="text-sm text-emerald-600">시험 시간</p>
                  <p className="text-2xl font-bold text-emerald-800">75분</p>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 rounded-xl p-4">
                  ...
                  <p className="text-sm text-gray-600">토양의 특성, 비옥도, 유기물 관리</p>
                </div>
                <div className="bg-gray-50 rounded-xl p-4">
                  ...
                  <p className="text-sm text-gray-600">유기농업 원리, 인증제도, 병해충 관리</p>
                </div>
              </div>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4">
                ...
                <ul className="text-sm text-yellow-700 space-y-1">
                  ...
                  <li>• 친환경 인증기준 핵심 내용 암기</li>
                  <li>• 퇴비 제조와 토양관리 이해</li>
