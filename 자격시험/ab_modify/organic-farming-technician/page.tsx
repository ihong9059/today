...
export default function OrganicFarmingTechnicianPage() {
  const subjects = [
    { id: 'cultivation', name: '재배원론', icon: '🌱', desc: '작물 재배의 기초', questions: 50 },
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">유기농업산업기사</h1>
              <p className="text-gray-600">친환경 유기농업 기술인력</p>
            </div>
          </div>
          ...
          <Link
            href="/category/agriculture/organic-farming-technician/exam"
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          ...
          <div className="space-y-3">
            {subjects.map((subject) => (
              <Link
                key={subject.id}
                href={`/category/agriculture/organic-farming-technician/study/${subject.id}`}
          ...
          <div className="mt-6 p-4 bg-green-50 rounded-xl">
            ...
            <ul className="text-sm text-green-700 space-y-1">
              <li>• 유기농업기사보다 기초적인 내용 위주</li>
              <li>• 친환경 인증제도 기준 숙지</li>
              <li>• 유기물 관리와 퇴비 제조 이해</li>
              <li>• 생물적 병해충 방제 기초 학습</li>
            </ul>
          </div>
        </div>
      </div>
