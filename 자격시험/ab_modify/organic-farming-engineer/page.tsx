...
export default function OrganicFarmingEngineerPage() {
  const subjects = [
    { id: 'cultivation', name: '재배원론', icon: '🌱', desc: '작물 재배의 기초이론', questions: 50 },
    { id: 'soil-science', name: '토양학', icon: '🪨', desc: '토양의 특성과 관리', questions: 50 },
    { id: 'organic-food', name: '유기식품학', icon: '🥗', desc: '유기식품의 특성과 관리', questions: 50 },
    { id: 'organic-farming', name: '유기농업일반', icon: '🌾', desc: '유기농업의 원리와 실제', questions: 50 },
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">유기농업기사</h1>
              <p className="text-gray-600">친환경 유기농업 전문 기술인</p>
            </div>
          </div>
          ...
          <Link
            href="/category/agriculture/organic-farming-engineer/exam"
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          ...
          <div className="space-y-3">
            {subjects.map((subject) => (
              <Link
                key={subject.id}
                href={`/category/agriculture/organic-farming-engineer/study/${subject.id}`}
          ...
          <div className="mt-6 p-4 bg-green-50 rounded-xl">
            ...
            <ul className="text-sm text-green-700 space-y-1">
              <li>• 유기농업의 원리와 친환경 인증제도 숙지</li>
              <li>• 토양 비옥도 관리와 유기물 활용 이해</li>
              <li>• 병해충 생물적 방제법 학습</li>
              <li>• 유기식품 가공 및 품질관리 기준 파악</li>
            </ul>
          </div>
        </div>
      </div>
