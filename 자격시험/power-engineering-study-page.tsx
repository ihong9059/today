              ...
              {[
                ...
                <button
                  ...
                  className={`px-3 py-1 rounded-full text-sm font-medium transition ${
                    selectedAI === ai.id
                      ? `bg-${ai.color}-500 text-white`
                      : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                  }`}
                  style={selectedAI === ai.id ? {
                    backgroundColor: ai.id === 'claude' ? '#f97316' : ai.id === 'chatgpt' ? '#10b981' : '#3b82f6'
                  } : {}}
                >
                  {ai.name}
                </button>
                  ...
                  <div className="border-t bg-gray-50 p-4">
                    ...
                    <div className="flex gap-3">
                      <a
                        ...
                        style={{
                          backgroundColor: selectedAI === 'claude' ? '#f97316' : selectedAI === 'chatgpt' ? '#10b981' : '#3b82f6'
                        }}
                      >
