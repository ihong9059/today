#!/usr/bin/env python3
"""Analyze audio files for Lesson 8-5 to get durations"""

import os
from mutagen.mp3 import MP3

AUDIO_DIR = "../public/audio/lesson-8-5"
FPS = 30

scenes = ["intro", "precision", "why", "amp", "scaling", "bf16", "outro"]

print("Lesson 8-5 Audio Analysis")
print("=" * 50)
...
print(f"export const LESSON_8_5_DURATION = {total_duration};")
print()
