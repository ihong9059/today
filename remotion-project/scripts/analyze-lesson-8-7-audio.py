#!/usr/bin/env python3
"""Analyze audio files for Lesson 8-7 to get durations"""

import os
from mutagen.mp3 import MP3

AUDIO_DIR = "../public/audio/lesson-8-7"
FPS = 30

scenes = ["intro", "occupancy", "coalescing", "divergence", "bank", "profiling", "outro"]

print("Lesson 8-7 Audio Analysis")
print("=" * 50)
...
print(f"export const LESSON_8_7_DURATION = {total_duration};")
print()
