...
SCRIPT_DIR = "scripts/lesson-8-1"

scenes = [
    ("scene1_intro.txt", "intro.mp3"),
    ("scene2_cpu_vs_gpu.txt", "cpu_vs_gpu.mp3"),
    ("scene3_why_gpu.txt", "why_gpu.mp3"),
    ("scene4_simd.txt", "simd.mp3"),
    ("scene5_bandwidth.txt", "bandwidth.mp3"),
    ("scene6_cooperation.txt", "cooperation.mp3"),
