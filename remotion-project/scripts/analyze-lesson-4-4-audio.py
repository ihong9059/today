...
AUDIO_DIR = r"C:\todo\today\remotion-project\public\audio\lesson-4-4"
FPS = 30
...
print("Lesson 4-4: nn.Module 기초 - Audio Analysis")
print("=" * 60)
...
print("};")
print(f"\nexport const LESSON_4_4_DURATION = {total_frames};")
