...
OUTPUT_DIR = "public/audio/lesson-3-4"
SCRIPT_DIR = "scripts/lesson-3-4"

os.makedirs(OUTPUT_DIR, exist_ok=True)

scenes = [
    ("scene1_intro.txt", "intro.mp3"),
    ("scene2_sigmoid.txt", "sigmoid.mp3"),
    ("scene3_relu.txt", "relu.mp3"),
    ("scene4_leaky.txt", "leaky.mp3"),
    ("scene5_softmax.txt", "softmax.mp3"),
