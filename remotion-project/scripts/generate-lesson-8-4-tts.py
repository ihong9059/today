...
SCRIPT_DIR = "scripts/lesson-8-4"

scenes = [
    ("scene1_intro.txt", "intro.mp3"),
    ("scene2_naive.txt", "naive.mp3"),
    ("scene3_problem.txt", "problem.mp3"),
    ("scene4_tiling.txt", "tiling.mp3"),
    ("scene5_implementation.txt", "implementation.mp3"),
    ("scene6_performance.txt", "performance.mp3"),
