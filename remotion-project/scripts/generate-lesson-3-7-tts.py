...
OUTPUT_DIR = "public/audio/lesson-3-7"
SCRIPT_DIR = "scripts/lesson-3-7"

os.makedirs(OUTPUT_DIR, exist_ok=True)

scenes = [
    ("scene1_intro.txt", "intro.mp3"),
    ("scene2_what.txt", "what.mp3"),
    ("scene3_methods.txt", "methods.mp3"),
    ("scene4_learningrate.txt", "learningrate.mp3"),
    ("scene5_tips.txt", "tips.mp3"),
