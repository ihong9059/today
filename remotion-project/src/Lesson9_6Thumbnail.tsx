...
export const Lesson9_6Thumbnail: React.FC = () => (
  <AbsoluteFill style={{ background: COLORS.gradient, justifyContent: "center", alignItems: "center", fontFamily: "Pretendard, sans-serif" }}>
    ...
    <div style={{ textAlign: "center" }}>
      ...
      <div style={{ fontSize: 80, fontWeight: 800, color: COLORS.light, marginBottom: 20 }}>모델 배포</div>
      <div style={{ fontSize: 44, color: "rgba(255,255,255,0.9)" }}>서비스 운영 환경 구축</div>
