...
export const Lesson9_2Thumbnail: React.FC = () => (
  <AbsoluteFill style={{ background: COLORS.gradient, justifyContent: "center", alignItems: "center", fontFamily: "Pretendard, sans-serif" }}>
    ...
    <div style={{ textAlign: "center" }}>
      ...
      <div style={{ fontSize: 80, fontWeight: 800, color: COLORS.light, marginBottom: 20 }}>데이터 수집과 준비</div>
      <div style={{ fontSize: 44, color: "rgba(255,255,255,0.9)" }}>고품질 데이터셋 구축</div>
