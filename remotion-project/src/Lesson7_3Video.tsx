...
export const LESSON_7_3_DURATION = 3923;

const SCENE_TIMINGS = {
  intro: { start: 0, duration: 489 },
  why: { start: 489, duration: 571 },
  mechanism: { start: 1060, duration: 590 },
  heads: { start: 1650, duration: 611 },
  efficiency: { start: 2261, duration: 567 },
  visualization: { start: 2828, duration: 577 },
  outro: { start: 3405, duration: 518 },
};
...
const SceneIntro: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.gradient, justifyContent: "center", alignItems: "center", fontFamily: "Pretendard, sans-serif" }}>
      <GlobalOverlay />
      <Audio src={staticFile("audio/lesson-7-3/intro.mp3")} />
      <div style={{ textAlign: "center", opacity, transform: `translateY(${20 - opacity * 20}px)` }}>
        <div style={{ fontSize: 180, marginBottom: 20 }}>👁️</div>
        <div style={{ fontSize: 72, fontWeight: 800, color: COLORS.light, marginBottom: 20 }}>Multi-Head Attention</div>
        <div style={{ fontSize: 36, color: "rgba(255,255,255,0.9)" }}>여러 관점의 어텐션</div>
...
const SceneWhy: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.background, fontFamily: "Pretendard, sans-serif" }}>
      <GlobalOverlay />
      <Audio src={staticFile("audio/lesson-7-3/why.mp3")} />
      <div style={{ padding: 80, paddingTop: 100 }}>
        <h1 style={{ fontSize: 56, color: COLORS.primary, marginBottom: 40 }}>왜 여러 개?</h1>
        <div style={{ display: "flex", gap: 40 }}>
          <div style={{ flex: 1 }}>
            <div style={{ background: "rgba(139,92,246,0.15)", borderRadius: 20, padding: 40 }}>
              ...
              <div style={{ fontSize: 28, color: COLORS.light, textAlign: "center" }}>다양한 관계 포착</div>
            </div>
          </div>
...
const SceneMechanism: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.background, fontFamily: "Pretendard, sans-serif" }}>
      <GlobalOverlay />
      <Audio src={staticFile("audio/lesson-7-3/mechanism.mp3")} />
      <div style={{ padding: 80, paddingTop: 100 }}>
        <h1 style={{ fontSize: 56, color: COLORS.primary, marginBottom: 40 }}>동작 원리</h1>
        <div style={{ display: "flex", gap: 40 }}>
          <div style={{ flex: 1 }}>
            <div style={{ background: "rgba(139,92,246,0.15)", borderRadius: 20, padding: 40 }}>
              <div style={{ fontSize: 100, textAlign: "center", marginBottom: 20 }}>👁️</div>
              <div style={{ fontSize: 28, color: COLORS.light, textAlign: "center" }}>분할과 결합</div>
            </div>
          </div>
          <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <div style={{
...
const SceneHeads: React.FC = () => {
  const frame = useCurrentFrame();
  return (
    <AbsoluteFill style={{ background: COLORS.background, fontFamily: "Pretendard, sans-serif" }}>
      <GlobalOverlay />
      <Audio src={staticFile("audio/lesson-7-3/heads.mp3")} />
      <div style={{ padding: 80, paddingTop: 100 }}>
        <h1 style={{ fontSize: 56, color: COLORS.primary, marginBottom: 40 }}>헤드의 역할</h1>
        <div style={{ display: "flex", gap: 40 }}>
          <div style={{ flex: 1 }}>
            <div style={{ background: "rgba(139,92,246,0.15)", borderRadius: 20, padding: 40 }}>
              <div style={{ fontSize: 100, textAlign: "center", marginBottom: 20 }}>👁️</div>
              <div style={{ fontSize: 28, color: COLORS.light, textAlign: "center" }}>각각의 전문성</div>
            </div>
          </div>
          <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <div style={{
...
const SceneEfficiency: React.FC = () => {
  const frame = useCurrentFrame();
  return (
    <AbsoluteFill style={{ background: COLORS.background, fontFamily: "Pretendard, sans-serif" }}>
      <GlobalOverlay />
      <Audio src={staticFile("audio/lesson-7-3/efficiency.mp3")} />
      <div style={{ padding: 80, paddingTop: 100 }}>
        <h1 style={{ fontSize: 56, color: COLORS.primary, marginBottom: 40 }}>효율성</h1>
        <div style={{ display: "flex", gap: 40 }}>
          <div style={{ flex: 1 }}>
            <div style={{ background: "rgba(139,92,246,0.15)", borderRadius: 20, padding: 40 }}>
              <div style={{ fontSize: 100, textAlign: "center", marginBottom: 20 }}>👁️</div>
              <div style={{ fontSize: 28, color: COLORS.light, textAlign: "center" }}>계산량 유지</div>
            </div>
          </div>
          <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <div style={{
...
const SceneVisualization: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.background, fontFamily: "Pretendard, sans-serif" }}>
      <GlobalOverlay />
      <Audio src={staticFile("audio/lesson-7-3/visualization.mp3")} />
      <div style={{ padding: 80, paddingTop: 100 }}>
        <h1 style={{ fontSize: 56, color: COLORS.primary, marginBottom: 40 }}>시각화</h1>
        <div style={{ display: "flex", gap: 40 }}>
          <div style={{ flex: 1 }}>
            <div style={{ background: "rgba(139,92,246,0.15)", borderRadius: 20, padding: 40 }}>
              <div style={{ fontSize: 100, textAlign: "center", marginBottom: 20 }}>👁️</div>
              <div style={{ fontSize: 28, color: COLORS.light, textAlign: "center" }}>어텐션 패턴</div>
            </div>
          </div>
          <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <div style={{
...
const SceneOutro: React.FC = () => (
  <AbsoluteFill style={{ background: COLORS.gradient, justifyContent: "center", alignItems: "center", fontFamily: "Pretendard, sans-serif" }}>
    <GlobalOverlay />
    <Audio src={staticFile("audio/lesson-7-3/outro.mp3")} />
    <div style={{ textAlign: "center" }}>
      ...
      <div style={{ marginTop: 50, fontSize: 32, color: COLORS.light }}>
        다음 시간: <span style={{ fontWeight: 700 }}>Positional Encoding</span>
      </div>
    </div>
  </AbsoluteFill>
);
...
export const Lesson7_3Video: React.FC = () => (
  <AbsoluteFill style={{ background: COLORS.background }}>
    ...
    <Sequence from={SCENE_TIMINGS.mechanism.start} durationInFrames={SCENE_TIMINGS.mechanism.duration}><SceneMechanism /></Sequence>
    <Sequence from={SCENE_TIMINGS.heads.start} durationInFrames={SCENE_TIMINGS.heads.duration}><SceneHeads /></Sequence>
    <Sequence from={SCENE_TIMINGS.efficiency.start} durationInFrames={SCENE_TIMINGS.efficiency.duration}><SceneEfficiency /></Sequence>
