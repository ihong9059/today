...
export const Lesson0_3Thumbnail: React.FC = () => {
  return (
    <AbsoluteFill>
      {/* 배경 그라데이션 */}
      <div
      ...
      >
        <span style={{ fontSize: 32, color: colors.white, fontWeight: "bold" }}>Level 0-3</span>
      </div>
      ...
      >
        {[
          { type: "if", color: colors.primary },
          { type: "elif", color: colors.accent },
          { type: "else", color: colors.secondary },
          { type: "True/False", color: colors.success },
        ].map((item, i) => (
          <div
            key={i}
            style={{
