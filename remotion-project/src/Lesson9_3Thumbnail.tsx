...
export const Lesson9_3Thumbnail: React.FC = () => (
  <AbsoluteFill style={{ background: COLORS.gradient, justifyContent: "center", alignItems: "center", fontFamily: "Pretendard, sans-serif" }}>
    ...
    <div style={{ textAlign: "center" }}>
      ...
      <div style={{ fontSize: 80, fontWeight: 800, color: COLORS.light, marginBottom: 20 }}>번호판 검출 - YOLO</div>
      <div style={{ fontSize: 44, color: "rgba(255,255,255,0.9)" }}>실시간 객체 검출</div>
