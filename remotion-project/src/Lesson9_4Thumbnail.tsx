...
export const Lesson9_4Thumbnail: React.FC = () => (
  <AbsoluteFill style={{ background: COLORS.gradient, justifyContent: "center", alignItems: "center", fontFamily: "Pretendard, sans-serif" }}>
    ...
    <div style={{ textAlign: "center" }}>
      ...
      <div style={{ fontSize: 80, fontWeight: 800, color: COLORS.light, marginBottom: 20 }}>문자 인식 - CNN</div>
      <div style={{ fontSize: 44, color: "rgba(255,255,255,0.9)" }}>OCR 시스템 구현</div>
