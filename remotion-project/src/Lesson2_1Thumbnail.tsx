...
export const Lesson2_1Thumbnail: React.FC = () => {
  return (
    ...
    >
      ...
      >
        <span style={{ fontSize: 36, color: colors.white, fontWeight: "bold" }}>Level 2-1</span>
      </div>
      ...
      >
        {[
          ...
          >
            <div style={{ fontSize: 50, marginBottom: 8 }}>{item.icon}</div>
            <div style={{ fontSize: 22, color: colors.white, fontWeight: "bold" }}>{item.label}</div>
          </div>
        ))}
      </div>
