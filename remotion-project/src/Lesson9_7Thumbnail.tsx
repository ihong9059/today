...
export const Lesson9_7Thumbnail: React.FC = () => (
  <AbsoluteFill style={{ background: COLORS.gradient, justifyContent: "center", alignItems: "center", fontFamily: "Pretendard, sans-serif" }}>
    ...
    <div style={{ textAlign: "center" }}>
      ...
      <div style={{ fontSize: 80, fontWeight: 800, color: COLORS.light, marginBottom: 20 }}>MLOps 기초</div>
      <div style={{ fontSize: 44, color: "rgba(255,255,255,0.9)" }}>지속적인 모델 운영</div>
