...
export const Lesson9_1Thumbnail: React.FC = () => (
  <AbsoluteFill style={{ background: COLORS.gradient, justifyContent: "center", alignItems: "center", fontFamily: "Pretendard, sans-serif" }}>
    ...
    <div style={{ textAlign: "center" }}>
      ...
      <div style={{ fontSize: 80, fontWeight: 800, color: COLORS.light, marginBottom: 20 }}>프로젝트 개요</div>
      <div style={{ fontSize: 44, color: "rgba(255,255,255,0.9)" }}>번호판 인식 시스템</div>
