...
export const Lesson0_2Thumbnail: React.FC = () => {
  return (
    <AbsoluteFill>
      {/* 배경 그라데이션 */}
      <div
      ...
      >
        <span style={{ fontSize: 32, color: colors.white, fontWeight: "bold" }}>Level 0-2</span>
      </div>
      ...
      >
        {[
          { type: "int", color: colors.primary },
          { type: "float", color: colors.accent },
          { type: "str", color: colors.secondary },
          { type: "list", color: colors.success },
          { type: "dict", color: "#f97316" },
        ].map((item, i) => (
          <div
            key={i}
            style={{
