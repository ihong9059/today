...
export const Lesson9_5Thumbnail: React.FC = () => (
  <AbsoluteFill style={{ background: COLORS.gradient, justifyContent: "center", alignItems: "center", fontFamily: "Pretendard, sans-serif" }}>
    ...
    <div style={{ textAlign: "center" }}>
      ...
      <div style={{ fontSize: 80, fontWeight: 800, color: COLORS.light, marginBottom: 20 }}>모델 평가</div>
      <div style={{ fontSize: 44, color: "rgba(255,255,255,0.9)" }}>성능 측정과 분석</div>
