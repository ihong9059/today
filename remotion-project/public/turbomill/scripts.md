# TURBO MILL TTS 나레이션 스크립트

## scene01_intro.mp3 (15초)
...
이를 통해 D50 기준 10~500 마이크로미터 범위의 정밀한 입도 제어가 가능합니다.

## scene03_features.mp3 (50초)
...
다섯째, CIP(Clean-In-Place) 대응 설계로 식품, 의약품 GMP 환경에 적합합니다.

## scene04_specs.mp3 (45초)
