"""
UTTEC Mini Web UI Server (port 8098)
ESP32-C3 SuperMini 웹 UI — 빌드 API는 8096 프록시
"""
import asyncio
import httpx
...
app = FastAPI(title="UTTEC Mini Web UI", version="1.0")
