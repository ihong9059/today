...
class _MainShellState extends State<MainShell> {
  ...
  // Shared state — Server
  String serverUrl = 'http://192.168.0.20:8093';
  String prebuiltServerUrl = 'http://192.168.0.20:8096';
  ...
  Future<void> _loadSettings() async {
    ...
    setState(() {
      ...
      serverUrl = p.getString('serverUrl') ?? 'http://192.168.0.20:8093';
      prebuiltServerUrl = p.getString('prebuiltServerUrl') ?? 'http://192.168.0.20:8096';
    });
  }
