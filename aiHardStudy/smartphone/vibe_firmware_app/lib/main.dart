...
class _MainShellState extends State<MainShell> {
  ...
  // Shared state — Server
  String serverUrl = 'http://192.168.0.2:8092';
  ...
  Future<void> _loadSettings() async {
    ...
    setState(() {
      ...
      serverUrl = p.getString('serverUrl') ?? 'http://192.168.0.2:8092';
    });
  }
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Container(
            ...
            child: Row(children: [
              ...
              const SizedBox(width: 12),
              const Text('\uC2A4\uC704\uCE58 \uC0C1\uD0DC', style: TextStyle(fontSize: 14)),
              const Spacer(),
              Container(
                padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 4),
                decoration: BoxDecoration(
                  color: C.text2.withOpacity(0.15),
                  borderRadius: BorderRadius.circular(20),
                ),
                child: const Text('\uB300\uAE30 \uC911', style: TextStyle(fontSize: 12, color: C.text2)),
              ),
            ]),
          ),
        ...
        child: Column(children: [
          ...
          styledCard(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: 'http://192.168.0.2:8092',
