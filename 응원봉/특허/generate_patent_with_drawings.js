const { Document, Packer, Paragraph, TextRun, Table, TableRow, TableCell,
        ...
        PageNumber, PageBreak, HeadingLevel, ShadingType, VerticalAlign,
...
const drawings = {
    fig1: fs.readFileSync(path.join(drawingsPath, '도1_전체시스템구성도.png')),
    fig2: fs.readFileSync(path.join(drawingsPath, '도2_시스템프롬프트생성흐름도.png')),
    fig3: fs.readFileSync(path.join(drawingsPath, '도3_음성AI_LED파이프라인시퀀스.png')),
    fig4: fs.readFileSync(path.join(drawingsPath, '도4_BLE명령프로토콜구조.png')),
    fig5: fs.readFileSync(path.join(drawingsPath, '도5_AI응답파싱알고리즘흐름도.png')),
    fig6: fs.readFileSync(path.join(drawingsPath, '도6_하이브리드AI아키텍처.png')),
    fig7: fs.readFileSync(path.join(drawingsPath, '도7_온디바이스AI처리상세흐름도.png'))
};

// 한국 특허청 제출 양식에 맞는 특허 명세서 생성 (도면 포함)
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      // ============ 도면 섹션 ============
      new Paragraph({ style: "PatentSection", children: [new TextRun("【도면】")] }),

      // 도 1
      new Paragraph({ spacing: { before: 200, after: 150 }, alignment: AlignmentType.CENTER, children: [
        new TextRun({ text: "【도 1】 AI FanStick 전체 시스템 구성도", bold: true, size: 24 })
      ]}),
      new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 100 }, children: [
        new ImageRun({
          type: "png",
          data: drawings.fig1,
          transformation: { width: 450, height: 562 },
          altText: { title: "도 1", description: "전체 시스템 구성도", name: "fig1" }
        })
      ]}),
      ...
      // 도 2
      new Paragraph({ spacing: { before: 200, after: 150 }, alignment: AlignmentType.CENTER, children: [
        new TextRun({ text: "【도 2】 시스템 프롬프트 생성 흐름도", bold: true, size: 24 })
      ]}),
      new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 100 }, children: [
        new ImageRun({
          type: "png",
          data: drawings.fig2,
          transformation: { width: 450, height: 562 },
          altText: { title: "도 2", description: "시스템 프롬프트 생성 흐름도", name: "fig2" }
        })
      ]}),
      ...
      // 도 3
      new Paragraph({ spacing: { before: 200, after: 150 }, alignment: AlignmentType.CENTER, children: [
        new TextRun({ text: "【도 3】 음성-AI-LED 파이프라인 시퀀스 다이어그램", bold: true, size: 24 })
      ]}),
      new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 100 }, children: [
        new ImageRun({
          type: "png",
          data: drawings.fig3,
          transformation: { width: 450, height: 562 },
          altText: { title: "도 3", description: "음성-AI-LED 파이프라인 시퀀스 다이어그램", name: "fig3" }
        })
      ]}),
      ...
      // 도 4
      new Paragraph({ spacing: { before: 200, after: 150 }, alignment: AlignmentType.CENTER, children: [
        new TextRun({ text: "【도 4】 BLE 명령 프로토콜 구조", bold: true, size: 24 })
      ]}),
      new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 100 }, children: [
        new ImageRun({
          type: "png",
          data: drawings.fig4,
          transformation: { width: 450, height: 562 },
          altText: { title: "도 4", description: "BLE 명령 프로토콜 구조", name: "fig4" }
        })
      ]}),
      ...
      // 도 5
      new Paragraph({ spacing: { before: 200, after: 150 }, alignment: AlignmentType.CENTER, children: [
        new TextRun({ text: "【도 5】 AI 응답 파싱 알고리즘 흐름도", bold: true, size: 24 })
      ]}),
      new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 100 }, children: [
        new ImageRun({
          type: "png",
          data: drawings.fig5,
          transformation: { width: 450, height: 562 },
          altText: { title: "도 5", description: "AI 응답 파싱 알고리즘 흐름도", name: "fig5" }
        })
      ]}),
      ...
      // 도 6
      new Paragraph({ spacing: { before: 200, after: 150 }, alignment: AlignmentType.CENTER, children: [
        new TextRun({ text: "【도 6】 하이브리드 AI 아키텍처 (클라우드 + 온디바이스)", bold: true, size: 24 })
      ]}),
      new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 100 }, children: [
        new ImageRun({
          type: "png",
          data: drawings.fig6,
          transformation: { width: 450, height: 562 },
          altText: { title: "도 6", description: "하이브리드 AI 아키텍처", name: "fig6" }
        })
      ]}),
      ...
      // 도 7
      new Paragraph({ spacing: { before: 200, after: 150 }, alignment: AlignmentType.CENTER, children: [
        new TextRun({ text: "【도 7】 온디바이스 AI 처리 상세 흐름도", bold: true, size: 24 })
      ]}),
      new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 100 }, children: [
        new ImageRun({
          type: "png",
          data: drawings.fig7,
          transformation: { width: 450, height: 562 },
          altText: { title: "도 7", description: "온디바이스 AI 처리 상세 흐름도", name: "fig7" }
        })
      ]}),
...
function createInfoTable() {
  ...
  return new Table({
    ...
    rows: [
      ...
      createInfoRow("발명자", "홍 광선", cellBorders),
      createInfoRow("대리인", "(직접 출원)", cellBorders),
      createInfoRow("출원일", "2026년 3월 3일", cellBorders),
...
Packer.toBuffer(doc).then(buffer => {
  fs.writeFileSync("/Users/maeg/todo/today/응원봉/특허/AI_FanStick_특허출원서_도면포함.docx", buffer);
  console.log("특허 출원서 (도면 포함) DOCX 파일 생성 완료!");
  console.log("파일: AI_FanStick_특허출원서_도면포함.docx");
});
