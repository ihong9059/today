...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    private String serverUrl = "http://178.128.90.37:3000";
    private String deviceId = "tablet-001";
        ...
        try {
            ...
            mainHandler.post(() -> {
                if (responseCode == 200 || responseCode == 201) {
                    ...
                    Toast.makeText(this, "Send failed: " + responseCode, Toast.LENGTH_SHORT).show();
                }
            });
        } catch (Exception e) {
            mainHandler.post(() ->
    ...
    public class WebAppInterface {
        ...
        public void setServerUrl(String url) {
            serverUrl = url;
            mainHandler.post(() ->
                Toast.makeText(MainActivity.this, "Server: " + url, Toast.LENGTH_SHORT).show()
            );
        }
        ...
        @JavascriptInterface
        public void sendSensorData(String sensorType, double value, String unit) {
            executor.execute(() -> {
                try {
                    JSONObject json = new JSONObject();
                    json.put("device_id", deviceId);
                    ...
                    sendPost(serverUrl + "/api/sensor", json.toString());
                } catch (Exception e) {
                    e.printStackTrace();
                }
            });
        ...
        @JavascriptInterface
        public void sendFormData(String formType, String data) {
            executor.execute(() -> {
                try {
                    JSONObject json = new JSONObject();
                    json.put("device_id", deviceId);
                    json.put("form_type", formType);
                    json.put("data", new JSONObject(data));

                    sendPost(serverUrl + "/api/form", json.toString());
                    mainHandler.post(() ->
                        Toast.makeText(MainActivity.this, "Form sent!", Toast.LENGTH_SHORT).show()
                    );
                } catch (Exception e) {
                    mainHandler.post(() ->
