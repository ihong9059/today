...
export default function CivilEngineerExamPage() {
  ...
  const writtenSubjects = [
    {
      ...
      difficulty: '상',
      studyPath: '/civil-engineer/study/applied-mechanics'
    },
    {
      id: 2,
      name: '측량학',
      ...
      difficulty: '중',
      studyPath: '/civil-engineer/study/surveying'
    },
    {
      id: 3,
      name: '수리학 및 수문학',
      ...
      difficulty: '상',
      studyPath: '/civil-engineer/study/hydraulics'
    },
    {
      id: 4,
      name: '토질 및 기초',
      ...
      difficulty: '상',
      studyPath: '/civil-engineer/study/soil-mechanics'
    },
    {
      id: 5,
      name: '상하수도공학',
      ...
      difficulty: '중',
      studyPath: '/civil-engineer/study/water-supply'
    }
  ];
  ...
  const practicalInfo = {
    ...
    studyPath: '/civil-engineer/study/practical'
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-teal-50">
      ...
      <div className="bg-gradient-to-r from-teal-600 to-cyan-500 text-white py-12">
        <div className="container mx-auto px-4">
          <Link href="/civil-engineer" className="inline-flex items-center text-white/80 hover:text-white mb-4 transition-colors">
