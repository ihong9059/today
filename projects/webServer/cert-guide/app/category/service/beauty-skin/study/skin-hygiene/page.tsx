...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '소독의 종류를 설명하시오.',
        answer: '자비소독, 자외선소독, 화학소독',
        prompt: `미용사(피부) 위생관리 문제입니다.\n\n문제: 소독의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '일회용품 관리를 설명하시오.',
        answer: '1회 사용 폐기, 재사용 금지',
        prompt: `미용사(피부) 위생관리 문제입니다.\n\n문제: 일회용품 관리를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '화장품 보관을 설명하시오.',
        answer: '직사광선 피함, 서늘한 곳, 밀폐',
        prompt: `미용사(피부) 위생관리 문제입니다.\n\n문제: 화장품 보관을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '감염예방을 설명하시오.',
        answer: '손소독, 도구소독, 청결유지',
        prompt: `미용사(피부) 위생관리 문제입니다.\n\n문제: 감염예방을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '개인위생을 설명하시오.',
        answer: '청결한 복장, 손톱정리, 건강관리',
        prompt: `미용사(피부) 위생관리 문제입니다.\n\n문제: 개인위생을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function SkinhygieneStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('skin-hygiene-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('skin-hygiene-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-rose-600 font-medium">위생관리</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">위생관리 학습</h1>
