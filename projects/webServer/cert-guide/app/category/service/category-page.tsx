    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-6xl mx-auto px-4 py-10">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Link href="/category/service/cook-pufferfish" className="bg-white rounded-xl shadow-md hover:shadow-lg transition-all transform hover:-translate-y-1 overflow-hidden group">
              <div className="bg-gradient-to-r from-rose-500 to-pink-500 p-6 text-center">
                <span className="text-5xl">🐡</span>
              </div>
              <div className="p-4">
            ...
            <Link href="/category/service/confectioner" className="bg-white rounded-xl shadow-md hover:shadow-lg transition-all transform hover:-translate-y-1 overflow-hidden group">
              <div className="bg-gradient-to-r from-rose-500 to-pink-500 p-6 text-center">
                <span className="text-5xl">🍰</span>
              </div>
              <div className="p-4">
            ...
            <Link href="/category/service/hotel-admin" className="bg-white rounded-xl shadow-md hover:shadow-lg transition-all transform hover:-translate-y-1 overflow-hidden group">
              <div className="bg-gradient-to-r from-rose-500 to-pink-500 p-6 text-center">
                <span className="text-5xl">🛎️</span>
              </div>
              <div className="p-4">
