...
export default function AgriMachineEngineerPage() {
  const subjects = [
    { id: 'machine-science', name: '농업기계학', icon: '🚜', desc: '농업기계의 구조와 원리', questions: 50 },
    { id: 'power-engineering', name: '농업동력학', icon: '⚡', desc: '엔진과 동력전달', questions: 50 },
    { id: 'manufacturing', name: '농업기계공작법', icon: '🔧', desc: '가공과 제작', questions: 50 },
    { id: 'design', name: '농업기계설계', icon: '📐', desc: '설계와 재료역학', questions: 50 },
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">농업기계기사</h1>
              <p className="text-gray-600">농업기계 전문기술인력</p>
            </div>
          </div>
          ...
          <Link
            href="/category/agriculture/agri-machine-engineer/exam"
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          ...
          <div className="space-y-3">
            {subjects.map((subject) => (
              <Link
                key={subject.id}
                href={`/category/agriculture/agri-machine-engineer/study/${subject.id}`}
          ...
          <div className="mt-6 p-4 bg-green-50 rounded-xl">
            ...
            <ul className="text-sm text-green-700 space-y-1">
              <li>• 농업기계 구조와 작동원리 이해</li>
              <li>• 내연기관과 동력전달 원리 파악</li>
              <li>• 기계공작법과 가공기술 학습</li>
              <li>• 재료역학과 설계 기초 숙지</li>
            </ul>
          </div>
        </div>
      </div>
