      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">식물보호산업기사</h1>
              <p className="text-gray-600">식물 병해충 방제 기술인력</p>
            </div>
          </div>
          ...
          <Link
            href="/category/agriculture/plant-protection-technician/exam"
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          ...
          <div className="space-y-3">
            {subjects.map((subject) => (
              <Link
                key={subject.id}
                href={`/category/agriculture/plant-protection-technician/study/${subject.id}`}
          ...
          <div className="mt-6 p-4 bg-green-50 rounded-xl">
            ...
            <ul className="text-sm text-green-700 space-y-1">
              <li>• 식물보호기사보다 난이도가 낮은 기초 과목</li>
              <li>• 병해충 식별과 기초 방제법 위주 학습</li>
              <li>• 농약의 안전사용법과 희석 계산 숙지</li>
              <li>• 실기는 실무 중심의 필답형 문제</li>
            </ul>
          </div>
        </div>
      </div>
