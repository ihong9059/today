...
export default function AgriMachineTechnicianExamPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="mb-6">
          <Link href="/category/agriculture/agri-machine-technician" className="text-green-700 hover:text-green-900 flex items-center gap-2">
            ← 농업기계산업기사로 돌아가기
          </Link>
        </div>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="bg-emerald-50 rounded-xl p-4 text-center">
                  ...
                  <p className="text-2xl font-bold text-emerald-800">90분</p>
                </div>
