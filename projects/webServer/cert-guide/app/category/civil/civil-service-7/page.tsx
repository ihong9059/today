...
export default function CivilService7Page() {
  ...
  const selectSubjects = [
    ...
    { id: 'admin-science', name: '행정학', icon: '🏢', desc: '행정이론, 조직론, 정책학', questions: 50 },
    { id: 'economics', name: '경제학', icon: '💹', desc: '미시/거시경제, 재정학', questions: 50 },
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">7급 공채</h1>
              <p className="text-gray-600">국가공무원 7급 공개경쟁채용시험</p>
            </div>
          </div>
          ...
          <Link
            href="/category/civil/civil-service-7/exam"
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
          ...
          <div className="space-y-3">
            {requiredSubjects.map((subject) => (
              <Link
                key={subject.id}
                href={`/category/civil/civil-service-7/study/${subject.id}`}
