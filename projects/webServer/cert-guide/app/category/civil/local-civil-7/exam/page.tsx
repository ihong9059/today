...
export default function LocalCivil7ExamPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="mb-6">
          <Link href="/category/civil/local-civil-7" className="text-emerald-600 hover:text-emerald-800 flex items-center gap-2">
            ← 지방직 7급으로 돌아가기
          </Link>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
          ...
          <div className="flex gap-2 mb-6">
            <button onClick={() => setActiveTab('written')} className={`px-6 py-3 rounded-xl font-medium transition ${activeTab === 'written' ? 'bg-gradient-to-r from-emerald-500 to-teal-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'}`}>필기시험</button>
            <button onClick={() => setActiveTab('interview')} className={`px-6 py-3 rounded-xl font-medium transition ${activeTab === 'interview' ? 'bg-gradient-to-r from-emerald-500 to-teal-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'}`}>면접시험</button>
          </div>
          ...
          {activeTab === 'written' && (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 rounded-xl p-4">
                  <p className="text-sm text-gray-600">행정법, 행정학, 지방자치론, 경제학, 헌법 등에서 2과목 선택 (각 20문항)</p>
                </div>
              </div>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4">
                ...
                <ul className="text-sm text-yellow-700 space-y-1">
                  <li>• 국가직 7급과 동일 난이도, 기출문제 공유</li>
                  <li>• 지방자치론 선택 시 지역 현안 파악 유리</li>
                  <li>• 각 지자체별 커트라인 상이</li>
                  <li>• 시간 관리: 문항당 1분</li>
                </ul>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="bg-teal-50 rounded-xl p-4 text-center">
                  ...
                  <p className="text-2xl font-bold text-teal-800">약 15분</p>
                </div>
                <div className="bg-cyan-50 rounded-xl p-4 text-center">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 rounded-xl p-4">
                  <ul className="text-sm text-gray-600 space-y-2">
                    ...
                    <li>• 전문성: 직무수행에 필요한 지식과 응용능력</li>
                    <li>• 의사표현: 의사표현의 정확성과 논리성</li>
                    <li>• 창의력: 창의적 문제해결 능력</li>
