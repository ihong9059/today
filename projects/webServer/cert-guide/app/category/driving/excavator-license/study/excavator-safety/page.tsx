...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '굴삭기 작업반경 내 안전수칙을 설명하시오.',
        answer: '접근금지구역 설정, 신호수 배치, 경보장치 사용',
        prompt: `굴삭기운전기능사 안전관리 문제입니다.\n\n문제: 굴삭기 작업반경 내 안전수칙을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '전도(전복) 방지대책을 설명하시오.',
        answer: '지반확인, 아웃트리거 설치, 과부하 금지, 급조작 금지',
        prompt: `굴삭기운전기능사 안전관리 문제입니다.\n\n문제: 전도(전복) 방지대책을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '협착재해 예방을 설명하시오.',
        answer: '끼임방지 덮개, 접근금지, 록아웃/태그아웃',
        prompt: `굴삭기운전기능사 안전관리 문제입니다.\n\n문제: 협착재해 예방을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '지하매설물 확인방법을 설명하시오.',
        answer: '사전탐사, 관계기관 확인, 시굴작업, 안전이격거리',
        prompt: `굴삭기운전기능사 안전관리 문제입니다.\n\n문제: 지하매설물 확인방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '야간작업 안전수칙을 설명하시오.',
        answer: '조명확보, 경광등 작동, 신호수 배치, 반사조끼 착용',
        prompt: `굴삭기운전기능사 안전관리 문제입니다.\n\n문제: 야간작업 안전수칙을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function ExcavatorsafetyStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('excavator-safety-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('excavator-safety-progress', JSON.stringify(newCompleted));
  };
