...
export default function DrivingCategoryPage() {
  const certifications: {
    ...
    },
    {
      ...
      subjects: ['항공법규', '항공기상', '비행이론', '항법'],
      hasStudyPage: true,
      href: '/category/driving/pilot-license-private',
    },
    {
      id: 'pilot-license-commercial',
      name: '사업용조종사',
      englishName: 'Commercial Pilot License',
      icon: '🛫',
      color: 'from-amber-500 to-orange-600',
      difficulty: 4,
      description: '유상 항공운송 조종자격 (200시간+)',
      subjects: ['항공법규', '항공기상', '비행이론', '항법'],
      hasStudyPage: true,
      href: '/category/driving/pilot-license-commercial',
    },
    {
      id: 'pilot-license-airline',
      name: '운송용조종사',
      englishName: 'Airline Transport Pilot License',
      icon: '🛩️',
      color: 'from-slate-600 to-gray-800',
      difficulty: 5,
      description: '대형항공기 기장 자격 (1,500시간+)',
      subjects: ['항공법규', '항공기상', '비행이론', '항법'],
      hasStudyPage: true,
      href: '/category/driving/pilot-license-airline',
    },
    {
      id: 'light-sport-pilot',
      name: '경량항공기조종사',
      englishName: 'Light Sport Aircraft Pilot',
      icon: '🪂',
      color: 'from-cyan-500 to-teal-600',
      difficulty: 3,
      description: '경량항공기 조종자격 (20시간+)',
      subjects: ['항공법규', '항공기상', '비행이론', '항법'],
      hasStudyPage: true,
