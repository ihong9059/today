...
export default function MechanicalCategoryPage() {
  const certifications: {
    ...
    },
    {
      ...
      hasStudyPage: true,
      href: '/category/mechanical/mechanical-craftsman',
    },
    {
    ...
    },
    {
      ...
      color: 'from-amber-500 to-yellow-500',
      difficulty: 4,
      description: '전기공사 설계, 감리, 시공 전문 기술자',
      subjects: ['전기응용', '전기설비기술기준', '전기기기', '배전설비'],
      hasStudyPage: true,
      href: '/category/mechanical/electrical-work-engineer',
    },
    {
      ...
      hasStudyPage: true,
      href: '/category/mechanical/electrician-technician',
    },
    {
      ...
      hasStudyPage: true,
      href: '/category/mechanical/electric-craftsman',
    },
    {
      id: 'control-engineer',
      name: '제어계측기사',
      ...
      hasStudyPage: true,
      href: '/category/mechanical/control-engineer',
    },
    {
      id: 'welding-engineer',
      name: '용접기사',
      ...
      hasStudyPage: true,
      href: '/category/mechanical/welding-engineer',
    },
    {
      id: 'excavator-operator',
      name: '굴삭기운전기능사',
      englishName: 'Craftsman Excavator Operation',
      icon: '🏗️',
      color: 'from-amber-600 to-orange-600',
      difficulty: 2,
      description: '건설현장 필수, 굴삭기 조종 전문 기능사',
      subjects: ['굴삭기조종', '건설기계일반', '안전관리', '실기'],
      hasStudyPage: true,
      href: '/category/mechanical/excavator-operator',
    },
    {
      id: 'forklift-operator',
      name: '지게차운전기능사',
      englishName: 'Craftsman Forklift Operation',
      icon: '🚜',
      color: 'from-yellow-500 to-amber-600',
      difficulty: 2,
      description: '물류창고 필수, 화물운반 전문 기능사',
      subjects: ['지게차조종', '건설기계일반', '안전관리', '실기'],
      hasStudyPage: true,
      href: '/category/mechanical/forklift-operator',
    },
    {
      id: 'crane-operator',
      name: '기중기운전기능사',
      englishName: 'Craftsman Crane Operation',
      icon: '🏗️',
      color: 'from-blue-600 to-indigo-600',
      difficulty: 2,
      description: '건설현장 필수, 크레인 조종 전문 기능사',
      subjects: ['기중기조종', '건설기계일반', '안전관리', '실기'],
      hasStudyPage: true,
      href: '/category/mechanical/crane-operator',
    },
    {
      id: 'solar-power-engineer',
      name: '태양광발전설비기사',
      englishName: 'Engineer Solar Photovoltaic Power',
      icon: '☀️',
      color: 'from-yellow-500 to-orange-500',
      difficulty: 4,
      description: '태양광 발전시스템 설계, 시공, 운영 전문가',
      subjects: ['태양광발전시스템 이론', '전력계통', '설계', '시공', '법규'],
      hasStudyPage: true,
      href: '/category/mechanical/solar-power-engineer',
    },
    {
      id: 'wind-power-engineer',
      name: '풍력발전설비기사',
      englishName: 'Engineer Wind Power',
      icon: '🌪️',
      color: 'from-cyan-500 to-teal-500',
      difficulty: 4,
      description: '풍력 발전시스템 설계, 시공, 운영 전문가',
      subjects: ['풍력발전시스템 이론', '전력계통', '설계', '시공', '법규'],
      hasStudyPage: true,
      href: '/category/mechanical/wind-power-engineer',
    },
