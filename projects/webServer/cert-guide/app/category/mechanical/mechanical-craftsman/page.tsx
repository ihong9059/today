    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                <h1 className="text-3xl font-bold">기계산업기사</h1>
                <span className="bg-white/20 px-3 py-1 rounded-full text-sm">국가기술자격</span>
              </div>
              <p className="text-amber-100 text-lg mb-4">Industrial Engineer Mechanical</p>
      ...
      <section className="max-w-6xl mx-auto px-4 -mt-6">
        <div className="grid md:grid-cols-4 gap-4">
          <a href="/category/mechanical/mechanical-craftsman/exam" className="bg-white rounded-xl shadow-md p-4 text-center hover:shadow-lg hover:border-amber-300 border-2 border-transparent transition cursor-pointer">
            <span className="text-2xl">📝</span>
            ...
            <p className="text-xs text-amber-500 mt-2 font-medium">상세보기 →</p>
          </a>
          <a href="/category/mechanical/mechanical-craftsman/exam?tab=practical" className="bg-white rounded-xl shadow-md p-4 text-center hover:shadow-lg hover:border-amber-300 border-2 border-transparent transition cursor-pointer">
          ...
          <div className="bg-white rounded-xl shadow-md p-4 text-center">
            ...
            <p className="text-xs text-gray-400">실기 36,200원</p>
          </div>
          <div className="bg-white rounded-xl shadow-md p-4 text-center">
            <span className="text-2xl">🏢</span>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white rounded-xl shadow-md p-6">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                기계산업기사는 기계 분야의 중급 기술인력으로서, 기계 제도, 설계, 가공 등의
                실무 업무를 수행하는 국가기술자격입니다. 기계기사의 전 단계 자격증입니다.
              </p>
            ...
            <section className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="space-y-3">
                {[
                  { name: '기계제도', difficulty: 2, tip: '도면 기호, 치수 기입법' },
                  { name: '기계재료', difficulty: 3, tip: '금속재료, 열처리' },
                  { name: '기계설계', difficulty: 4, tip: '기계요소 설계, 계산' },
                  { name: '기계제작법', difficulty: 3, tip: '가공법, 공작기계' },
                ].map((subject, i) => (
            ...
            <section className="bg-white rounded-xl shadow-md p-6">
              <h2 className="text-xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                <span className="text-amber-500">✍️</span> 실기시험 구성
              </h2>
              <div className="mb-4">
                <div className="flex items-center gap-2 mb-2">
                  <span className="font-semibold text-gray-800">기계장치 제작 및 정비</span>
                  <span className="text-sm text-gray-500">(필답형 + 작업형)</span>
                </div>
              </div>
              <div className="grid md:grid-cols-2 gap-3">
                {[
                  { name: '필답형', ratio: '약 40%', desc: '계산 문제, 이론 서술' },
                  { name: '작업형 (CAD)', ratio: '약 60%', desc: '2D 도면 작성' },
                  { name: '도면 해독', ratio: '필수', desc: '부품도, 조립도 해석' },
                  { name: '치수/공차', ratio: '필수', desc: '치수 기입, 끼워맞춤' },
                ].map((item, i) => (
                  <div key={i} className="p-3 border rounded-lg">
                    <div className="flex justify-between items-center mb-1">
                      <span className="font-medium text-gray-800">{item.name}</span>
                      <span className="text-amber-600 font-bold">{item.ratio}</span>
                    </div>
            ...
            <section className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="border-2 border-amber-200 rounded-xl p-4">
                  <h3 className="font-bold text-amber-600 mb-3">👨‍🎓 비전공자 (4개월)</h3>
                  <div className="space-y-2">
                    {[
                      { step: 1, name: '기계제도', period: '1개월', note: '기초!' },
                      { step: 2, name: '기계재료', period: '3주', note: '암기' },
                      { step: 3, name: '기계설계', period: '1.5개월', note: '핵심!' },
                      { step: 4, name: '기계제작법', period: '3주', note: '마무리' },
                    ].map((item) => (
                      <div key={item.step} className="flex items-center gap-3">
                        ...
                        {item.note && <span className="text-xs bg-amber-100 text-amber-600 px-2 py-0.5 rounded">{item.note}</span>}
                      </div>
                    ))}
                  </div>
                </div>
                <div className="border-2 border-green-200 rounded-xl p-4">
                  ...
                  <div className="space-y-2">
                    {[
                      { step: 1, name: '기계제도 + 재료', period: '3주', note: '복습' },
                      { step: 2, name: '기계설계', period: '3주', note: '심화' },
                      { step: 3, name: '기계제작법', period: '1주', note: '암기' },
                      { step: 4, name: '기출문제 5회독', period: '1주', note: '마무리' },
                    ].map((item) => (
                      <div key={item.step} className="flex items-center gap-3">
            ...
            <section className="bg-gradient-to-r from-purple-500 to-indigo-500 rounded-xl shadow-md p-6 text-white">
              ...
              <p className="text-purple-100 mb-4">Claude AI에게 기계산업기사 관련 질문을 해보세요!</p>
              <div className="space-y-3">
                <div className="bg-white/10 rounded-lg p-3">
                  <p className="text-sm text-purple-200 mb-1">개념 질문</p>
                  <p className="text-white">&quot;끼워맞춤의 종류와 적용 예를 설명해줘&quot;</p>
                </div>
                <div className="bg-white/10 rounded-lg p-3">
                  <p className="text-sm text-purple-200 mb-1">문제 풀이</p>
                  <p className="text-white">&quot;기어 모듈 계산 문제 3개 만들어줘&quot;</p>
                </div>
                <div className="bg-white/10 rounded-lg p-3">
                  <p className="text-sm text-purple-200 mb-1">암기 도우미</p>
                  <p className="text-white">&quot;열처리 종류와 목적 정리해줘&quot;</p>
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-md p-5">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={item.round} className="border-l-4 border-amber-400 pl-3">
              ...
              <a href="https://www.q-net.or.kr" target="_blank" rel="noopener noreferrer"
                className="mt-4 block text-center text-sm text-amber-600 hover:underline">
                Q-Net에서 접수하기 →
              </a>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-5">
              ...
              <div className="space-y-3">
                {[
                  { name: '기계제도', target: 75, color: 'bg-blue-500' },
                  { name: '기계재료', target: 70, color: 'bg-green-500' },
                  { name: '기계설계', target: 55, color: 'bg-amber-500' },
                  { name: '기계제작법', target: 70, color: 'bg-emerald-500' },
                ].map((item) => (
                  <div key={item.name}>
              ...
              <div className="mt-4 p-3 bg-amber-50 rounded-lg text-center">
                ...
                <p className="text-2xl font-bold text-amber-600">68점</p>
            ...
            <div className="bg-white rounded-xl shadow-md p-5">
              ...
              <div className="space-y-2">
                {[
                  { name: '기계기사', desc: '상위 자격증' },
                  { name: '일반기계기사', desc: '범용 설계' },
                  { name: '전산응용기계제도기능사', desc: 'CAD 전문' },
                  { name: '컴퓨터응용가공산업기사', desc: 'CAM 전문' },
                ].map((item) => (
                  <a key={item.name} href="#" className="block p-3 bg-gray-50 rounded-lg hover:bg-amber-50 transition">
            ...
            <div className="bg-white rounded-xl shadow-md p-5">
              <h3 className="font-bold text-gray-800 mb-4 flex items-center gap-2">
                <span className="text-amber-500">📖</span> 추천 교재/인강
              </h3>
              <div className="space-y-3">
                <a href="https://www.eduwill.net" target="_blank" rel="noopener noreferrer"
                  className="block p-3 border rounded-lg hover:border-amber-400 transition">
                ...
                <a href="https://www.inup.co.kr" target="_blank" rel="noopener noreferrer"
                  className="block p-3 border rounded-lg hover:border-amber-400 transition">
                  <p className="font-medium text-gray-800">인업</p>
                  <p className="text-xs text-gray-500">기계 전문 인강</p>
                </a>
              </div>
            </div>
          </div>
