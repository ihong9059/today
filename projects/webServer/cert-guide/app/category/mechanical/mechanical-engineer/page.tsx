    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <a href="/category/mechanical" className="text-gray-600 hover:text-blue-600">기계·제어</a>
            <span className="text-gray-300">›</span>
            <span className="text-blue-600 font-medium">기계기사</span>
          </nav>
        </div>
      </header>
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                <h1 className="text-3xl font-bold">기계기사</h1>
                <span className="bg-white/20 px-3 py-1 rounded-full text-sm">국가기술자격</span>
              </div>
              <p className="text-blue-100 text-lg mb-4">Engineer Machinery</p>
      ...
      <section className="max-w-6xl mx-auto px-4 -mt-6">
        <div className="grid md:grid-cols-4 gap-4">
          <a href="/category/mechanical/mechanical-engineer/exam" className="bg-white rounded-xl shadow-md p-4 text-center hover:shadow-lg hover:border-blue-300 border-2 border-transparent transition cursor-pointer">
            <span className="text-2xl">📝</span>
          ...
          <div className="bg-white rounded-xl shadow-md p-4 text-center">
            ...
            <p className="text-xs text-gray-400">실기 46,900원</p>
          </div>
          <div className="bg-white rounded-xl shadow-md p-4 text-center">
            <span className="text-2xl">🏢</span>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white rounded-xl shadow-md p-6">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                기계기사는 기계 분야에 관한 고도의 전문지식과 기술을 갖추고, 기계설비의 설계, 제작,
                생산관리, 품질관리 등의 업무를 수행하는 국가기술자격입니다.
              </p>
            ...
            <section className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="space-y-3">
                {[
                  { name: '재료역학', difficulty: 4, tip: '계산 많음, 공식 암기 필수' },
                  { name: '열역학', difficulty: 4, tip: '사이클 문제 반복 출제' },
                  { name: '유체역학', difficulty: 3, tip: '베르누이 방정식 중요' },
                  { name: '기계제작법 및 기계동력학', difficulty: 3, tip: '암기 위주, 고득점 가능' },
                  { name: '기계설계 및 기계재료', difficulty: 3, tip: '설계 공식, 재료 특성' },
                ].map((subject, i) => (
            ...
            <section className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="mb-4">
                <div className="flex items-center gap-2 mb-2">
                  <span className="font-semibold text-gray-800">기계장치 설계·제도 및 설비관리</span>
                  <span className="text-sm text-gray-500">(필답형 + 작업형)</span>
                </div>
              </div>
              <div className="grid md:grid-cols-2 gap-3">
                {[
                  { name: '필답형', ratio: '약 50%', desc: '설계 계산, 이론 문제' },
                  { name: '작업형 (CAD)', ratio: '약 50%', desc: '2D/3D 도면 작성' },
                  { name: '재료역학 계산', ratio: '필수', desc: '응력, 변형률, 단면계수' },
                  { name: '기계설계', ratio: '필수', desc: '축, 베어링, 기어 설계' },
                ].map((item, i) => (
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="border-2 border-blue-200 rounded-xl p-4">
                  ...
                  <div className="space-y-2">
                    {[
                      { step: 1, name: '재료역학', period: '2개월', note: '핵심!' },
                      { step: 2, name: '열역학', period: '1개월', note: '' },
                      { step: 3, name: '유체역학', period: '1개월', note: '' },
                      { step: 4, name: '기계제작법/동력학', period: '1개월', note: '암기' },
                      { step: 5, name: '기계설계/재료', period: '1개월', note: '마무리' },
                    ].map((item) => (
                ...
                <div className="border-2 border-green-200 rounded-xl p-4">
                  ...
                  <div className="space-y-2">
                    {[
                      { step: 1, name: '재료역학 + 열역학', period: '1개월', note: '복습' },
                      { step: 2, name: '유체역학 + 동력학', period: '1개월', note: '심화' },
                      { step: 3, name: '기계설계/재료', period: '2주', note: '암기' },
            ...
            <section className="bg-gradient-to-r from-purple-500 to-indigo-500 rounded-xl shadow-md p-6 text-white">
              ...
              <p className="text-purple-100 mb-4">Claude AI에게 기계기사 관련 질문을 해보세요!</p>
              <div className="space-y-3">
                <div className="bg-white/10 rounded-lg p-3">
                  <p className="text-sm text-purple-200 mb-1">개념 질문</p>
                  <p className="text-white">&quot;재료역학에서 모어의 응력원을 쉽게 설명해줘&quot;</p>
                </div>
                <div className="bg-white/10 rounded-lg p-3">
                  <p className="text-sm text-purple-200 mb-1">문제 풀이</p>
                  <p className="text-white">&quot;카르노 사이클 효율 계산 문제 3개 만들어줘&quot;</p>
                </div>
                <div className="bg-white/10 rounded-lg p-3">
                  <p className="text-sm text-purple-200 mb-1">암기 도우미</p>
                  <p className="text-white">&quot;기계재료 열처리 종류와 특징 정리해줘&quot;</p>
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-md p-5">
              ...
              <div className="space-y-3">
                {[
                  { name: '재료역학', target: 65, color: 'bg-blue-500' },
                  { name: '열역학', target: 60, color: 'bg-cyan-500' },
                  { name: '유체역학', target: 70, color: 'bg-green-500' },
                  { name: '기계제작법/동력학', target: 75, color: 'bg-emerald-500' },
                  { name: '기계설계/재료', target: 70, color: 'bg-teal-500' },
                ].map((item) => (
                  <div key={item.name}>
              ...
              <div className="mt-4 p-3 bg-blue-50 rounded-lg text-center">
                ...
                <p className="text-2xl font-bold text-blue-600">68점</p>
            ...
            <div className="bg-white rounded-xl shadow-md p-5">
              ...
              <div className="space-y-2">
                {[
                  { name: '기계산업기사', desc: '중급 자격증' },
                  { name: '일반기계기사', desc: '범용 설계' },
                  { name: '건설기계기사', desc: '건설 분야' },
                  { name: '기계기술사', desc: '최고급 자격' },
                ].map((item) => (
