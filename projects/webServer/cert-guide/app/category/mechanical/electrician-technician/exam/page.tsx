  ...
  const writtenSubjects = [
    {
      ...
      href: '/category/mechanical/electrician-technician/study/electrical-theory',
    },
    {
      name: '전기기기',
      weight: '33%',
      ...
      href: '/category/mechanical/electrician-technician/study/electrical-machine',
    },
    {
      name: '전기설비',
      weight: '34%',
      ...
      href: '/category/mechanical/electrician-technician/study/electrical-installation',
    },
  ];
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <Link href="/category/mechanical" className="hover:text-yellow-600">기계·전기분야</Link>
            <span>/</span>
            <Link href="/category/mechanical/electrician-technician" className="hover:text-yellow-600">전기기능사</Link>
            <span>/</span>
        ...
        {activeTab === 'practical' && (
          <div className="space-y-6">
            ...
            <div className="flex justify-center">
              <Link
                href="/category/mechanical/electrician-technician/study/practical"
