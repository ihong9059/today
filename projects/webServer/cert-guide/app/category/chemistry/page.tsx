  ...
  const certifications = [
    {
      ...
      name: '화공기사',
      englishName: 'Chemical Engineer',
      icon: '🏭',
      color: 'from-orange-500 to-red-600',
      difficulty: 4,
      description: '화학공정 설계 및 운영 전문 기술자',
      subjects: ['화공열역학', '단위조작', '반응공학', '공정제어', '화학공장설계'],
      hasStudyPage: true,
      href: '/category/chemistry/chemical-engineer',
    },
    {
      id: 'chemical-analyst',
      name: '화학분석기사',
    ...
    },
    {
      ...
      subjects: ['환경공학개론', '대기오염방지', '수질오염방지', '폐기물처리', '소음진동'],
      hasStudyPage: true,
    ...
    },
    {
      ...
      subjects: ['대기오염개론', '연소공학', '대기오염방지기술', '대기오염공정시험기준'],
      hasStudyPage: true,
    ...
    },
    {
      ...
      subjects: ['수질오염개론', '상하수도계획', '수질오염방지기술', '수질오염공정시험기준'],
      hasStudyPage: true,
