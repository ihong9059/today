...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '정규화의 목적을 설명하시오.',
        answer: '데이터 중복 최소화, 무결성 확보',
        prompt: `컴퓨터활용능력 1급 데이터베이스 문제입니다.\n\n문제: 정규화의 목적을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '관계 설정을 설명하시오.',
        answer: '1:1, 1:N, N:M, 기본키-외래키 연결',
        prompt: `컴퓨터활용능력 1급 데이터베이스 문제입니다.\n\n문제: 관계 설정을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'SQL SELECT문을 설명하시오.',
        answer: 'SELECT 필드 FROM 테이블 WHERE 조건',
        prompt: `컴퓨터활용능력 1급 데이터베이스 문제입니다.\n\n문제: SQL SELECT문을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '쿼리의 종류를 설명하시오.',
        answer: '선택, 매개변수, 실행(추가/삭제/업데이트)',
        prompt: `컴퓨터활용능력 1급 데이터베이스 문제입니다.\n\n문제: 쿼리의 종류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '보고서 작성을 설명하시오.',
        answer: '데이터 출력 형식, 그룹화/정렬/요약',
        prompt: `컴퓨터활용능력 1급 데이터베이스 문제입니다.\n\n문제: 보고서 작성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: '개체-관계 모델을 설명하시오.',
        answer: 'E-R 다이어그램, 개체/속성/관계 표현',
        prompt: `컴퓨터활용능력 1급 데이터베이스 문제입니다.\n\n문제: 개체-관계 모델을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '기본키와 외래키를 설명하시오.',
        answer: '기본키: 고유식별, 외래키: 다른 테이블 참조',
        prompt: `컴퓨터활용능력 1급 데이터베이스 문제입니다.\n\n문제: 기본키와 외래키를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '인덱스의 역할을 설명하시오.',
        answer: '검색 속도 향상, B-트리 구조',
        prompt: `컴퓨터활용능력 1급 데이터베이스 문제입니다.\n\n문제: 인덱스의 역할을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '트랜잭션을 설명하시오.',
        answer: '작업 단위, ACID 특성 보장',
        prompt: `컴퓨터활용능력 1급 데이터베이스 문제입니다.\n\n문제: 트랜잭션을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '무결성 제약조건을 설명하시오.',
        answer: '개체/참조/도메인 무결성',
        prompt: `컴퓨터활용능력 1급 데이터베이스 문제입니다.\n\n문제: 무결성 제약조건을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function Database1StudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('database-1-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('database-1-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">데이터베이스</span>
          </nav>
        </div>
      </header>
