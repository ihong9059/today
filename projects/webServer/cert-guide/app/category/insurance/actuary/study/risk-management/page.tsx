    ...
    questions: [
      {
        id: 1,
        question: '보험리스크의 종류는?',
        answer: '언더라이팅리스크, 가격리스크, 지급준비금리스크 등이 있습니다.',
        prompt: `보험회사가 직면하는 주요 리스크의 종류와 특성을 설명해주세요.`
      },      {
        id: 2,
        question: '지급여력(Solvency) 제도란?',
        answer: '보험회사의 재무건전성을 평가하는 지표로, 지급여력비율로 측정합니다.',
        prompt: `보험회사 지급여력제도의 의의와 산출 방법을 설명해주세요.`
      },      {
        id: 3,
        question: 'K-ICS 제도의 특징은?',
        answer: 'IFRS17 기반 새로운 지급여력제도로, 시가평가를 적용합니다.',
        prompt: `K-ICS(신지급여력제도)의 주요 특징과 기존 제도와의 차이를 설명해주세요.`
      },      {
        id: 4,
        question: 'ALM(자산부채관리)이란?',
        answer: '자산과 부채의 듀레이션을 일치시켜 금리리스크를 관리합니다.',
        prompt: `보험회사 ALM의 개념과 관리 방법을 설명해주세요.`
      },      {
        id: 5,
        question: '재보험의 역할은?',
        answer: '리스크 분산, 인수능력 확대, 자본효율성 제고 등의 역할을 합니다.',
        prompt: `재보험의 종류와 보험회사 리스크관리에서의 역할을 설명해주세요.`
      }
    ]
  }
];
...
export default function StudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('risk-management-progress');
  ...
  const toggleQuestion = (questionId: string) => {
    ...
    localStorage.setItem('risk-management-progress', JSON.stringify(updated));
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-cyan-50">
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-cyan-600 font-medium">리스크관리</span>
          </nav>
        </div>
      </header>
      ...
      <section className="bg-gradient-to-r from-cyan-500 to-teal-500 text-white py-8">
        <div className="max-w-4xl mx-auto px-4">
          <h1 className="text-2xl font-bold mb-2">리스크관리</h1>
          <p className="text-cyan-100">보험계리사 - 리스크관리 학습</p>
