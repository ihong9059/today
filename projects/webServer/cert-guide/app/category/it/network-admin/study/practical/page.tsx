...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '라우터 기본 설정 명령어를 나열하시오.',
        answer: 'enable, configure terminal, hostname, interface',
        prompt: `네트워크관리사 실기 문제입니다.\n\n문제: 라우터 기본 설정 명령어를 나열하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'OSPF 설정 명령어를 설명하시오.',
        answer: 'router ospf, network, area',
        prompt: `네트워크관리사 실기 문제입니다.\n\n문제: OSPF 설정 명령어를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'ACL 설정 방법을 설명하시오.',
        answer: 'access-list, permit/deny, ip access-group',
        prompt: `네트워크관리사 실기 문제입니다.\n\n문제: ACL 설정 방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 4,
        question: 'NAT 설정 방법을 설명하시오.',
        answer: 'ip nat inside/outside, pool, overload',
        prompt: `네트워크관리사 실기 문제입니다.\n\n문제: NAT 설정 방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      },{
        id: 5,
        question: 'VLAN 설정 명령어를 설명하시오.',
        answer: 'vlan, switchport access/trunk, allowed vlan',
        prompt: `네트워크관리사 실기 문제입니다.\n\n문제: VLAN 설정 명령어를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 공식\n5. 연습문제 3개`
      }
    ]
  }
];
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-blue-600 font-medium">실기</span>
          </nav>
        </div>
      </header>
