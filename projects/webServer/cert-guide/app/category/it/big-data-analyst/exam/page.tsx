  ...
  const writtenSubjects = [
    {
      ...
      studyLink: '/category/it/big-data-analyst/study/planning'
    },
    {
      name: '빅데이터 탐색',
      questions: 20,
      ...
      studyLink: '/category/it/big-data-analyst/study/exploration'
    },
    {
      name: '빅데이터 모델링',
      questions: 20,
      ...
      studyLink: '/category/it/big-data-analyst/study/modeling'
    },
    {
      name: '빅데이터 결과 해석',
      questions: 20,
      ...
      studyLink: '/category/it/big-data-analyst/study/interpretation'
    }
  ];
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="bg-amber-50 px-3 py-1 rounded-lg">
                        ...
                        {subject.studyLink && (
                          <a href={subject.studyLink} className="inline-flex items-center gap-2 mt-3 px-4 py-2 bg-cyan-500 hover:bg-cyan-600 text-white rounded-lg transition text-sm font-medium">
                            📚 {subject.name} 학습하기 →
                          </a>
                        )}
                      </div>
