...
export default function CreditanalystMainPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-teal-600 font-medium">신용분석사</span>
          </nav>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        <div className="text-center mb-12">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">신용분석사</h1>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          {subjects.map((subject) => (
            <Link
              key={subject.id}
              href={`/category/finance/credit-analyst/study/${subject.id}`}
