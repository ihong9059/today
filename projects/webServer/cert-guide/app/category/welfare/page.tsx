...
{      id: 'social-worker-2',      name: '사회복지사 2급',      englishName: 'Social Worker Level 2',      icon: '💝',      color: 'from-pink-500 to-rose-500',      difficulty: 2,      description: '학점이수를 통해 취득하는 사회복지 자격증',      subjects: ['사회복지개론', '인간행동과사회환경', '사회복지실천론', '지역사회복지론', '사회복지법제'],      hasStudyPage: true,      href: '/category/welfare/social-worker-2',    },
    {
