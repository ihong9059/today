...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '청소년 하위문화를 설명하시오.',
        answer: '또래문화, 디지털문화, 소비문화, 저항문화',
        prompt: `청소년상담사 3급 청소년문화 문제입니다.\n\n문제: 청소년 하위문화를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '청소년 미디어 이용 특성을 설명하시오.',
        answer: '스마트폰 과의존, SNS, 게임, 유튜브',
        prompt: `청소년상담사 3급 청소년문화 문제입니다.\n\n문제: 청소년 미디어 이용 특성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '학교부적응의 유형을 설명하시오.',
        answer: '학업부적응, 교우관계, 학교폭력, 등교거부',
        prompt: `청소년상담사 3급 청소년문화 문제입니다.\n\n문제: 학교부적응의 유형을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '청소년 비행의 원인을 설명하시오.',
        answer: '개인요인, 가정요인, 학교요인, 사회요인',
        prompt: `청소년상담사 3급 청소년문화 문제입니다.\n\n문제: 청소년 비행의 원인을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '청소년 복지서비스를 설명하시오.',
        answer: '청소년수련관, 쉼터, 상담복지센터, 학교밖센터',
        prompt: `청소년상담사 3급 청소년문화 문제입니다.\n\n문제: 청소년 복지서비스를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
...
export default function YouthcultureStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('youth-culture-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('youth-culture-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">청소년문화</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">청소년문화 학습</h1>
