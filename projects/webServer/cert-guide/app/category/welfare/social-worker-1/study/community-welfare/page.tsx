...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '로스만의 지역사회복지 실천모델 3가지를 설명하시오.',
        answer: '지역사회개발, 사회계획, 사회행동',
        prompt: `사회복지사 1급 지역사회복지론 문제입니다.\n\n문제: 로스만의 지역사회복지 실천모델 3가지를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '지역사회복지관의 기능과 사업을 설명하시오.',
        answer: '사례관리, 서비스제공, 지역조직화, 자원개발',
        prompt: `사회복지사 1급 지역사회복지론 문제입니다.\n\n문제: 지역사회복지관의 기능과 사업을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '사회복지협의회의 역할을 설명하시오.',
        answer: '연락조정, 조사연구, 기관간 협력, 지역복지 증진',
        prompt: `사회복지사 1급 지역사회복지론 문제입니다.\n\n문제: 사회복지협의회의 역할을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '주민조직화의 원칙과 방법을 설명하시오.',
        answer: '주민참여, 역량강화, 지도력 개발, 네트워크 구축',
        prompt: `사회복지사 1급 지역사회복지론 문제입니다.\n\n문제: 주민조직화의 원칙과 방법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '지역사회보장계획의 내용을 설명하시오.',
        answer: '4년 단위 수립, 지역복지 자원조사, 서비스 연계체계 구축',
        prompt: `사회복지사 1급 지역사회복지론 문제입니다.\n\n문제: 지역사회보장계획의 내용을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
];
...
export default function CommunitywelfareStudyPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('community-welfare-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('community-welfare-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">지역사회복지론</span>
          </nav>
        </div>
      </header>
