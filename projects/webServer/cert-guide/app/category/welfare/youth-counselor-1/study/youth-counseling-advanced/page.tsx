...
const topics = [
  {
    id: 'advanced-counseling',
    name: '상담심화이론',
    color: 'from-violet-500 to-purple-600',
    questions: [
      {
        id: 1,
        question: '상담수퍼비전의 모델을 설명하시오.',
        answer: '발달모델, 역할모델, 통합모델, 동료수퍼비전',
        prompt: `청소년상담사 1급 청소년상담 심화 문제입니다.\n\n문제: 상담수퍼비전의 모델을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 2,
        question: '상담자 윤리강령의 내용을 설명하시오.',
        answer: '비밀보장, 다중관계 금지, 전문성 유지, 내담자 권리',
        prompt: `청소년상담사 1급 청소년상담 심화 문제입니다.\n\n문제: 상담자 윤리강령의 내용을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 3,
        question: '위기개입 상담의 원칙을 설명하시오.',
        answer: '즉각성, 단기집중, 안전확보, 자원연계',
        prompt: `청소년상담사 1급 청소년상담 심화 문제입니다.\n\n문제: 위기개입 상담의 원칙을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 4,
        question: '다문화 청소년상담의 특성을 설명하시오.',
        answer: '문화적 감수성, 언어장벽, 정체성혼란, 가족갈등',
        prompt: `청소년상담사 1급 청소년상담 심화 문제입니다.\n\n문제: 다문화 청소년상담의 특성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      },{
        id: 5,
        question: '청소년 자살예방 상담전략을 설명하시오.',
        answer: '위험요인 사정, 안전계획, 보호요인 강화, 연계',
        prompt: `청소년상담사 1급 청소년상담 심화 문제입니다.\n\n문제: 청소년 자살예방 상담전략을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 관련 이론\n5. 연습문제 3개`
      }
    ]
  }
];

export default function YouthcounselingadvancedStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('youth-counseling-advanced-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('youth-counseling-advanced-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <Link href="/category/welfare/youth-counselor-1" className="text-gray-600 hover:text-violet-600">청소년상담사 1급</Link>
            <span className="text-gray-300">›</span>
            <span className="text-violet-600 font-medium">청소년상담 심화</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">청소년상담 심화 학습</h1>
                <p className="text-violet-100">청소년상담사 1급</p>
              </div>
            </div>
