...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '물류의 정의를 설명하시오.',
        answer: '물자 흐름의 계획/실행/통제',
        prompt: `물류관리사 물류관리론 문제입니다.\n\n문제: 물류의 정의를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: '물류의 5대 기능을 설명하시오.',
        answer: '운송, 보관, 하역, 포장, 정보',
        prompt: `물류관리사 물류관리론 문제입니다.\n\n문제: 물류의 5대 기능을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: '물류비 구성을 설명하시오.',
        answer: '운송비, 보관비, 하역비, 포장비, 정보비',
        prompt: `물류관리사 물류관리론 문제입니다.\n\n문제: 물류비 구성을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '물류합리화를 설명하시오.',
        answer: '표준화, 공동화, 정보화, 자동화',
        prompt: `물류관리사 물류관리론 문제입니다.\n\n문제: 물류합리화를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '물류아웃소싱을 설명하시오.',
        answer: '전문업체 위탁, 핵심역량 집중',
        prompt: `물류관리사 물류관리론 문제입니다.\n\n문제: 물류아웃소싱을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    ...
    questions: [
      {
        id: 1,
        question: 'SCM의 구성요소를 설명하시오.',
        answer: '계획, 조달, 생산, 배송, 반품',
        prompt: `물류관리사 물류관리론 문제입니다.\n\n문제: SCM의 구성요소를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'Push와 Pull 시스템을 설명하시오.',
        answer: 'Push: 예측생산, Pull: 주문생산',
        prompt: `물류관리사 물류관리론 문제입니다.\n\n문제: Push와 Pull 시스템을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'JIT를 설명하시오.',
        answer: '적시생산, 재고최소화, 낭비제거',
        prompt: `물류관리사 물류관리론 문제입니다.\n\n문제: JIT를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: '린 물류를 설명하시오.',
        answer: '7대 낭비 제거, 가치흐름 최적화',
        prompt: `물류관리사 물류관리론 문제입니다.\n\n문제: 린 물류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: '그린물류를 설명하시오.',
        answer: '환경친화적 물류, 탄소배출 감소',
        prompt: `물류관리사 물류관리론 문제입니다.\n\n문제: 그린물류를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
...
export default function LogisticstheoryStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('logistics-theory-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('logistics-theory-progress', JSON.stringify(newCompleted));
  };
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-300">›</span>
            <span className="text-teal-600 font-medium">물류관리론</span>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">물류관리론 학습</h1>
