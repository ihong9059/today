...
const topics = [
  {
    ...
    questions: [
      {
        id: 1,
        question: '무역서신의 기본구조를 설명하시오.',
        answer: 'Letter Head, Date, Inside Address, Salutation, Body, Closing',
        prompt: `무역영어 2급 무역서신 문제입니다.\n\n문제: 무역서신의 기본구조를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'Circular Letter의 용도를 설명하시오.',
        answer: '거래처 통보문, 신제품/가격변동 안내',
        prompt: `무역영어 2급 무역서신 문제입니다.\n\n문제: Circular Letter의 용도를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'Credit Inquiry의 목적을 설명하시오.',
        answer: '거래처 신용조회, 거래 가부 판단',
        prompt: `무역영어 2급 무역서신 문제입니다.\n\n문제: Credit Inquiry의 목적을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: 'Order Letter 작성법을 설명하시오.',
        answer: '품명, 수량, 가격, 납기, 결제조건 명시',
        prompt: `무역영어 2급 무역서신 문제입니다.\n\n문제: Order Letter 작성법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: 'Shipping Advice의 내용을 설명하시오.',
        answer: '선적완료 통보, B/L 정보, 도착예정일',
        prompt: `무역영어 2급 무역서신 문제입니다.\n\n문제: Shipping Advice의 내용을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  },{
    id: 'practical-letter',
    ...
    questions: [
      {
        id: 1,
        question: 'Amendment Request의 작성법을 설명하시오.',
        answer: 'L/C 조건변경 요청, 변경사항 명확히',
        prompt: `무역영어 2급 무역서신 문제입니다.\n\n문제: Amendment Request의 작성법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 2,
        question: 'Complaint Letter 작성법을 설명하시오.',
        answer: '문제점 기술, 증빙첨부, 해결요청',
        prompt: `무역영어 2급 무역서신 문제입니다.\n\n문제: Complaint Letter 작성법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 3,
        question: 'Apology Letter 작성법을 설명하시오.',
        answer: '사과, 원인설명, 재발방지, 보상제시',
        prompt: `무역영어 2급 무역서신 문제입니다.\n\n문제: Apology Letter 작성법을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 4,
        question: 'Reminder Letter의 목적을 설명하시오.',
        answer: '대금독촉, 선적독촉, 회신독촉',
        prompt: `무역영어 2급 무역서신 문제입니다.\n\n문제: Reminder Letter의 목적을 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      },{
        id: 5,
        question: 'Acknowledgment Letter의 용도를 설명하시오.',
        answer: '수신확인, 처리예정 통보',
        prompt: `무역영어 2급 무역서신 문제입니다.\n\n문제: Acknowledgment Letter의 용도를 설명하시오.\n\n다음 순서로 설명해주세요:\n1. 핵심 개념 정리\n2. 상세 설명\n3. 적용 예시\n4. 실무 적용\n5. 연습문제 3개`
      }
    ]
  }
];

export default function TradecorrespondenceStudyPage() {
  const [completedQuestions, setCompletedQuestions] = useState<Record<string, boolean>>({});
  const [expandedTopics, setExpandedTopics] = useState<Record<string, boolean>>({});

  useEffect(() => {
    const saved = localStorage.getItem('trade-correspondence-progress');
  ...
  const toggleComplete = (topicId: string, questionId: number) => {
    ...
    localStorage.setItem('trade-correspondence-progress', JSON.stringify(newCompleted));
  };
