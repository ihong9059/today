      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <Link href="/category/accounting" className="text-gray-600 hover:text-blue-600">회계·세무</Link>
            <span className="text-gray-300">›</span>
        ...
        {activeTab === 'overview' && (
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
              ...
              <Link href="/category/accounting/financial-manager/exam" className="block w-full py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-center rounded-xl font-medium">
                시험 정보 보기 →
              </Link>
            </div>
          </div>
        ...
        {activeTab === 'subjects' && (
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {subjects.map((subject) => (
              <Link key={subject.slug} href={`/category/accounting/financial-manager/study/${subject.slug}`}
