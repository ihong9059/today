      ...
      <section className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-8">
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center gap-2 text-indigo-100 mb-2">
            ...
            <span>›</span>
            <Link href="/category/accounting" className="hover:text-white">회계·세무</Link>
            <span>›</span>
            <Link href="/category/accounting/financial-manager" className="hover:text-white">재경관리사</Link>
            <span>›</span>
