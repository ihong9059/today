...
export default function GasEngineerExamPage() {
      ...
      <section className="bg-gradient-to-r from-red-500 to-orange-500 text-white py-8">
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold">가스기사 시험정보</h1>
              <p className="text-red-100">Engineer Gas</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="font-medium text-gray-800">과목당 25문항 (총 100문항)</p>
                </div>
                <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">연소이론, 화염, 폭발, 소화이론</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">가스 제조·저장·공급설비, 안전장치</p>
                    </div>
                  </div>
                  <span className="text-sm text-gray-500">25문항</span>
                </div>
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">가스 안전관리, 사고예방, 점검 및 진단</p>
                    </div>
                  </div>
                  <span className="text-sm text-gray-500">25문항</span>
                </div>
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-3">
                    <span className="text-2xl">📖</span>
                    <div>
                      <p className="font-medium text-gray-800">가스관계법규</p>
                      <p className="text-sm text-gray-500">고압가스법, 액화석유가스법, 도시가스법</p>
                    </div>
                  </div>
                  <span className="text-sm text-gray-500">25문항</span>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-600">연소공학은 화학 이론이 기반이므로 기본 개념을 확실히 이해하세요.</p>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-600">가스설비는 도면과 시스템 구조를 숙지하고 계산 문제를 반복 연습하세요.</p>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-600">가스안전관리는 실무 사례 중심으로 학습하고 안전장치 작동원리를 이해하세요.</p>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-600">가스관계법규는 최신 개정 법령을 확인하고 주요 조항을 암기하세요.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  <p className="text-sm text-gray-500">시험 시간</p>
                  <p className="font-medium text-gray-800">필답 2시간 + 작업 1시간</p>
                </div>
                <div className="p-4 bg-gray-50 rounded-lg">
                  <p className="text-sm text-gray-500">합격 기준</p>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-4">
                <div className="p-4 border rounded-lg">
                  <h3 className="font-medium text-gray-800 mb-2">필답형 주요 출제 영역</h3>
                  <ul className="text-sm text-gray-600 space-y-1">
                    <li>• 가스설비 설계 및 계산 (배관 직경, 압력 계산)</li>
                    <li>• 안전장치 선정 및 배치</li>
                    <li>• 가스 누출 검지 및 대응방법</li>
                    <li>• 가스설비 점검 및 정비</li>
                    <li>• 사고사례 분석 및 대책 수립</li>
                  </ul>
                </div>
                <div className="p-4 border rounded-lg">
                  <h3 className="font-medium text-gray-800 mb-2">작업형 주요 출제 영역</h3>
                  <ul className="text-sm text-gray-600 space-y-1">
                    <li>• 배관 용접 및 연결 작업</li>
                    <li>• 압력계 및 안전밸브 설치</li>
                    <li>• 기밀시험 실시</li>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <span className="w-6 h-6 rounded-full bg-red-100 text-red-600 flex items-center justify-center text-sm font-bold flex-shrink-0">1</span>
                  <p className="text-gray-600">필답형은 계산 문제가 많으므로 공식을 정확히 암기하고 반복 연습하세요.</p>
                </div>
                <div className="flex items-start gap-3">
                  <span className="w-6 h-6 rounded-full bg-red-100 text-red-600 flex items-center justify-center text-sm font-bold flex-shrink-0">2</span>
                  <p className="text-gray-600">작업형은 용접 및 배관 작업 숙련도가 중요하므로 충분히 연습하세요.</p>
                </div>
                <div className="flex items-start gap-3">
                  <span className="w-6 h-6 rounded-full bg-red-100 text-red-600 flex items-center justify-center text-sm font-bold flex-shrink-0">3</span>
                  <p className="text-gray-600">기밀시험 및 누출검사 절차를 정확히 숙지하세요.</p>
                </div>
                <div className="flex items-start gap-3">
                  <span className="w-6 h-6 rounded-full bg-red-100 text-red-600 flex items-center justify-center text-sm font-bold flex-shrink-0">4</span>
                  <p className="text-gray-600">안전장치 작동 원리와 점검 방법을 실습을 통해 체득하세요.</p>
                </div>
              </div>
            </div>
          </div>
