...
export default function Home() {
  const categories = [
    ...
    { id: 'safety', name: '안전·소방', icon: '🛡️', color: 'from-red-500 to-orange-500', count: 8, hasPage: true, href: '/category/safety' },
    { id: 'medical', name: '의료·보건', icon: '🏥', color: 'from-pink-500 to-rose-500', count: 13, hasPage: false },
    { id: 'education', name: '교육', icon: '📚', color: 'from-indigo-500 to-purple-500', count: 10, hasPage: true, href: '/category/education' },
