...
export const mainNavigation: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'career', label: '진로지도', href: '/platforms/career', description: '학생 진로 탐색' },
  ...
  },
  {
    ...
    href: '/news',
    children: [
      { id: 'news-all', label: '뉴스/공지', href: '/news', description: '최신 소식' },
      { id: 'news-tech', label: '기술 블로그', href: '/news/tech', description: '기술 인사이트' },
    ],
  },
  {
    id: 'contact',
...
export const footerNavigation = {
  ...
  platforms: [
    ...
    { label: '진로지도', href: '/platforms/career' },
