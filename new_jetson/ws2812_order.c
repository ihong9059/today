...
int main() {
    ...
    printf("=== Find correct byte order for RED ===\n\n");

    // Test: First byte only = 150
    reset_led();
    printf("1. First byte=150: ");
    send_byte(150); send_byte(0); send_byte(0);
    reset_led();
    printf("What color?\n");
    sleep(3);

    // Test: Second byte only = 150
    reset_led();
    printf("2. Second byte=150: ");
    send_byte(0); send_byte(150); send_byte(0);
    reset_led();
    printf("What color?\n");
    sleep(3);

    // Test: Third byte only = 150
    reset_led();
    printf("3. Third byte=150: ");
    send_byte(0); send_byte(0); send_byte(150);
    reset_led();
    printf("What color?\n");
    sleep(3);
