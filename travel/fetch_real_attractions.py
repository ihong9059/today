...
# 진짜 관광지 카테고리 ID (Foursquare 실제 ID)
REAL_TOURIST_CATEGORIES = [
    ...
    "4bf58dd8d48988d138941735",  # Temple
    "4bf58dd8d48988d139941735",  # Shrine
    "4bf58dd8d48988d134941735",  # Mosque
    "4bf58dd8d48988d137941735",  # Buddhist Temple
    "52e81612bcbc57f1066b7a3e",  # Cathedral

    # Nature & Parks
    "4bf58dd8d48988d163941735",  # Park
    "4bf58dd8d48988d166941735",  # National Park
    "4bf58dd8d48988d15a941735",  # Botanical Garden
    "4bf58dd8d48988d15b941735",  # Garden
    "52e81612bcbc57f1066b7a21",  # Beach
    "4bf58dd8d48988d159941735",  # Lake
    "4bf58dd8d48988d15d941735",  # Mountain
    "52e81612bcbc57f1066b7a22",  # Waterfall

    # Entertainment & Attractions
    "4bf58dd8d48988d182941735",  # Zoo
    "4fceea171983d5d06c3e9823",  # Aquarium
    "4bf58dd8d48988d161941735",  # Amusement Park
    "4bf58dd8d48988d17f941735",  # Planetarium
    "4bf58dd8d48988d193941735",  # Theme Park

    # Buildings & Architecture
    "4bf58dd8d48988d12c941735",  # Castle
    "4bf58dd8d48988d171941735",  # Bridge
    "52e81612bcbc57f1066b7a13",  # Tower
]
...
def search_real_attractions(airport_code, city_info, limit=50):
    """진짜 관광지만 검색 - 더 많이 가져오기"""
    url = f"{BASE_URL}/places/search"
    params = {
        "ll": f"{city_info['lat']},{city_info['lng']}",
        "radius": 30000,  # 30km 반경
        "categories": ",".join(REAL_TOURIST_CATEGORIES),
        "sort": "RELEVANCE",
        "limit": limit  # 최대 50개
    }
    ...
    try:
        ...
        for place in data.get("results", []):
            ...
            attraction = {
                ...
                "transport": f"Located in {city_info['city']}"
            }
...
def main():
    ...
    for airport_code, city_info in CITY_COORDS.items():
        print(f"Fetching real attractions for {airport_code} ({city_info['city']})...")
        attractions = search_real_attractions(airport_code, city_info, limit=50)
    ...
    print(f"\nTotal: {total_count} real attractions for {len(all_attractions)} airports")
    print(f"Saved to attractions.json")
