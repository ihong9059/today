...
const levels = [
  {
    id: '초급',
    title: '초급',
    subtitle: 'UTTEC 보드 기초',
    icon: '🤖',
    color: 'from-cyan-500 to-blue-600',
    days: '15일',
    dayRange: 'Day 1-15',
    topics: ['MicroPython 기초', 'GPIO 제어', 'LED/버튼', '센서 연결', 'OLED 디스플레이'],
  },
  {
    id: '중급',
    title: '중급',
    ...
    days: '30일',
    dayRange: 'Day 16-45',
    topics: ['WiFi 연결', '웹서버', 'MQTT', '센서 데이터 수집', '클라우드 연동'],
  },
  {
    id: '고급',
    title: '고급',
    ...
    days: '45일',
    dayRange: 'Day 46-90',
    topics: ['스마트홈', '원격 모니터링', '자동화 시스템', 'Home Assistant', '최종 프로젝트'],
  },
];

export default function PythonUTTECCoursePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <CodingTabNav currentCourse="python-uttec" />
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="text-center mb-12">
          <div className="inline-flex items-center px-4 py-2 bg-violet-500/20 text-violet-300 rounded-full text-sm mb-4">
          ...
          <p className="text-xl text-slate-400 max-w-2xl mx-auto">
            UTTEC 보드로 배우는 MicroPython! IoT와 스마트홈 구현
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {levels.map((level) => (
            <Link
              key={level.id}
              href={`/course/coding/python-uttec/${level.id}`}
