...
const levels = [
  {
    ...
    days: '15일',
    dayRange: 'Day 1-15',
    topics: ['변수/자료형', '조건문/반복문', '함수', '리스트/딕셔너리', '파일 I/O'],
  },
  {
    id: '중급',
    title: '중급',
    ...
    days: '30일',
    dayRange: 'Day 16-45',
    topics: ['클래스', '상속', '모듈/패키지', '예외처리', '정규표현식'],
  },
  {
    id: '고급',
    title: '고급',
    ...
    days: '45일',
    dayRange: 'Day 46-90',
    topics: ['웹 크롤링', '데이터 분석', 'API 활용', '자동화', '최종 프로젝트'],
  },
];

export default function PythonPCCoursePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <CodingTabNav currentCourse="python-pc" />
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="text-center mb-12">
          <div className="inline-flex items-center px-4 py-2 bg-green-500/20 text-green-300 rounded-full text-sm mb-4">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {levels.map((level) => (
            <Link
              key={level.id}
              href={`/course/coding/python-pc/${level.id}`}
