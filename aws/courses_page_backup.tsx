...
import { ChevronRight, Brain, Briefcase, Users, GraduationCap, CheckCircle, Code, Cpu, Database, Server, Terminal, Menu, X, TrendingUp } from 'lucide-react';
...
const trackData = [
  {
    ...
    description: 'AI와 함께하는 영어·수학·탐구',
    features: ['TTS 듣기', 'AI 문제풀이', '초등~고등'],
    courses: [
      { id: 'english', name: '영어', icon: '🇬🇧', link: '/course/english', directLink: true },
      { id: 'math', name: '수학', icon: '🔢', link: '/course/math', directLink: true },
      { id: 'exploration', name: '탐구영역', icon: '📊', link: '/course/exploration', directLink: true, highlight: true, badge: '9과목' },
      { id: 'korean', name: '국어', icon: '📝', link: '/course/korean', directLink: true, highlight: true, badge: '5과목' },
      { id: 'english-suneung', name: '영어수능', icon: '🎯', link: '/course/english-suneung', directLink: true, highlight: true, badge: '6과목' },
      { id: 'math-suneung', name: '수학수능', icon: '📐', link: '/course/math-suneung', directLink: true, highlight: true, badge: '6과목' },
      { id: 'history-suneung', name: '한국사', icon: '🏛️', link: '/course/history-suneung', directLink: true, highlight: true, badge: '5과목' },
    ],
  },
  {
    id: 'conversation',
    ...
    description: '실용 외국어 회화 마스터',
    features: ['TTS 발음 연습', '4개 언어', '여행/비즈니스'],
    courses: [
      { id: 'english-conversation', name: '영어회화', icon: '🇺🇸', link: '/course/english-conversation', directLink: true },
      { id: 'japanese-conversation', name: '일본어회화', icon: '🇯🇵', link: '/course/japanese-conversation', directLink: true },
      { id: 'chinese-conversation', name: '중국어회화', icon: '🇨🇳', link: '/course/chinese-conversation', directLink: true },
      { id: 'spanish-conversation', name: '스페인어회화', icon: '🇪🇸', link: '/course/spanish-conversation', directLink: true },
    ],
  },
  {
    id: 'parent',
    ...
    description: 'AI로 자녀 교육하는 부모되기',
    features: ['60일 완성', '4단계 커리큘럼', '대학진학 연계'],
    courses: [
      { id: 'ai-basics', name: '1단계: AI 기초 마스터', icon: '🤖', link: '/course/parent/ai-basics', directLink: true, badge: '15일' },
      { id: 'mindset', name: '2단계: 마인드셋 변화', icon: '💡', link: '/course/parent/mindset', directLink: true, badge: '10일' },
      { id: 'education', name: '3단계: 자녀 교육 실전', icon: '📚', link: '/course/parent/education', directLink: true, highlight: true, badge: '20일' },
      { id: 'career', name: '4단계: 진로 교육', icon: '🎯', link: '/course/parent/career', directLink: true, badge: '15일' },
    ],
  },
  {
    id: 'beginner',
    ...
    description: 'AI 시대 직장인 필수 역량',
    features: ['AI 업무 활용', '프롬프트 마스터', '커리어 개발'],
    courses: [
      { id: 'ai-workplace', name: 'AI 시대 직장생활', icon: '💼', link: '/course/beginner/ai-workplace', directLink: true, badge: '5강' },
      { id: 'ai-tools-work', name: 'AI 도구 업무 활용', icon: '🛠️', link: '/course/beginner/ai-tools-work', directLink: true, badge: '5강' },
      { id: 'prompt-master', name: '프롬프트 마스터', icon: '✍️', link: '/course/beginner/prompt-master', directLink: true, highlight: true, badge: '5강' },
      { id: 'career-development', name: 'AI 시대 커리어 개발', icon: '📈', link: '/course/beginner/career-development', directLink: true, badge: '5강' },
      { id: 'portfolio-building', name: 'AI 활용 포트폴리오', icon: '🎨', link: '/course/beginner/portfolio-building', directLink: true, badge: '5강' },
    ],
  },
  {
    id: 'coding',
  ...
  },
  {
    ...
    description: 'AI 활용 교육 전문가 양성 (30일 과정)',
    features: ['30일 완성', '6단계 커리큘럼', '학교급별 맞춤'],
    courses: [
      { id: 'elementary', name: '초등교사 AI 활용 과정', icon: '🌱', link: '/course/teacher/elementary', directLink: true, badge: '30일', highlight: true },
      { id: 'middle', name: '중등교사 AI 활용 과정', icon: '📚', link: '/course/teacher/middle', directLink: true, badge: '30일' },
      { id: 'high', name: '고등교사 AI 활용 과정', icon: '🎓', link: '/course/teacher/high', directLink: true, badge: '30일' },
    ],
  },
  {
    id: 'career-change',
    ...
    courses: [
      { id: 'self-discovery', name: '나를 다시 발견하기', icon: '🔍', link: '/course/career-change/self-discovery', directLink: true, badge: '5강' },
      { id: 'ai-era-trends', name: 'AI 시대 유망 분야', icon: '🌟', link: '/course/career-change/ai-era-trends', directLink: true, badge: '5강' },
      { id: 'ai-skills', name: 'AI 활용 필수 역량', icon: '🤖', link: '/course/career-change/ai-skills', directLink: true, badge: '5강', highlight: true },
      { id: 'new-field-entry', name: '새 분야 진입 전략', icon: '🎯', link: '/course/career-change/new-field-entry', directLink: true, badge: '5강' },
      { id: 'digital-career', name: '디지털 커리어 설계', icon: '💻', link: '/course/career-change/digital-career', directLink: true, badge: '5강' },
      { id: 'creator-economy', name: '크리에이터 경제 입문', icon: '🎨', link: '/course/career-change/creator-economy', directLink: true, badge: '5강' },
      { id: 'freelance-startup', name: '프리랜서/창업 준비', icon: '🚀', link: '/course/career-change/freelance-startup', directLink: true, badge: '5강' },
      { id: 'transition-roadmap', name: '전환 로드맵 수립', icon: '🗺️', link: '/course/career-change/transition-roadmap', directLink: true, badge: '5강' },
    ],
  },
  {
    id: 'free',
    ...
    description: '다양한 직업 무료 체험',
    features: ['5개 직업 체험', '간접 경험', '기초 지식'],
    courses: [
      { id: 'film-director', name: '영화 감독', icon: '🎬', link: '/course/free/film-director', directLink: true, badge: '5강' },
      { id: 'renewable-energy', name: '신재생에너지발전설비기사', icon: '⚡', link: '/course/free/renewable-energy', directLink: true, badge: '5강' },
      { id: 'elementary-teacher', name: '초등학교 선생님', icon: '👩‍🏫', link: '/course/free/elementary-teacher', directLink: true, badge: '5강', highlight: true },
      { id: 'welding-technician', name: '용접 기사', icon: '🔧', link: '/course/free/welding-technician', directLink: true, badge: '5강' },
      { id: 'orchard-owner', name: '과수원 운영자', icon: '🍎', link: '/course/free/orchard-owner', directLink: true, badge: '5강' },
    ],
  },
];
...
function CourseCard({ course, trackColor }: { course: any; trackColor: string }) {
  ...
  // directLink가 true면 바로 링크로 이동
  if (course.directLink && course.link) {
    return (
      <Link href={course.link} className={`bg-white rounded-xl shadow-sm border p-4 hover:shadow-md transition block ${
        course.highlight ? 'border-indigo-400 ring-2 ring-indigo-100' : 'border-gray-100'
      }`}>
        ...
        <div className={`w-full py-2 text-center rounded-lg font-medium text-white bg-gradient-to-r ${trackColor}`}>
          강의 시작하기
        </div>
      </Link>
    );
