...
const days = [
  { day: 1, title: '고급 문법 심화', desc: '시제 일치, 화법 전환' },
  { day: 2, title: '복잡한 문장 구조', desc: '도치, 강조, 생략' },
  { day: 3, title: '준동사 심화', desc: '부정사/동명사/분사 완벽 정복' },
  { day: 4, title: '특수 구문', desc: '가정법, 조건문 심화' },
  { day: 5, title: '구문 분석 실전', desc: '긴 문장 분석 기술' },
];

export default function HighCommonPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-purple-50">
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span className="text-gray-900 font-medium">고1 공통영어</span>
          </div>
        </div>
      </div>

      <section className="bg-gradient-to-r from-purple-600 to-violet-600 text-white py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center gap-4 mb-4">
            <span className="text-5xl">🎓</span>
            <div>
              <h1 className="text-3xl font-bold">고1 공통영어</h1>
              <p className="text-purple-100 mt-1">문법 심화, 구문 분석</p>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="space-y-4">
          {days.map((item) => (
            <Link key={item.day} href={`/course/english/high/common/lesson/${item.day}`} className="block bg-white rounded-xl shadow-md hover:shadow-lg transition p-6 border-l-4 border-purple-500">
