...
const days = [
  { day: 1, title: '주제 찾기', desc: '글의 중심 내용 파악' },
  { day: 2, title: '요지/주장 파악', desc: '필자의 의도 읽기' },
  { day: 3, title: '빈칸 추론', desc: '문맥에서 답 찾기' },
  { day: 4, title: '순서/삽입', desc: '글의 논리적 흐름' },
  { day: 5, title: '장문 독해', desc: '긴 지문 공략법' },
];

export default function HighReadingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span className="text-gray-900 font-medium">영어 독해</span>
          </div>
        </div>
      </div>
      ...
      <section className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold">영어 독해</h1>
              <p className="text-blue-100 mt-1">독해 전략, 유형별 접근</p>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="space-y-4">
          {days.map((item) => (
            <Link key={item.day} href={`/course/english/high/reading/lesson/${item.day}`} className="block bg-white rounded-xl shadow-md hover:shadow-lg transition p-6 border-l-4 border-blue-500">
