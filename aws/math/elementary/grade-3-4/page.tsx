...
const days = [
  { day: 1, title: '덧셈과 뺄셈', desc: '세 자리 수 연산' },
  { day: 2, title: '곱셈', desc: '두 자리 수 곱셈' },
  { day: 3, title: '나눗셈', desc: '나머지 있는 나눗셈' },
  { day: 4, title: '분수의 기초', desc: '분수의 개념과 비교' },
  { day: 5, title: '도형과 측정', desc: '삼각형, 사각형, 길이' },
];

export default function Grade34MathPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-yellow-50">
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span className="text-gray-900 font-medium">초등 3-4학년</span>
          </div>
        </div>
      </div>
      ...
      <section className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold">초등 3-4학년 수학</h1>
              <p className="text-yellow-100 mt-1">기초 연산과 도형의 기초</p>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="space-y-4">
          {days.map((item) => (
            <Link key={item.day} href={`/course/math/elementary/grade-3-4/lesson/${item.day}`} className="block bg-white rounded-xl shadow-md hover:shadow-lg transition p-6 border-l-4 border-yellow-500">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-yellow-100 rounded-full flex items-center justify-center"><span className="text-yellow-700 font-bold">Day {item.day}</span></div>
