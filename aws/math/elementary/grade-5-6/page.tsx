...
const days = [
  { day: 1, title: '분수의 계산', desc: '분수 덧셈, 뺄셈' },
  { day: 2, title: '소수의 계산', desc: '소수점 연산' },
  { day: 3, title: '비와 비율', desc: '비율, 백분율' },
  { day: 4, title: '도형의 넓이', desc: '삼각형, 사각형 넓이' },
  { day: 5, title: '입체도형', desc: '부피와 겉넓이' },
];

export default function Grade56MathPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-orange-50">
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span className="text-gray-900 font-medium">초등 5-6학년</span>
          </div>
        </div>
      </div>
      ...
      <section className="bg-gradient-to-r from-orange-500 to-red-500 text-white py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold">초등 5-6학년 수학</h1>
              <p className="text-orange-100 mt-1">분수, 소수, 비와 비율</p>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="space-y-4">
          {days.map((item) => (
            <Link key={item.day} href={`/course/math/elementary/grade-5-6/lesson/${item.day}`} className="block bg-white rounded-xl shadow-md hover:shadow-lg transition p-6 border-l-4 border-orange-500">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-orange-100 rounded-full flex items-center justify-center"><span className="text-orange-700 font-bold">Day {item.day}</span></div>
