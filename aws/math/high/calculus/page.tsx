...
const days = [
  { day: 1, title: '수열의 극한', desc: '급수, 무한급수' },
  { day: 2, title: '여러 가지 함수의 미분', desc: '합성함수, 음함수' },
  { day: 3, title: '여러 가지 미분법', desc: '매개변수, 이계도함수' },
  { day: 4, title: '여러 가지 적분법', desc: '치환적분, 부분적분' },
  { day: 5, title: '정적분의 활용', desc: '넓이, 부피, 속도' },
];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-purple-50">
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span className="text-gray-900 font-medium">미적분</span>
          </div>
        </div>
      </div>
      ...
      <section className="bg-gradient-to-r from-purple-500 to-pink-500 text-white py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold">미적분</h1>
              <p className="text-purple-100 mt-1">고급 미분, 적분 심화</p>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="space-y-4">
          {days.map((item) => (
            <Link key={item.day} href={`/course/math/high/calculus/lesson/${item.day}`} className="block bg-white rounded-xl shadow-md hover:shadow-lg transition p-6 border-l-4 border-purple-500">
