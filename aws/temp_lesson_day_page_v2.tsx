...
const enrollmentData: Record<string, string[]> = {
  'test@test.com': ['c-esp32'], // test@test.com은 c-esp32 강좌 수강 신청됨
};
...
const lessonDataByDay: Record<number, any> = {
  1: {
    ...
    subtitle: 'ESP32의 특징을 이해하고, 개발환경을 설정하는 방법을 배웁니다.',
    progress: 0,
    learningGoals: [
    ...
    sections: [
      ...
      },
      {
        ...
        content: {
          ...
          items: [
            { label: 'Arduino', description: '입문자를 위한 간단한 마이크로컨트롤러' },
            { label: 'ESP32', description: 'Wi-Fi/Bluetooth 내장, 고성능 듀얼코어 프로세서' },
          ],
          keyPoint: {
            title: '핵심 차이',
    ...
    quiz: {
      ...
      questions: [
        ...
        },
        {
          ...
          options: ['싱글 코어', '듀얼 코어', '쿼드 코어', '옥타 코어'],
          correctAnswer: 1,
        },
      ],
    },
    additionalResources: [
      { title: '예제 파일과 자료집', type: 'download', icon: 'file' },
    ],
    nextLesson: { day: 2, title: 'GPIO 기초 - LED 제어하기' },
  },
  2: {
    day: 2,
    ...
    quiz: {
      title: '퀴즈',
      questions: [
        { id: 1, question: 'ESP32의 GPIO 출력 전압은?', options: ['1.8V', '3.3V', '5V', '12V'], correctAnswer: 1 },
        { id: 2, question: 'LED를 켜려면 어떤 함수를 사용하나요?', options: ['ledOn()', 'digitalWrite(pin, HIGH)', 'turnOn(LED)', 'LED.on()'], correctAnswer: 1 },
      ],
    },
    additionalResources: [{ title: 'LED 회로도 및 예제 코드', type: 'download', icon: 'file' }],
...
for (let day = 3; day <= 10; day++) {
  if (!lessonDataByDay[day]) {
    lessonDataByDay[day] = {
      ...
      sections: [
        { id: 1, type: 'video', badge: '이론', duration: '10분', title: '이론 강의', videoId: 'ZT25P9lUN9c' },
        { id: 2, type: 'video', badge: '실습', duration: '15분', title: '실습', videoId: 'ZT25P9lUN9c' },
      ],
      quiz: {
        title: '퀴즈',
        questions: [{ id: 1, question: '퀴즈 문제 1', options: ['보기 1', '보기 2', '보기 3', '보기 4'], correctAnswer: 0 }],
      },
      additionalResources: [],
...
export default function LessonDayPage() {
  ...
  const courseId = 'c-esp32'; // 현재 페이지의 강좌 ID
