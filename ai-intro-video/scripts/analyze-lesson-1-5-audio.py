"""
Lesson 1-5: AND, OR, NOT 게이트 - 오디오 길이 분석 스크립트
...
AUDIO_DIR = "public/audio/lesson-1-5"
FPS = 30
...
def analyze_audio():
    """오디오 파일 길이 분석"""
    print("=" * 60)
    print("Lesson 1-5: AND, OR, NOT 게이트 - 오디오 분석")
    print("=" * 60)
    ...
    print("};")
    print(f"\nexport const LESSON_1_5_DURATION = {total_frames};")
