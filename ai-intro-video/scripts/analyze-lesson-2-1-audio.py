...
FPS = 30
AUDIO_DIR = "public/audio/lesson-2-1"

scene_info = []
total_frames = 0
current_start = 0

for i in range(1, 10):  # 9개 씬
    ...
    if os.path.exists(audio_file):
        ...
        print(f"Scene {i}: {duration:.2f}s = {frames} frames (start: {current_start})")
        current_start += frames
        total_frames += frames

print("\n" + "="*50)
print("// TypeScript code for Video.tsx")
print("="*50 + "\n")
...
print("};")
print(f"\nexport const LESSON_2_1_DURATION = {total_frames};")
