...
const demoPath = path.join(publicPath, "demo");
console.log("Serving static files from:", publicPath);
console.log("Serving demo files from:", demoPath);

// Demo files first (more specific route)
app.use("/demo", function(req, res, next) {
  console.log("Demo request:", req.path);
  next();
}, express.static(demoPath, { fallthrough: true }));
...
let calibratedOrientation = { roll: 0, pitch: 0, timestamp: 0 };
let calibrationResetTimestamp = 0;
