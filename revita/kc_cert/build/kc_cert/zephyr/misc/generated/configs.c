...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RADIO_TEST_RX_TIMEOUT, 10);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FEM_AL_LIB, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_RAK4631, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_RAK4631_NRF52840, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_BACKEND_SERIAL_RX_RING_BUFFER_SIZE, 1024);
