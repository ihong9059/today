...
created: 2026-05-07
updated: 2026-05-07
status: 현재 — 특허 출원 완료 / 차세대 — onDevice_AI_검증 진행 중
...
| **차세대** | ESP32-S3-N16R8 | microGPT 변종 (자체 탑재) | 검증 중 ([[onDevice_AI_검증]]) | "외부 인터넷 0%, 응원봉 자체 GPT" |
...
| 2026-05~ (검증 종료 후) | Stage 4 영업 자료 갱신 (실측 데이터 추가) | ⬜ |
