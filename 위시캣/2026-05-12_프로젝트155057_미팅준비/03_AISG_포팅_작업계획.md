...
> 90일 (약 13주) 일정을 단계별로 분할 + 마일스톤 + 산출물 + 위험.
> 미팅에서 클라이언트에 보여줄 작업 계획서 — 사전 준비된 모습이 신뢰도 ↑.
...
|---|:-:|---|
| 선금 | 30% | 계약 체결 시 |
| 1차 중간 | 20% | Phase 3 종료 (Week 8) — 기능 4개 단위 테스트 PASS |
| 2차 중간 | 20% | Phase 4 종료 (Week 10) — 통합 테스트 PASS |
| 잔금 | 30% | Week 13 인계 + 검수 |

→ 클라이언트 입장 부담 ↓, UTTEC 입장 cash flow ↑
